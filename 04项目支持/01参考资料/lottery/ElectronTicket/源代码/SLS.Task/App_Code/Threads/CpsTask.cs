...
namespace SLS.Task
{
    ...
    public class CpsTask
    {
        ...
        //private void CpsCalculateAllowBonus()	//计算可提佣金
        //{
        //    if ((DateTime.Now.Hour > 6) || (DateTime.Now.Day != 1))
        //    {
        //        return;
        //    }
        ...
        //    //if (DAL.Procedures.P_CpsCalculateAllowBonus(ConnectionString, DateTime.Now.AddMonths(-1).Year, DateTime.Now.Month - 1, ref ReturnValue, ref ReturnDescription) < 0)
        //    if (DAL.Procedures.P_CpsCalculateAllowBonus(ConnectionString, DateTime.Now.AddMonths(-1).Year, DateTime.Now.AddMonths(-1).Month, ref ReturnValue, ref ReturnDescription) < 0)
        //    {
        //        msg.Send("Exec CpsCalculateAllowBonus: Procedure \"P_CpsCalculateAllowBonus\" Fail.");
        //        log.Write("Exec CpsCalculateAllowBonus: Procedure \"P_CpsCalculateAllowBonus\" Fail.");
        ...
        //    if (ReturnValue < 0)
        //    {
        //        msg.Send("Exec CpsCalculateAllowBonus: Procedure \"P_CpsCalculateAllowBonus\" Return: " + ReturnDescription);
        //        log.Write("Exec CpsCalculateAllowBonus: Procedure \"P_CpsCalculateAllowBonus\" Return: " + ReturnDescription);
        //    }
        //}
