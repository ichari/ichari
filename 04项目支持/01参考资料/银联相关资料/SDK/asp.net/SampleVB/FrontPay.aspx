<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="FrontPay.aspx.vb" Inherits="SampleVB.FrontPay" %>
...
<%
    ...
    Dim orderID As String = DateTime.Now.ToString("yyyyMMddHHmmss") + (rnd.Next(900) + 100).ToString().Trim()
    ...
    param("frontEndUrl") = "http://localhost/UPOPSDK/NotifyCallback.aspx"    ' 前台回调URL
    param("backEndUrl") = "http://localhost/UPOPSDK/NotifyCallBack.aspx"     ' 后台回调URL（前台请求时可为空）

    ' 创建前台交易服务对象
    Dim srv As FrontPaySrv = New FrontPaySrv(param)
