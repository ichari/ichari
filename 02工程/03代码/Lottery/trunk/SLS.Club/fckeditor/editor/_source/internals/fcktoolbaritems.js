...
FCKToolbarItems.GetItem = function(itemName) {
    ...
    switch (itemName) {
        ...
        case 'Bold': oItem = new FCKToolbarButton('Bold', FCKLang.Bold, null, null, false, true, 20); aler(FCKLang.Bold); break;
        case 'Hide': oItem = new FCKToolbarButton('Hide', FCKLang.Hide, null, null, false, true, null); break;
