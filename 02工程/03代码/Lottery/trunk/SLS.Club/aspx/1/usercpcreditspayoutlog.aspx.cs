...
namespace Discuz.Web
{
	...
	/// 支出记录
	/// </summary>
	public partial class usercpcreditspayoutlog : PageBase
    {
        #region 页面变量
        /// <summary>
        /// 当前页码
        ...
        override protected void OnLoad(EventArgs e)
        {
            ...
            /* 
                This page was created by Discuz!NT Template Engine at 2008/10/13 15:54:14.
                本页面代码由Discuz!NT模板引擎生成于 2008/10/13 15:54:14. 
            */
            ...
            templateBuilder.Append("		<a href=\"" + config.Forumurl.ToString().Trim() + "\" class=\"home\">" + config.Forumtitle.ToString().Trim() + "</a>  &raquo; <a href=\"usercp.aspx\">用户中心</a>  &raquo; <strong>金币支出记录</strong>\r\n");
