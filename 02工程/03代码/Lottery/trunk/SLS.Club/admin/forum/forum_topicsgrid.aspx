<%@ Page language="c#" Inherits="Discuz.Web.Admin.topicsgrid" CodeFile="forum_topicsgrid.aspx.cs" %>
...
<html>
	...
	<body>
		<form id="Form1" method="post" runat="server">
                        ...
                        <td class="panelbox" align="left" width="50%">
                            <table width="100%">
                                <tr>
						            ...
						            <td><input type="checkbox" name="nodeletepostnum" value="1" checked id="nodeletepostnum" runat="server" />删帖不减用户发帖数和金币</td>
                                </tr>
                                <tr>
			...
			<cc1:datagrid id="DataGrid1" ShowFooter="true" runat="server" OnPageIndexChanged="DataGrid_PageIndexChanged" OnSortCommand="Sort_Grid" PageSize="15">
				<Columns>
					...
					<asp:TemplateColumn HeaderText="回帖数">
						<ItemTemplate>
						    <asp:Label Text='<%# Eval("replies").ToString() %>' ID="lblReplies" runat="server"></asp:Label>
