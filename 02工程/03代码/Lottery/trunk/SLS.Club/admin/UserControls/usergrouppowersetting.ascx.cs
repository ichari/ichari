...
namespace Discuz.Web.Admin
{
    public partial class usergrouppowersetting : System.Web.UI.UserControl
    {
        ...
        public void Bind(UserGroupInfo usergroupinfo)
        {
            ...
            if (usergroupinfo.Allowsetreadperm == 1) usergroupright.Items[7].Selected = true; //是否允许设置主题阅读金币权限
            if (usergroupinfo.Allowsetattachperm == 1) usergroupright.Items[8].Selected = true; //是否允许设置附件阅读金币限制
