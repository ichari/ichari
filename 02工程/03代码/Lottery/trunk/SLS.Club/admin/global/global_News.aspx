<%@ Page Language="C#" AutoEventWireup="true" CodeFile="global_News.aspx.cs" Inherits="admin_global_global_News" %>
            ...
            <table cellspacing="0" cellpadding="0" width="90%" border="0" align="center">
                <tr>
                    <td align="left" valign="top"  rowspan="2">
                        <ShoveWebUI:ShoveTreeView ID="tv" runat="server" Width="140px" ImageSet="BulletedList3" ShowExpandCollapse="False" IDFieldName="ID" OnSelectedNodeChanged="tv_SelectedNodeChanged" ParentIDFieldName="ParentID" TextFieldName="Name" ValueFieldName="ID" ShowLines="True">
