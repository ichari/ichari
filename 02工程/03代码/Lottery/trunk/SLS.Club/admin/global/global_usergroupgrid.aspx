...
<%@ Page Language="c#" Inherits="Discuz.Web.Admin.usergroupgrid" CodeFile="global_usergroupgrid.aspx.cs" %>
    ...
    <form id="Form1" method="post" runat="server">
        ...
        <cc1:DataGrid ID="DataGrid1" runat="server" IsFixConlumnControls="true" OnPageIndexChanged="DataGrid_PageIndexChanged" 
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="creditshigher" SortExpression="creditshigher" HeaderText="金币下限"></asp:BoundColumn>
                <asp:BoundColumn DataField="creditslower" SortExpression="creditslower" HeaderText="金币上限"></asp:BoundColumn>
