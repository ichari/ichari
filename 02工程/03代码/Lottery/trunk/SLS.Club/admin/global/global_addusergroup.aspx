<%@ Page language="c#" Inherits="Discuz.Web.Admin.addusergroup" CodeFile="global_addusergroup.aspx.cs" %>
	...
	<body>
		<form id="Form1" runat="server">
            ...
            <uc1:PageInfo id="info1" runat="server" Icon="warning"
             Text="增加用户组时金币的上限和下限必须在已有的某个用户组金币上下限范围之内. <br />例如: 新手上路(已有)的金币上下限分别是50和0 ,那么要添加的用户组的金币上下限必须在(50≥上下限 >0) 或 (50>上下限≥0)之间. 而当要添加跨越多个用户组金币上下限区间的用户组时, 系统将视为无效."></uc1:PageInfo>		
		                                ...
		                                <td  class="panelbox" width="50%" align="left">
		                                    <table width="100%">
		                                        ...
		                                        <tr>
					                                <td>金币下限:</td>
					                                <td>
						                                <cc1:TextBox id="creditshigher" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" Text="0" size="10"  MaxLength="9" HintInfo="所属该用户组用户的最低金币数"></cc1:TextBox>
					                                </td>
		                                        </tr>
		                                        <tr>
					                                <td>星星数:</td>
		                                        ...
		                                        <tr>
					                                <td>主题最高售价:</td>
					                                <td>
						                                <cc1:TextBox id="maxprice" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" Text="0" size="5" MaxLength="4" HintInfo="主题出售使得作者可以将自己发表的主题隐藏起来,只有当浏览者向作者支付相应的交易金币后才能查看主题内容.此处设置用户出售主题时允许设置的最高价格,0 为不允许用户出售."></cc1:TextBox>
		                                ...
		                                <td  class="panelbox" width="50%" align="right">
		                                    <table width="100%">
				                                ...
				                                <tr>						    
					                                <td>金币上限:</td>
					                                <td>
						                                <cc1:TextBox id="creditslower" runat="server" CanBeNull="必填" RequiredFieldType="数据校验" Text="0" size="10"  MaxLength="9" HintInfo="所属该用户组用户的最高金币数"></cc1:TextBox>
					                                </td>						
				                                </tr>
				                                <tr>				
					                                <td>阅读权限:</td>
