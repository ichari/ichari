<%@ Page Language="c#" Inherits="Discuz.Web.Admin.announcegrid" CodeFile="global_announcegrid.aspx.cs" %>
        ...
        <div style="display: none">
            <table id="Table1" width="100%" cellspacing="1" cellpadding="4">
                ...
                <tr>
                    <td class="td1">标题:</td>
                    <td class="td1">
                        <cc2:TextBox ID="tbtitle" runat="server" RequiredFieldType="暂无校验" Width="300"></cc2:TextBox></td>
                </tr>
                <tr>
