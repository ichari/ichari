<%@ Page Language="c#" Inherits="Discuz.Web.Admin.cachemanage" CodeFile="global_cachemanage.aspx.cs" %>
    ...
    <script type="text/javascript">	       
        ...
        function getcachename()
        {
           ...
           switch(result)
           {
                ...
                case '11': cachename='正在重设论坛金币';break;
                ...
                case '34': cachename='正在重设兑换比率可交易金币策略';break;
                ...
                case '35': cachename='正在重设兑换比率可交易金币策略';break;
        ...
        <tr>
            <td  class="panelbox" width="50%" align="left">
                <table width="100%">
                    ...
                    <tr>
                        <td><cc1:Button ID="ReSetScoreset" runat="server" Text="重新设置论坛金币设置" ButtonImgUrl="../images/cache_reset.gif" /></td>
                    </tr>
                    <tr>
            ...
            <td  class="panelbox" width="50%" align="right">
                <table width="100%">                    
                    ...
                    <tr>
                        <td><cc1:Button ID="ReSetScorePaySet" runat="server" Text="重新设置兑换比率的可交易金币策略" ButtonImgUrl="../images/cache_reset.gif" /></td>
                    </tr>
                    <tr>
