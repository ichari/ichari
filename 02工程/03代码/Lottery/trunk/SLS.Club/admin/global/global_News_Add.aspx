<%@ Page Language="C#" AutoEventWireup="true" CodeFile="global_News_Add.aspx.cs" Inherits="admin_global_global_News_Add" %>
            ...
            <tr>
                <td style="height: 50px" align="center">
                    <ShoveWebUI:ShoveConfirmButton ID="btnAdd" runat="server" Width="60px" Height="20px"
                        BackgroupImage="../images/buttbg.gif" Text="增加" AlertText="确信输入无误，并立即增加此资讯吗？"
