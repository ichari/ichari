<%@ Page language="c#" Inherits="Discuz.Web.Admin.syslogin"  EnableViewstate ="false" CodeFile="syslogin.aspx.cs" %>
		   ...
		   <span class="td1">
			...
			<li class="FormNav">
				<dl>
					...
					<dd><label>验证码:</label><input class="FormCode" id="vcode" onkeydown="if(event.keyCode==13)  document.getElementById('login').focus();" type="text" size="20" name="vcode" autocomplete="off"> <img id="vcodeimg" style="cursor:hand" onclick="this.src='../tools/VerifyImagePage.aspx?time=' + Math.random()" title="点击刷新验证码" align="absMiddle" src="about:blank" />
