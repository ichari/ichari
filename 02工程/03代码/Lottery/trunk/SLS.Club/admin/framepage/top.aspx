<%@ Page Language="C#" AutoEventWireup="true" CodeFile="top.aspx.cs" Inherits="Discuz.Web.Admin.top" %>
		...
		<ul id="MainMenu">
		    <li class="MenuDrop">
		        <div class="MenuDropOut" onmouseover="this.className='MenuDropOn'" onmouseout="this.className='MenuDropOut'">
		            <a style ="cursor:pointer;"onmouseover="javascript:top.mainFrame.setshorcutmenu('block');" onmouseout="javascript:top.mainFrame.setshorcutmenu('none');" >快捷操作</a>
		        </div>
		    </li>
		</ul>		
		<div class="SearchBar">
