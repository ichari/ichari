...
function tradelog_callback(data) {
	...
	for(var i in data) {
		...
		for (j = 0; j< parseInt(data[i].buyercredit,0); j++) {
		   tradelog_html += '<img alt="0" src="'+ path +'/images/1.gif"/>'; //<span rank:params="type=b&uid=1418fcc13383f28e49634d03bfb89380&override=1" class="rank:token"><a href="#" target="_blank" title="11－40个买家信用金币，请点击查看详情" class="tb-rank buyer-rank-2"/></span>
		}
		tradelog_html += '</td>';
