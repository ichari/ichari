...
<div class="w970">
    ...
    <div style="display: none;">
        <iframe id="Login_Iframe_Reg" name="Login_Iframe_Reg" width="100%" frameborder="0" scrolling="no" src="<%= LoginIframeUrl %>"></iframe>
    </div>
    <div style="padding-top:8px;"></div>
    <div id="box1">
        <div id="content1">
            <div id="user_left" style="float:left; margin-left:10px;">
                <table width="300" border="0" cellspacing="1" cellpadding="0" style="margin-top: 6px; height: 551px;" bgcolor="#DDDDDD">
                    <tr>
                        <td valign="top" bgcolor="#FFFFFF" style="padding-bottom: 15px;">
                            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <img src="Home/Room/images/user_title_1.jpg" width="100%" height="62" />
                                    </td>
                                </tr>
                                <tr>
            ...
            <div id="user_center"  style="float:left; width:348px;" >
                <table width="400" border="0" cellspacing="0" cellpadding="0" style="margin-top: 6px;">
                    <tr>
                        <td>
                            <img id="imgLoginAD" src="Home/Room/images/user_banner.jpg" width="348" height="187" />
                        </td>
                    </tr>
                </table>
            ...
            <div id="user_right"  style="float:left;">
                    ...
                    <tr>
                        <td valign="top" bgcolor="#FFFFFF" style="padding-bottom: 15px;">
                            <table width="290" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <img src="Home/Room/images/user_title_2.jpg" width="100%" height="62" />
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding: 0px 10px 0px 10px;" height="15">
                            ...
                            <table width="268" border="0" align="center" cellpadding="0" cellspacing="0">
                                ...
                                <tr style="padding-bottom: 2px;">
                                    ...
                                    <td class="blue12_line">
                                        <label>
                                            <asp:CheckBox ID="ckbHomePage" runat="server" Text="" Checked="false" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <ShoveWebUI:ShoveConfirmButton ID="btnReg" Style="cursor: pointer;" runat="server"
                                            ...
                                            BorderStyle="None" OnClick="btnReg_Click" OnClientClick="if(!UsercheckReg()){return false}else{if(document.getElementById('ckbHomePage').checked){this.style.behavior='url(#default#homepage)';this.setHomePage(document.getElementById('HomePage').value);};}" />
                                    </td>
                                </tr>
                            </table>
                        </td>
