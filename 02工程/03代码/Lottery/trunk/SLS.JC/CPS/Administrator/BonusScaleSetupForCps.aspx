<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BonusScaleSetupForCps.aspx.cs" Inherits="Cps_Administrator_BonusScaleSetupForCps" %>
...
<body>
    <form id="form1" runat="server">
         ...
         CPS商家>><asp:Label ID="lblCpsName" runat="server" Text="lblCpsName" ForeColor="#CC0000"></asp:Label>
         佣金返点比例设置
         </span><br />
         <table>
            <tr>
                ...
                <td valign="top">
                    ...
                    <ShoveWebUI:ShoveGridPager ID="gPager" runat="server" Width="100%" PageSize="20"
                        ...
                        class="black12" CssClass="black12" SelectRowColor="#FF9933" /></div>
                </td>
            </tr>
            <tr>
                ...
                <td valign="top">
                    ...
                    (正确格式:0.03 )&nbsp;<asp:Button ID="btnModifyAll" runat="server" Text="统一修改" 
