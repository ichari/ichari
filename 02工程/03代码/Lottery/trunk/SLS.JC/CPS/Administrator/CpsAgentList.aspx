<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CpsAgentList.aspx.cs" Inherits="CPS_Administrator_CpsAgentList" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="padding: 0px; border: 1px solid #CCCCCC; background-color: #E9F1F8; margin-top: 5px; margin-bottom: 5px;">
            <div  style=" padding: 3px;width:100%; height:25px; font-size: 14px; font-weight: bold; color: #455C7E; border-bottom-style: solid; border-bottom-width: 1px; border-bottom-co; text-align: center; border-bottom-color: #C0C0C0;">代理商一览表</div> 
