<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserBuyDetail.aspx.cs" Inherits="Cps_Administrator_UserBuyDetail" %>
...
<body>
    ...
    <asp:HiddenField ID="hfUserID" runat="server" />
         <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top:1px;">
            <tr>
                <td width="50%">
                     &nbsp;&nbsp;&nbsp;&nbsp;会员<asp:Label ID="lblUserName" runat="server" 
                         Font-Bold="True" ForeColor="#CC0000" Text="lblUserName"></asp:Label>
                     交易明细&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 按出票日期查询: &nbsp;开始日期：
