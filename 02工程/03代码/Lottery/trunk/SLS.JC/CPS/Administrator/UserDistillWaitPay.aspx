<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserDistillWaitPay.aspx.cs" Inherits="Cps_Administrator_UserDistillWaitPay" %>
    ...
    <form id="form1" runat="server">
       ...
       <div style="border: 1px solid #BCD2E9; width: 99%; margin-top: 10px; margin-bottom: 8px; background-color: #F4F9FC; height: 60px; vertical-align: middle;" >
                        ...
                        <tr>
                            ...
                            <%--<td id="PayBy99Bill" runat="server" class="NotSelectedTab" width="100px" align="center"  >
                                <asp:LinkButton runat="server" ID="lbtnPayBy99Bill" 
                                    OnClientClick="return true;" onclick="lbtnPayBy99Bill_Click">提款到快钱</asp:LinkButton>
                            </td>
                            <td width="6px">
                                &nbsp;
                            </td>--%>
        ...
        <ShoveWebUI:ShoveConfirmButton ID="btnAlipayToAlipayAdd"  runat="server" Width="129px" Height="28px" Text="批量派发至支付宝" AlertText="确信输入无误，并立即派发用户的支付宝账号吗？" onclick="btnAlipayToAlipayAdd_Click" />
         ...
         <ShoveWebUI:ShoveConfirmButton ID="btnAlipayToBank"  Visible="false"  runat="server" Width="129px" Height="28px" Text="批量派发至银行卡" AlertText="确信输入无误，并立即派发用户的银行卡吗？" OnClick="btnAlipayToBank_Click" /> 
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <%--<ShoveWebUI:ShoveConfirmButton ID="btn99Bill"  runat="server" Width="129px" 
           Height="28px" Text="批量派发至快钱" AlertText="确信输入无误，并立即派发用户的快钱账号吗？" 
           onclick="btn99Bill_Click"/>
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        
         <ShoveWebUI:ShoveConfirmButton ID="btn99BillToBank" Visible="false"   runat="server" Width="129px" Height="28px" Text="批量派发至银行卡" AlertText="确信输入无误，并立即派发用户的银行卡吗？" OnClick="btn99BillToBank_Click" /> --%>
    </form>
