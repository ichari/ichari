<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CpsCommenderBuyDetail.aspx.cs" Inherits="Cps_Administrator_CpsCommenderBuyDetail" %>
...
<body>
    ...
    <asp:HiddenField ID="hfCommenderID" runat="server" />
    <div>
         <table width="100%" border="0" cellspacing="0" cellpadding="0" style="padding-top:1px;">
            <tr>
                <td width="50%">
                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;推广员<asp:Label ID="lblCommenderName" runat="server" Font-Bold="True" 
                         ForeColor="#CC0000" Text="lblCommenderName"></asp:Label>推广员购彩明细&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                     购买日期查询: &nbsp;开始日期：
