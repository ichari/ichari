<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdvermentLink.aspx.cs" Inherits="CPS_Administrator_Admin_AdvermentLink" %>
                                        ...
                                        <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#ccccccc">
                                            ...
                                            <tr>
                                                ...
                                                <td height="28" align="left" bgcolor="#FFFFFF" class="red" style="padding-left: 10px;">
                                                    <a href="BonusScaleView.aspx?ID=<%=CpsID %>">查看返点比例<span class="hui_2"></span></a>
                                                </td>
