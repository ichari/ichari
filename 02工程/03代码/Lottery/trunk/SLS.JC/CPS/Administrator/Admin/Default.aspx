<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="CPS_Administrator_Admin_Default" %>
...
<body>
    ...
    <table width="981" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;" align="center">
        <tr>
            ...
            <td valign="top">
                <iframe id="contentFrame" src="BaseInfo.aspx"  frameborder="no" width="100%" onload="try{document.all['contentFrame'].style.height=contentFrame.document.body.scrollHeight;}catch(e){}" name="contentFrame"
