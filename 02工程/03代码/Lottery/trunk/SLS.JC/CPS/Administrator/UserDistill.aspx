<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserDistill.aspx.cs" Inherits="Cps_Administrator_UserDistill" %>
                                    ...
                                    <tr>
                                        <td style="height: 19px" align="left">
                                            ...
                                            <input id="tbAlipayName" type="hidden" size="1" value='<%# DataBinder.Eval(Container.DataItem,"AlipayName") %>'
                                                runat="server" />
                                                <%--<input id="tb99BillName" type="hidden" size="1" value='<%# DataBinder.Eval(Container.DataItem,"BillName") %>'
                                                runat="server" />--%>
                                            ...
                                            <span id="Span3"  class='<%# DataBinder.Eval(Container.DataItem,"BillName").ToString().Trim()==""?"hidden":"visibility"%>' runat="server">
                                
                                                快钱用户名&nbsp;<font color="#ff0000"><%# DataBinder.Eval(Container.DataItem, "BillName")%></font>&nbsp;
                                            </span>   
                                        </td>
                                    </tr>
                                    <tr>
