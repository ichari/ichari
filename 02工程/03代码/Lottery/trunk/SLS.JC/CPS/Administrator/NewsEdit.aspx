<%@ Page Language="C#" AutoEventWireup="true" CodeFile="NewsEdit.aspx.cs" Inherits="CPS_Administrator_NewsEdit"
            ...
            <tr>
                <td style="height: 49px" align="center">
                    <ShoveWebUI:ShoveConfirmButton ID="btnSave" runat="server" Width="60px" Height="20px"
                        BackgroupImage="../../Images/Admin/buttbg.gif" Text="保存" AlertText="确信输入无误，并立即保存此资讯吗？"
