<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserDistillPayed.aspx.cs" Inherits="Cps_Administrator_UserDistillPayed" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function clickTab(obj)
        {
            ...
            switch (obj.id)
            {
                case 'PayByAlipay':
                    ...
                    break;
                case 'PayBy99Bill':
                    document.getElementById("PayBy99Bill").className = 'blue12';
                    document.getElementById("PayBy99Bill").style.fontWeight = "bold";
                    document.getElementById("PayBy99Bill").style.backgroundImage = "url('../../Home/Room/images/admin_qh_100_1.jpg')";
                    break;
                case 'PayByBank':
        ...
        {
            var arrCells = new Array('PayByAlipay','PayBy99Bill', 'PayByBank', 'AllPay');
    ...
    <form id="form1" runat="server">
        <div style="border: 1px solid #BCD2E9; width: 99%; margin-top: 10px; margin-bottom: 8px; background-color: #F4F9FC; height: 60px; vertical-align: middle;" >
            <div style="border-color: #BCD2E9; width: 100%;  height: 25px; vertical-align: middle; " align="center">
                <span style="font-size: 14px; font-weight: bold; margin-top: 5px; color: #226699">提款成功用户一览表</span>  
            </div>
                 ...
                 <table cellspacing="0" cellpadding="0" width="99%" border="0" >
                    <tr>
                        <td style="height: 30px">
                                <asp:RadioButton ID="rbByDistillTime" runat="server" Checked="True" 
                                GroupName="byTimeType" Text="按申请时间" />
                      ...
                      <table border="0" cellspacing="0" cellpadding="0" background="../../Home/Room/images/zfb_left_bg_2.jpg" style="margin-top: 5px;">
                        <tr>
                            ...
                            <td id="PayBy99Bill" runat="server" class="NotSelectedTab" width="100px" align="center"  >
                                <asp:LinkButton runat="server" ID="lbtnPayBy99Bill" 
                                    OnClientClick="return true;" onclick="lbtnPayBy99Bill_Click">快钱提款</asp:LinkButton>
                            </td>
                            <td width="6px">
                                &nbsp;
                            </td>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#DDDDDD">
                        ...
                        <tr>
                            <td height="30"  align="center" bgcolor="#FFFFFF">
                                ...
                                Font-Names="宋体" PageSize="20" AllowPaging="True" DataKeyField="ID"
                                AllowSorting="True">
                                ...
                                <Columns>
                                   ...
                                   <asp:TemplateColumn HeaderText="应付金额"> 
                                    ...
                                    <asp:BoundColumn DataField="BankName" HeaderText="支行名称" SortExpression="BankName"></asp:BoundColumn>
                        ...
                        <tr>
                            <td bgcolor="#F8F8F8" >
                                ...
                                合计&nbsp;&nbsp;&nbsp;&nbsp; 
                                提款金额:
                                <asp:Label ID="lblTotalDistillMoney" runat="server" Text="0" Font-Bold="True" 
                                    ForeColor="#CC0000">
                               </asp:Label>元&nbsp;&nbsp;&nbsp;&nbsp; 
                                手续费:
                                <asp:Label ID="lblTotalFormalitiesFees" runat="server" Text="0" Font-Bold="True" ForeColor="#CC0000">
                                </asp:Label>元&nbsp;&nbsp;&nbsp;&nbsp; 实付金额:
                                <asp:Label ID="lblTotalPayMoney" runat="server" Text="0" Font-Bold="True" 
                                    ForeColor="#CC0000">
                               </asp:Label>元
                                </span>
                            </td>
