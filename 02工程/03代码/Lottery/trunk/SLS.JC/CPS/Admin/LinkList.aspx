<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LinkList.aspx.cs" Inherits="CPS_Admin_LinkList" %>
                            ...
                            <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#CCCCCC">
                                ...
                                <tr>
                                    <td colspan="2" align="left" style="padding-left:10px; padding-bottom:10px; padding-top:10px" bgcolor="#EAF2FE">
                                        PID为代理商家系统的站长标识ID (可以为数字或字符串).通过<%= _Site.Url %>/Default.aspx?Cpsid=1&PID=12345链接注册的会员由联盟指定的站长12345推广的会员,12345就是代理商分配给哪个站长的标记,目的是用这个标记来区别哪些员会是属于哪个站长推广的.
                                        PID的值由商家自由分配,系统会自动记录用此PID推广注册的会员
                                    </td>
                                </tr>
                            </table>
                        </td>
