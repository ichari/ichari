...
public partial class CPS_Admin_IncomeListByMonth : CpsPageBase
{
    ...
    override protected void OnInit(EventArgs e)
    {
        ...
        RequestLoginPage = Shove._Web.Utility.GetUrl() + "/CPS/Admin/Default.aspx?SubPage=IncomeListByMonth.aspx";
