<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WordCode.aspx.cs" Inherits="CPS_WordCode" %>
                            ...
                            <td align="center" bgcolor="#FFFFFF" style="padding-top: 8px; padding-bottom: 8px;">
                                ...
                                Rows="5" Columns="55"></asp:TextBox>
                                        ...
                                        <td width="15%" bgcolor="#FFFFFF">
                                            <input  type="button" onclick="doufucopy('tbWordCode1')" value="复制代码" />
                                        </td>
                                    </tr>
                                    <tr>
                                ...
                                Rows="5" Columns="55"></asp:TextBox>
                                        ...
                                        <td width="15%" bgcolor="#FFFFFF">
                                            <input  type="button" onclick="doufucopy('tbWordCode2')" value="复制代码" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td height="30" align="center" bgcolor="#FCF5E1">
