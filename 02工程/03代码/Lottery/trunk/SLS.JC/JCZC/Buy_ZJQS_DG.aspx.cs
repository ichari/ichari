...
public partial class JCZC_Buy_ZJQS_DG : System.Web.UI.Page
{
    ...
    {
        //赛事缓存30分钟
        DataTable dt = Shove._Web.Cache.GetCacheAsDataTable("DataCache_Matchs_72_IsTtg_dg");
        ...
        if (dt == null || dt.Rows.Count == 0)
        {
            ...
            dt = Shove.Database.MSSQL.Select("SELECT * FROM [T_singleRate]  where IsTtg = 1 and DATEADD(minute, (select SystemEndAheadMinute from T_PlayTypes where id = 7203) * -1, StopSellTime) > GETDATE() order by [Day], MatchNumber");
            ...
            if (dt != null)
            {
                Shove._Web.Cache.SetCache("DataCache_Matchs_72_IsTtg_dg", dt, 0);
            }
                ...
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    sb.Append("<tr class='" + lineStyle + "' zid=\"" + dr["MatchID"].ToString() + "\" mid=\"" + dr["MatchID"].ToString() + "\" pdate=\"" + OldDay.Insert(6, "-").Insert(4, "-") + "\" pname=\"" + (((int)startDate.DayOfWeek) == 0 ? 7 : ((int)startDate.DayOfWeek)).ToString() + dr["MatchNumber"].ToString().Substring(dr["MatchNumber"].ToString().Length - 3) + "\" lg=\"" + dr["Game"].ToString() + "\" odds=\"" + dr["in0"].ToString() + "," + dr["in1"].ToString() + "," + dr["in2"].ToString() + "," + dr["in3"].ToString() + "," + dr["in4"].ToString() + "," + dr["in5"].ToString() + "," + dr["in6"].ToString() + "," + dr["in7"].ToString() + "\">")
                       ...
                       .AppendLine("<td>析 亚 欧</td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"0\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["in0"].ToString(), 0)> 0 ? Shove._Convert.StrToDouble(dr["in0"].ToString(), 0).ToString("F2") : "") + "</span></td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"1\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["in1"].ToString(), 0) > 0 ? Shove._Convert.StrToDouble(dr["in1"].ToString(), 0).ToString("F2") : "") + "</span></td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"2\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["in2"].ToString(), 0)> 0 ? Shove._Convert.StrToDouble(dr["in2"].ToString(), 0).ToString("F2") : "") + "</span></td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"3\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["in3"].ToString(), 0)> 0 ? Shove._Convert.StrToDouble(dr["in3"].ToString(), 0).ToString("F2") : "") + "</span></td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"4\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["in4"].ToString(), 0)> 0 ? Shove._Convert.StrToDouble(dr["in4"].ToString(), 0).ToString("F2") : "") + "</span></td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"5\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["in5"].ToString(), 0)> 0 ? Shove._Convert.StrToDouble(dr["in5"].ToString(), 0).ToString("F2") : "") + "</span></td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"6\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["in6"].ToString(), 0)> 0 ? Shove._Convert.StrToDouble(dr["in6"].ToString(), 0).ToString("F2") : "") + "</span></td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"7\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["in7"].ToString(), 0) > 0 ? Shove._Convert.StrToDouble(dr["in7"].ToString(), 0).ToString("F2") : "") + "</span></td>")
