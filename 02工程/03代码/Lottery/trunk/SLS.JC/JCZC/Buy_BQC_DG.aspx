<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_BQC_DG.aspx.cs" Inherits="JCZC_Buy_BQC_DG" EnableViewState="false" %>
...
<body>
    ...
    <div class="fsds">
      ...
      <input type="radio" onclick="window.location.href='Buy_BQC.aspx'">
  ...
  <td colspan="2"><table class="table_bdtz_gg" width="100%" border="0" cellpadding="4" cellspacing="0">
    <tbody><tr class="t02">
      ...
      <tr class="t03"><td style="width:75px;" align="center"><input checked="checked" value="2929" name="m2929" type="checkbox" /><span>周四006</span></td><td align="center" style="width:50px;">巴兰基利亚青年 VS 蒙特维迪奥竞技</td>
       <td align="left" class="bnone" valign="middle" style="width:100px">
...
<input type="hidden" id="playname" name="playname" value="竞彩半全场胜平负" />
...
<script type="text/javascript" src="JScript/dg_bqc.js"></script>
