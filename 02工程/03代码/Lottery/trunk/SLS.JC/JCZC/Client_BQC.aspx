<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Client_BQC.aspx.cs" Inherits="JCZC_Client_BQC" EnableViewState="false"%>
...
<body>
  ...
  <td><table class="table_bdtz_gg" width="100%" border="0" cellpadding="4" cellspacing="0">
    <tbody><tr class="t02">
      ...
      <tr class="t03">
      <td><input checked="checked" value="2929" name="m2929" type="checkbox" /><span>周四006</span></td>
      <td align="center">巴兰基利亚青年 VS 蒙特维迪奥竞技</td>
      <td align="center" class="bnone">
          <label style="display:none"><input type="checkbox"checked="checked"value="33"/>胜-胜</label>
          <label style="display:none"><input type="checkbox"checked="checked"value="31"/>胜-平</label>
          <label style="display:none"><input type="checkbox"checked="checked"value="30"/>胜-负</label>
          <label style="display:none"><input type="checkbox"checked="checked"value="13"/>平-胜</label>
          <label style="display:none"><input type="checkbox"checked="checked"value="11"/>平-平</label>
          <label style="display:none"><input type="checkbox"checked="checked"value="10"/>平-负</label>
          <label style="display:none"><input type="checkbox"checked="checked"value="03"/>负-胜</label>
          <label style="display:none"><input type="checkbox"checked="checked"value="01"/>负-平</label>
          <label style="display:none"><input type="checkbox"checked="checked"value="00"/>负-负</label>
      </td>
  ...
  <td class="jczqtouzu_title_gg">请选择过关方式</td>
      ...
      <tr>
        <td><table class="table_bdtz_gg" width="100%" border="0" cellpadding="4" cellspacing="0" style="margin:0;">
          ...
          <tr class="t05">
            <td><input name="ssq_dg" checked="checked" type="radio" />普通过关</td>
            </tr>
            ...
            <tr style="display:none">
                <td>
                    <table class="table_BetInfo" width="100%" border="0" cellpadding="2" cellspacing="0">
                        ...
                        <tr>
                            <td colspan="2">
                                <div class="touz_btn" style="float:left;"><img src="Images/btn_dg.gif" id="dgBtn" border="0" style="cursor: pointer;" alt="确认代购" />&nbsp;&nbsp;<img src="Images/FilterShrink.gif" id="FilterBtn" border="0" style="cursor: pointer;" alt="高级过滤" /></div>
                            </td>
                        </tr>
                    </table>
                </td>
        ...
        <input type="hidden" id="lotType" name="lotType" value="bqc" />
...
<script type="text/javascript" src="JScriptClient/gg_bqc.js"></script>
