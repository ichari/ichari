...
public partial class JCZC_Buy_BQC : System.Web.UI.Page
{
    ...
    private DataTable getMatchs()
    {
        ...
        if (dt == null || dt.Rows.Count == 0)
        {
            ...
            dt = Shove.Database.MSSQL.Select("SELECT * FROM [T_PassRate]  where IsHafu = 1 and DATEADD(minute, (select SystemEndAheadMinute from T_PlayTypes where id = 7204) * -1, StopSellTime) > GETDATE() order by [Day], MatchNumber");
            ...
            if (dt != null)
            {
                Shove._Web.Cache.SetCache("DataCache_Matchs_72_IsHafu", dt, 0);
            }
