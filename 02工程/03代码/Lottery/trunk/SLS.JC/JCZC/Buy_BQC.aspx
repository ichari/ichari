<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_BQC.aspx.cs" Inherits="JCZC_Buy_BQC" EnableViewState="false"%>
...
<body>
    ...
    <div id="gc_bg">
        <div id="position">
            ...
            <span class="sub_t">半全场(最多选择3场赛事)</span></div>
        <div id="wrap">
                ...
                <ul>
                   <li class="butt2"><a href="Buy_SPF.aspx">
                    ...
                    <li class="butt2"><a href="Buy_ZQBF.aspx">
                        比分</a></li>
                    <li class="butt1"><a href="Buy_BQC.aspx">
                        半全场</a></li>
                    <li style="float:right; width:280px; text-align:right;">
                        ...
                        <a href="/Help/play_7204.aspx" target="_blank">玩法介绍</a>                        
                    </li>
               </ul>
            </div>
            <div class="choice">
    <div class="fsds">
      <div class="l">
      <input type="radio"  onclick="window.location.href='Buy_BQC_DG.aspx'" />
...
<div style="width:240px; float:right;">
  ...
  <td colspan="2"><table class="table_bdtz_gg" width="100%" border="0" cellpadding="4" cellspacing="0">
    <tbody><tr class="t02">
      ...
      <tr class="t03">
      <td style="width:75px;" align="center"><input checked="checked" value="2929" name="m2929" type="checkbox" /><span>周四006</span></td>
      <td align="center" style="width:50px;">巴兰基利亚青年 VS 蒙特维迪奥竞技</td>
      <td align="left" class="bnone" valign="middle" style="width:95px">
        <div style="padding-left:5px;">
          <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="33" visible="false" style="display:none"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:38px; text-align:center; margin-top:3px; margin-bottom:4px;">胜-胜</div></em></label>
          <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="31" visible="false" style="display:none"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:38px; text-align:center; margin-top:3px; margin-bottom:4px;">胜-平</div></em></label>
          <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="30" visible="false" style="display:none"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:38px; text-align:center; margin-top:3px; margin-bottom:4px;">胜-负</div></em></label>
          <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="13" visible="false" style="display:none"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:38px; text-align:center; margin-top:3px; margin-bottom:4px;">平-胜</div></em></label>
          <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="11" visible="false" style="display:none"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:38px; text-align:center; margin-top:3px; margin-bottom:4px;">平-平</div></em></label>
          <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="10" visible="false" style="display:none"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:38px; text-align:center; margin-top:3px; margin-bottom:4px;">平-负</div></em></label>
          <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="03" visible="false" style="display:none"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:38px; text-align:center; margin-top:3px; margin-bottom:4px;">负-胜</div></em></label>
          <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="01" visible="false" style="display:none"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:38px; text-align:center; margin-top:3px; margin-bottom:4px;">负-平</div></em></label>
          <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="00" visible="false" style="display:none"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:38px; text-align:center; margin-top:3px; margin-bottom:4px;">负-负</div></em></label>
        </div>
      </td>
  ...
  <td class="jczqtouzu_title_gg">确认投注信息及购买</td>
      ...
      <tr>
        ...
        <input type="hidden" id="playid" name="playid" value="7204" />
        <input type="hidden" id="playname" name="playname" value="竞彩半全场" />
                ...
                <div class="lay_box4">
                    ...
                    <div class="lay_content2 scroll" id="popContent">
                        ...
                        <table cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                <td colspan="7">
                                    注：奖金预测sp值为投注时即时sp值，最终奖金以开奖sp值为准
                                </td>
                            </tr>
                        </table>
                        <table cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td>
                                    [50]1.59×[51]1.68×[48]1.72×[47]1.83×[46]1.87×[49]1.94×1倍×2元×65% = 39.65元
                                </td>
                                <td>
                                    396.5元
                                </td>
...
<script type="text/javascript" src="JScript/gg_bqc.js"></script>
<script id="config" type="text/javascript" src="JScript/form.js?4"></script>
