<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_ZQBF.aspx.cs" Inherits="JCZC_Buy_ZQBF" EnableViewState="false"%>
...
<body>
    ...
    <div id="gc_bg">
        <div id="position">
            ...
            <span class="sub_t">比分(最多选择3场赛事)</span></div>
        <div id="wrap">
            <div class="nav_button">
                <ul>
                    ...
                    <li class="butt2"><a href="Buy_ZJQS.aspx">
                        总进球数</a></li>
                    <li class="butt1"><a href="Buy_ZQBF.aspx">
                        比分</a></li>
                    ...
                    <li style="float:right; width:280px; text-align:right;">
                        ...
                        <a href="/Help/play_7202.aspx" target="_blank">玩法介绍</a>                        
                    </li>
               </ul>
            </div>
             <div class="choice">
    <div class="fsds">
      <div class="l">
      <input type="radio"  onclick="window.location.href='Buy_ZQBF_DG.aspx'">
...
<div class="touzhu" style="width:750px; float:left;border-top-color: #FFF; margin-left:0px;">
      ...
      <span>2、单个方案最多只能选择3场赛事进行投注。</span><br />
      <span>3、表中所有固定奖金额仅供参考，2或3场过关投注，单注最高奖金限额20万元。</span><br />  
...
<div style="width:240px; float:right;">
      ...
      <td colspan="2"><table class="table_bdtz_gg" width="100%" border="0" cellpadding="4" cellspacing="0">
        <tbody><tr class="t02">
          ...
          <tbody id="row_tpl">
          <tr class="t03" style="display:none"><td style="width:75px;" align="center"><input checked="checked" value="2929" name="m2929" type="checkbox" /><span>周四006</span></td><td align="center" style="width:50px;">巴兰基利亚青年 VS 蒙特维迪奥竞技</td>
          <td align="left" class="bnone" valign="middle" style="width:125px">
          <div style="padding-left:2px;">
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="3A" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:42px; text-align:center; margin-top:3px; margin-bottom:4px;">胜其他</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="10" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">1:0</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="20" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">2:0</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="21" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">2:1</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="30" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">3:0</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="31" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">3:1</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="32" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">3:2</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="40" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">4:0</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="41" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">4:1</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="42" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">4:2</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="50" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">5:0</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="51" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">5:1</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="52" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">5:2</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="1A" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:42px; text-align:center; margin-top:3px; margin-bottom:4px;">平其他</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="00" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">0:0</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="11" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">1:1</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="22" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">2:2</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="33" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">3:3</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="0A" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:42px; text-align:center; margin-top:3px; margin-bottom:4px;">负其他</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="01" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">0:1</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="02" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">0:2</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="12" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">1:2</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="03" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">0:3</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="13" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">1:3</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="23" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">2:3</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="04" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">0:4</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="14" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">1:4</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="24" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">2:4</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="05" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">0:5</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="15" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">1:5</div></em></label>
              <label style="display:none;float:left; margin-left:4px;"><input type="checkbox"checked="checked"value="25" visible="false" style="display: none;"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:26px; text-align:center; margin-top:3px; margin-bottom:4px;">2:5</div></em></label>
          </div>
          </td>
      ...
      <td valign="top"><table class="table_jczqtz_gg" style="" width="100%" border="0" cellpadding="4" cellspacing="0">    
         <tbody><tr><div style="height:6px;line-height:1px;"></div></tr><tr>
...
<input type="hidden" id="playname" name="playname" value="竞彩进球比分" />
...
<script type="text/javascript" src="JScript/gg_bf.js"></script>
