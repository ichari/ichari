...
selectTable.getNewTr = function(tr, chk, node) {//添加行
    ...
    if (!node) {
        ...
        tds[1].innerHTML = this.unHTML(tr.cells[3].innerHTML);
...
selectTable.isAllCancel=function (tr){
    var test=true;
    each(tr.getElementsByTagName('INPUT'), function() { if (this.parentNode.style.display != 'none') return test = false }, 1, 4);
    each(tr.getElementsByTagName('INPUT'), function() { this.checked = false; }, 4, 5);
    return test
};
...
*/
ggAdmin = {
    ggType: ['r2c1', 'r3c1,r3c3,r3c4', 'r4c1,r4c4,r4c5,r4c6,r4c11', 'r5c1,r5c5,r5c6,r5c10,r5c16,r5c20,r5c26', 'r6c1,r6c6,r6c7,r6c15,r6c20,r6c22,r6c35,r6c42,r6c50,r6c57', 'r7c1,r7c7,r7c8,r7c21,r7c35,r7c120', 'r8c1,r8c8,r8c9,r8c28,r8c56,r8c70,r8c247'],
...
function App(){
    ...
    intInputChange($id('tb_Share'), function() {//份数
        ...
        if (!OK) {if (confirm("份数为 0 或者不能除尽，将产生误差，并且金额不能小于 1 元。按“确定”重新输入，按“取消”自动更正为 1 份，请选择。")) {o_tb_Share.focus();return;}
...
function getC(v) {
    if ($("#lotType").val() == 'zqbf') return selectTable.__valToString[v];
    if ($("#lotType").val() == 'bqc') return table_vs.__valToChk[v];
    if ($("#lotType").val() == 'spf') return selectTable.__valToChkSFC[v];
    if ($("#lotType").val() == 'zjq') return selectTable.__valToString[v];
    return +v;
}
