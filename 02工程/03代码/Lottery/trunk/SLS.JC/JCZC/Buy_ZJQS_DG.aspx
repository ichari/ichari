<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_ZJQS_DG.aspx.cs" Inherits="JCZC_Buy_ZJQS_DG" EnableViewState="false"%>
...
<body>
    ...
    <div class="fsds">
      ...
      <input type="radio" onclick="window.location.href='Buy_ZJQS.aspx'">
...
<div style="width:240px; float:right;">
  ...
  <td colspan="2"><table class="table_bdtz_gg" width="100%" border="0" cellpadding="4" cellspacing="0">
    <tbody><tr class="t02">
      ...
      <td align="left" class="bnone" valign="middle" style="width:120px" colspan="2">
  ...
  <td valign="top"><table class="table_jczqtz_gg" style="" width="240px"  border="0" cellpadding="4" cellspacing="0">
...
<script type="text/javascript" src="JScript/dg_jqs.js"></script>
