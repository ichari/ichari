<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BuyConfirm.aspx.cs" Inherits="JCZC_BuyConfirm"%>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="listtable_c" style="line-height: 22px;">
                                &nbsp;--方案注数<asp:Label ID="labNum" runat="server" class="red"></asp:Label>注，倍数<asp:Label ID="labMultiple" runat="server" class="red"></asp:Label>倍，总金额￥<asp:Label ID="labSchemeMoney" runat="server" class="red"></asp:Label>元。</br>
                                &nbsp;--方案总份数<asp:Label ID="labShare" runat="server" class="red"></asp:Label>，购买份数<asp:Label ID="labBuyShare" runat="server" class="red"></asp:Label>，保底金额￥<asp:Label ID="labAssureMoney" runat="server" class="red"></asp:Label>元。
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="listtable_c none_line" style="padding-bottom: 20px;">
                                <br />
                                <ShoveWebUI:ShoveConfirmButton ID="btnOK" BackgroupImage="../images/btn_sms.gif" runat="server" Style="cursor: pointer;" Height="37" Width="143" OnClick="btnOK_Click" />
                                <br />
                                <br />
