...
public partial class JCZC_Buy_BQC_DG : System.Web.UI.Page
{
    ...
    {
        //赛事缓存30分钟
        DataTable dt = Shove._Web.Cache.GetCacheAsDataTable("DataCache_Matchs_72_IsHafu_dg");
        ...
        if (dt == null || dt.Rows.Count == 0)
        {
            ...
            dt = Shove.Database.MSSQL.Select("SELECT * FROM [T_singleRate]  where IsHafu = 1 and DATEADD(minute, (select SystemEndAheadMinute from T_PlayTypes where id = 7204) * -1, StopSellTime) > GETDATE()  order by [Day], MatchNumber");
            ...
            if (dt != null)
            {
                Shove._Web.Cache.SetCache("DataCache_Matchs_72_IsHafu_dg", dt, 0);
            }
    ...
    private void createHTML(DataTable dt, ref string strHTML, ref int jzCount, ref string strlgList)
    {
        ...
        System.Data.DataTable table = play.Open("SystemEndAheadMinute", "id=7204", "");
        ...
        if (dt.Rows != null && dt.Rows.Count > 0)
        {
            ...
            try
            {
                foreach (DataRow dr in dt.Rows)
                {
                    ...
                    sb.AppendLine("<tr class=\"" + lineStyle + "\" zid=\"" + dr["MatchID"].ToString() + "\" mid=\"" + dr["MatchID"].ToString() + "\" pname=\"" + (((int)startDate.DayOfWeek) == 0 ? 7 : ((int)startDate.DayOfWeek)).ToString() + dr["MatchNumber"].ToString().Substring(dr["MatchNumber"].ToString().Length - 3) + "\" pdate=\"" + OldDay.Insert(6, "-").Insert(4, "-") + "\"  lg=\"" + dr["Game"].ToString() + "\" odds=\"" + dr["ss"].ToString() + "," + dr["sp"].ToString() + "," + dr["sf"].ToString() + "," + dr["ps"].ToString() + "," + dr["pp"].ToString() + "," + dr["pf"].ToString() + "," + dr["fs"].ToString() + "," + dr["fp"].ToString() + "," + dr["ff"].ToString() + "\">")
                        ...
                        .AppendLine("<td>" + saleEndDate.AddMinutes(time * -1).ToString("HH:mm") + "</td><td>" + dr["MainTeam"].ToString() + "</td>")
                        .AppendLine("<td>" + dr["GuestTeam"].ToString() + "</td>")
                        .AppendLine("<td>析 亚 欧</td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"33\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["ss"].ToString(), 0) > 0 ? Shove._Convert.StrToDouble(dr["ss"].ToString(), 0).ToString("F2") : "") + "</span></td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"31\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["sp"].ToString(), 0) > 0 ? Shove._Convert.StrToDouble(dr["ss"].ToString(), 0).ToString("F2") : "") + "</span></td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"30\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["sf"].ToString(), 0) > 0 ? Shove._Convert.StrToDouble(dr["sf"].ToString(), 0).ToString("F2") : "") + "</span></td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"13\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["ps"].ToString(), 0) > 0 ? Shove._Convert.StrToDouble(dr["ps"].ToString(), 0).ToString("F2") : "") + "</span></td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"11\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["pp"].ToString(), 0) > 0 ? Shove._Convert.StrToDouble(dr["pp"].ToString(), 0).ToString("F2") : "") + "</span></td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"10\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["pf"].ToString(), 0) > 0 ? Shove._Convert.StrToDouble(dr["pf"].ToString(), 0).ToString("F2") : "") + "</span></td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"03\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["fs"].ToString(), 0) > 0 ? Shove._Convert.StrToDouble(dr["fs"].ToString(), 0).ToString("F2") : "") + "</span></td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"01\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["fp"].ToString(), 0) > 0 ? Shove._Convert.StrToDouble(dr["fp"].ToString(), 0).ToString("F2") : "") + "</span></td>")
                        .AppendLine("<td class=\"sp_bg\" style=\"cursor:pointer\"><input type=\"checkbox\" value=\"00\" /><br /><span>" + (Shove._Convert.StrToDouble(dr["ff"].ToString(), 0) > 0 ? Shove._Convert.StrToDouble(dr["ff"].ToString(), 0).ToString("F2") : "") + "</span></td>")
