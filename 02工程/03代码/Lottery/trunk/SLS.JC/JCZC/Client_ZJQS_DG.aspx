<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Client_ZJQS_DG.aspx.cs" Inherits="JCZC_Client_ZJQS_DG" EnableViewState="false"%>
    ...
    <div style="width:814px;">
        <div style="width:814px;">
            ...
            <div class="touzhu" style="border-top-color: #FFF;">
                ...
                <!-- 日期选择开始 -->
                <div style="position: absolute; display:none; left: 530px; top: 230px;">
                </div>
                  <!-- 开始对阵列表 !-->
...
<script type="text/javascript" src="JScriptClient/dg_jqs.js"></script>
