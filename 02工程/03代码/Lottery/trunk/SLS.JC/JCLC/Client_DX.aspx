<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Client_DX.aspx.cs" Inherits="JCLC_Client_DX" EnableViewState="false"%>
...
<body>
    <form id="buy_form" runat="server" ajax="Buy_Handler.ashx">
                                        ...
                                        <tr>
                                            <td>
                                                <table class="table_bdtz_gg_lq" width="100%" border="0" cellpadding="4" cellspacing="0">
                                                    ...
                                                    <tbody id="row_tpl" style="display:none;"><tr class="t03"><td><input checked="checked" value="2929" name="m2929" type="checkbox"><span>周四006</span></td><td align="center">巴兰基利亚青年 VS 蒙特维迪奥竞技</td><td align="center" class="bnone"><label style="display: none;"><input checked="checked" value="1" type="checkbox">大分</label><label style="display: none;"><input checked="checked" value="2" type="checkbox">小分</label></td></tr></tbody>
	  ...
	  <div class="layer2">
		<div class="lay_box4">
		  <div class="title_t title_t4 clear"><h4><span id="popWindowTitle">竞彩篮球奖金明细</span></h4><a href="javascript:void(0)" class="del" title="关闭" onclick="document.getElementById('popWindow').style.display='none'" alt="关闭">关闭</a></div>
...
<script type="text/javascript" src="JScriptClient/gg_dxf.js"></script>
