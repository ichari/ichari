<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_SF.aspx.cs" Inherits="JCZC_Buy_SF" EnableViewState="false"%>
    ...
    <div id="gc_bg">
        <div id="position">
            <span class="fa">当前位置：<a href="/" target="_parent">首页</a> > <a href="/jclc/buy_sf.aspx" target="_parent">
                篮球投注</a> > </span><span class="sub_t">胜负(最多选择8场赛事)</span></div>
        <div id="wrap">
            ...
            <div class="choice">
                <div class="fsds">
                    <div class="l">
                        <input type="radio" onclick="window.location.href='Buy_SF_DG.aspx'">
                        <label for="dgjc">
