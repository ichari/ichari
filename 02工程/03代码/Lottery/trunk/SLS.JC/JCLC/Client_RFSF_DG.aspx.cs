...
public partial class JCLC_Client_RFSF_DG : System.Web.UI.Page
{
    ...
    private DataTable getMatchs()
    {
        ...
        if (dt == null || dt.Rows.Count == 0)
        {
            ...
            dt = Shove.Database.MSSQL.Select("SELECT * FROM [T_SingleRateBasket]  where IsHdc = 1 and StopSellTime > GETDATE() order by [Day], MatchNumber");
