<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_RFSF_DG.aspx.cs" Inherits="JCLC_Buy_RFSF_DG" EnableViewState="false"%>
            ...
            <div class="choice">
                <div class="fsds">
                    <div class="l">
                        ...
                        <input type="radio" onclick="window.location.href='Buy_RFSF.aspx'">
                        <label for="ggjc">
                                ...
                                <table class="table_jczqtz_gg_lq" width="240px" border="0" cellpadding="4" cellspacing="0">
                                    <tbody>
                                        <tr>
                                            ...
                                            </td><td style="background-color:rgb(248, 217, 182); width:40px; text-align:right;"><span style="cursor: pointer; background-color:rgb(248, 217, 182); font-size:16px; font-weight:bold; color:Red;" id="clearAllSelect">×&nbsp;</span></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">
...
<script type="text/javascript" src="JScript/dg_1.js"></script>
