...
public partial class JCLC_Buy_SFC : System.Web.UI.Page
{
    ...
    private DataTable getMatchs()
    {
        ...
        if (dt == null || dt.Rows.Count == 0)
        {
            ...
            dt = Shove.Database.MSSQL.Select("SELECT * FROM [T_PassRateBasket]  where IsWnm = 1 and DATEADD(minute, (select SystemEndAheadMinute from T_PlayTypes where id = 7303) * -1, StopSellTime) > GETDATE() order by [Day], MatchNumber");
