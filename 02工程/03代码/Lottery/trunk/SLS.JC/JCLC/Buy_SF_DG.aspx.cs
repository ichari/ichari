...
public partial class JCZC_Buy_SF_DG : System.Web.UI.Page
{
    ...
    private DataTable getMatchs()
    {
        ...
        if (dt == null || dt.Rows.Count == 0)
        {
            ...
            dt = Shove.Database.MSSQL.Select("SELECT * FROM [T_SingleRateBasket]  where IsMnl = 1 and DATEADD(minute, (select SystemEndAheadMinute from T_PlayTypes where id = 7301) * -1, StopSellTime) > GETDATE() order by [Day], MatchNumber");
