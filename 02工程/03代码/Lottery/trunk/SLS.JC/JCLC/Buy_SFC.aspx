<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_SFC.aspx.cs" Inherits="JCLC_Buy_SFC" EnableViewState="false"%>
    ...
    <div id="gc_bg">
        <div id="position">
            <span class="fa">当前位置：<a href="/" target="_parent">首页</a> > <a href="/jclc/buy_sf.aspx" target="_parent">
                篮球投注</a> > </span><span class="sub_t">胜分差(最多选择8场赛事)</span></div>
        <div id="wrap">
            <div class="nav_button">
                <ul>
                    <li class="butt2"><a href="Buy_SF.aspx">胜负</a></li>
                    <li class="butt2"><a href="Buy_RFSF.aspx">让分胜负</a></li>
                    <li class="butt1"><a href="Buy_SFC.aspx">胜分差</a></li>
                    ...
                    <li style="float:right; width:280px; text-align:right;">
                        ...
                        <a href="/Help/play_7303.aspx" target="_blank">玩法介绍</a>                        
                    </li>
                </ul>
            </div>
            <div class="choice">
                <div class="fsds">
                    <div class="l">
                        <input type="radio" onclick="window.location.href='Buy_SFC_DG.aspx'">
                        <label for="dgjc">
                                        ...
                                        <tr>
                                            <td colspan="2">
                                                <table class="table_bdtz_gg_lq" width="100%" border="0" cellpadding="4" cellspacing="0">
                                                    ...
                                                    <tbody id="row_tpl" style="display:none;"><tr class="t03"><td width="72px" align="center"><input checked="checked" value="2929" name="m2929" type="checkbox" /><span>周四006</span></td><td align="center">巴兰基利亚青年 VS 蒙特维迪奥竞技</td><td align="center" class="bnone" style="width:114px;">
                                                    <label style="display:none"><input type="checkbox"checked="checked"value="2" visible="false" style="display:none"/><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:68px; margin-top:6px; margin-bottom:4px;">主胜1-5</div></em></label>
                                                    <label style="display:none"><input type="checkbox"checked="checked"value="4" visible="false" style="display:none" /><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:68px; margin-top:6px; margin-bottom:4px;">主胜6-10</div></em></label>
                                                    <label style="display:none"><input type="checkbox"checked="checked"value="6" visible="false" style="display:none" /><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:68px; margin-top:6px; margin-bottom:4px;">主胜11-15</div></em></label>
                                                    <label style="display:none"><input type="checkbox"checked="checked"value="8" visible="false" style="display:none" /><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:68px; margin-top:6px; margin-bottom:4px;">主胜16-20</div></em></label>
                                                    <label style="display:none"><input type="checkbox"checked="checked"value="10" visible="false" style="display:none" /><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:68px; margin-top:6px; margin-bottom:4px;">主胜21-25</div></em></label>
                                                    <label style="display:none"><input type="checkbox"checked="checked"value="12" visible="false" style="display:none" /><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:68px; margin-top:6px; margin-bottom:4px;">主胜26+</div></em></label>
                                                    <label style="display:none"><input type="checkbox"checked="checked"value="1" visible="false" style="display:none" /><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:68px; margin-top:6px; margin-bottom:4px;">客胜1-5</div></em></label>
                                                    <label style="display:none"><input type="checkbox"checked="checked"value="3" visible="false" style="display:none" /><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:68px; margin-top:6px; margin-bottom:4px;">客胜6-10</div></em></label>
                                                    <label style="display:none"><input type="checkbox"checked="checked"value="5" visible="false" style="display:none" /><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:68px; margin-top:6px; margin-bottom:4px;">客胜11-15</div></em></label>
                                                    <label style="display:none"><input type="checkbox"checked="checked"value="7" visible="false" style="display:none" /><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:68px; margin-top:6px; margin-bottom:4px;">客胜16-20</div></em></label>
                                                    <label style="display:none"><input type="checkbox"checked="checked"value="9" visible="false" style="display:none" /><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:68px; margin-top:6px; margin-bottom:4px;">客胜21-25</div></em></label>
                                                    <label style="display:none"><input type="checkbox"checked="checked"value="11" visible="false" style="display:none" /><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'"><div style="width:68px; margin-top:6px; margin-bottom:4px;">客胜26+</div></em></label>
                                                    </td><td><input type="checkbox" name="danma2929" value="2929" onclick="return damaclick(this,2929);" /></td></tr></tbody>
                ...
                <div class="lay_box4">
                    <div class="title_t title_t4 clear">
                        ...
                        <a href="javascript:void(0)" class="del" title="关闭" onclick="document.getElementById('popWindow').style.display='none'"
                            alt="关闭" style="float:right;">关闭&nbsp;</a></div>
...
<script type="text/javascript" src="JScript/gg_sfc.js"></script>
