<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_SFC_DG.aspx.cs" Inherits="JCLC_Buy_SFC_DG" EnableViewState="false"%>
            ...
            <div class="choice">
                <div class="fsds">
                    <div class="l">
                        ...
                        <input type="radio" onclick="window.location.href='Buy_SFC.aspx'">
                        <label for="ggjc">
...
<script type="text/javascript" src="JScript/dg_sfc.js"></script>
