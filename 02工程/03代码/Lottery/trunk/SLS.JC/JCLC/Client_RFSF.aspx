<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Client_RFSF.aspx.cs" Inherits="JCLC_Client_RFSF" EnableViewState="false"%>
                                        ...
                                        <tr>
                                            <td>
                                                <table class="table_bdtz_gg_lq" width="100%" border="0" cellpadding="4" cellspacing="0">
                                                    ...
                                                    <tbody id="row_tpl" style="display:none;"><tr class="t03"><td><input checked="checked" value="2929" name="m2929" type="checkbox"><span>周四006</span></td><td align="center">巴兰基利亚青年 VS 蒙特维迪奥竞技</td><td align="center" class="bnone"><label style="display: none;"><input checked="checked" value="1" type="checkbox">主负</label><label style="display: none;"><input checked="checked" value="2" type="checkbox">主胜</label></td></tr></tbody>
...
<script type="text/javascript" src="JScriptClient/gg_rf.js"></script>
