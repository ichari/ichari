<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_DX_DG.aspx.cs" Inherits="JCLC_Buy_DX_DG" EnableViewState="false"%>
            ...
            <div class="choice">
                <div class="fsds">
                    <div class="l">
                        ...
                        <input type="radio" onclick="window.location.href='Buy_DX.aspx'">
                        <label for="ggjc">
					...
					<tr>
						<td valign="top" width="58%">
							<table class="table_jczqtz_gg_lq" width="240px" border="0" cellpadding="4" cellspacing="0">
								<tbody>
									<tr>
										<td class="jczqtouzu_title_gg_lq" width="200px"><span class="bold">确认投注信息</span></td>
										...
										<td colspan="2">
											<table class="table_bdtz_gg_lq" width="100%" border="0" cellpadding="4" cellspacing="0">
												...
												<tbody id="row_tpl" style="display:none">
                                                    <tr class="t03"><td width="75px" align="center"><input checked="checked" value="2929" name="m2929" type="checkbox" /><span>周四006</span></td><td align="center">巴兰基利亚青年 VS 蒙特维迪奥竞技</td><td align="left" class="bnone" width="71px">&nbsp;<label style="display: none;"><input checked="checked" value="1" type="checkbox" visible="false" style="display:none" /><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'">大分</em></label><label style="display: none;"><input checked="checked" value="2" type="checkbox" visible="false" style="display:none" /><em class="x_s" onmouseover="javascript:this.className='x_s nx_s'" onmouseout="javscript:this.className='x_s'">小分</em></label></td></tr>
												</tbody>
