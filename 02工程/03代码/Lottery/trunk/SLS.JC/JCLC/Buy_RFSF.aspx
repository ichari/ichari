<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_RFSF.aspx.cs" Inherits="JCLC_Buy_RFSF" EnableViewState="false"%>
    ...
    <div id="gc_bg">
        <div id="position">
            <span class="fa">当前位置：<a href="/" target="_parent">首页</a> > <a href="/jclc/buy_sf.aspx" target="_parent">
                篮球投注</a> > </span><span class="sub_t">让分胜负(最多选择8场赛事)</span></div>
        <div id="wrap">
            <div class="nav_button">
                <ul>
                    <li class="butt2"><a href="Buy_SF.aspx">胜负</a></li>
                    <li class="butt1"><a href="Buy_RFSF.aspx">让分胜负</a></li>
                    ...
                    <li style="float:right; width:280px; text-align:right;">
                        ...
                        <a href="/Help/play_7302.aspx" target="_blank">玩法介绍</a>                        
                    </li>
                </ul>
            </div>
            <div class="choice">
                <div class="fsds">
                    <div class="l">
                        <input type="radio" onclick="window.location.href='Buy_RFSF_DG.aspx'">
                        <label for="dgjc">
            ...
            <div class="touzhu" style="border-top-color: #FFF;">
                <div class="reply_type_01">
                    ...
                    已隐藏<span class="red" id="hideCount">0</span>场比赛 <a href="javascript:void 0" id="showAllTeam">
                        ...
                        <span class="red">&nbsp;玩法提示：篮球惯例客队在前；让分只适合“让分胜负”玩法，“-”为主让客，“+”为客让主</span>
                </div>
                <div>
                <div class="ss_slect">
...
<div class="touzhu" style="width:750px; float:left;border-top-color: #FFF;">
                <table class="ttd showodds" id="table_vs" width="100%" border="0" cellpadding="0"
                    ...
                    <tbody>
						...
						<td width="100" rowspan="2">赛事编号</td>
						<td width="160" rowspan="2">赛事类型 </td>
						<td width="100" rowspan="2">截止时间</td>
						<td width="130" rowspan="2">客队</td>
						<td width="50" rowspan="2">让分</td>
						<td width="130" rowspan="2">主队</td>
						<td colspan="3">请选择投注</td>
					</tr>
					<tr class="gg_form_tr_02_lq">
						<td width="80" class="s">主负</td>
						<td width="80" class="s">主胜</td>
						<td width="40">全包</td>
					</tr>
                        <%= MatchList %>
                    </tbody>
...
<div style="width:240px; float:right;">
    ...
    <uc2:WebFoot ID="WebFoot1" runat="server" />
        ...
        <input type="hidden" id="playid" name="playid" value="7302" />
...
<script type="text/javascript" src="JScript/gg_rf.js"></script>
