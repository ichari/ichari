...
public class Buy_Dg_Handler : IHttpHandler, IReadOnlySessionState
{
    ...
    private void Buy(HttpContext context)
    {
        ...
        System.Data.DataTable dt = Shove.Database.MSSQL.Select(Shove._Web.WebConfig.GetAppSettingsString("ConnectionString"), "SELECT StopSellTime from T_SingleRateBasket where MatchID=" + FireTeam, null);
