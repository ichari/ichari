...
<body>
    ...
    <div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="listtable_c none_line" style="padding-bottom: 20px;">
                                <br>
                                <ShoveWebUI:ShoveConfirmButton ID="btnOK" BackgroupImage="images/btn_sms.gif"
                                                runat="server" Style="cursor: pointer;" Height="37" Width="143" OnClick="btnOK_Click" OnClientClick="return CreateLogin('btnOKClick()');" />
                                <br>
                                <br>
                                <input id="agreement" checked="checked" type="checkbox">
                                <label for="agreement">
                                    我已阅读了<a href="agreement.htm" target="_blank">《用户合买代购协议》</a>并同意其中条款。</label>
                                <br>
                            </td>
                        </tr>
                    </tbody>
        ...
        <input type='hidden' name='hidcodes' id="hidcodes" value='1' runat="server"/>
