<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LotteryPackage.aspx.cs" Inherits="LotteryPackage" %>
...
<head id="Head1" runat="server">
    ...
    <script src="JScript/LotteryPackage.js" type="text/javascript"></script>
    <script src="JScript/Marquee.js" type="text/javascript"></script>
    <script type="text/javascript">
        $(document).ready(function () {
            $("#WebHead1_currentMenu").val("mYear");
        });
    </script>
...
<div class="w970">
    <table width="960" border="0" cellspacing="0" cellpadding="0">
        <tr>
                            ...
                            <table cellspacing="0" width="100%" cellpadding="0" border="0">
                                <tbody>
                                    <tr class="bg1x bgp5">
                                        ...
                                        <td width="90" align="center" onclick="ClickLottery(this,0)" style="cursor:pointer;"  id="tdLottery5">
                                            双色球
                                        </td>
                                        <td width="90" align="center" onclick="ClickLottery(this,1)" style="cursor:pointer;" id="tdLottery6">
                                           福彩3D
                                        </td>
                                        <!---td width="90" align="center" onclick="ClickLottery(this,7)" style="cursor:pointer;" id="tdLottery13">
                                            七乐彩
                                        </td--->
                                    ...
                                    <tr>
                                        <td height="2" colspan="5" bgcolor="#FF6600">
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                                    ...
                                    <tr>
                                        <td height="15" align="left">
                                            <table style="margin-top: 10px" cellspacing="0" cellpadding="0" width="100%" border="0">
                                                <tbody>
                                                    <tr>
                                                        <td width="150" height="32" class="red14">
                                                            <span id="spanLotteryName"></span>套餐服务
                                                        </td>
                                                        <td width="4">
                                                            &nbsp;
                                                        </td>
                                                        <td width="120" align="center" onclick="ClickTC(this,1);" style="cursor:pointer;" id="tdTC1">
                                                            吉祥套餐(包月)
                                                        </td>
                                                        <td width="4">
                                                            &nbsp;
                                                        </td>
                                                        <td width="120" align="center" onclick="ClickTC(this,2);" style="cursor:pointer;" id="tdTC2">
                                                            如意套餐(包季)
                                                        </td>
                                                        <td width="2">
                                                            &nbsp;
                                                        </td>
                                                        <td width="120" align="center" onclick="ClickTC(this,3);" style="cursor:pointer;" id="tdTC3">
                                                            幸福套餐(半年)
                                                        </td>
                                                        <td width="2">
                                                            &nbsp;
                                                        </td>
                                                        <td width="120" align="center" onclick="ClickTC(this,4);" style="cursor:pointer;" id="tdTC4">
                                                            安康套餐(包年)
                                                        </td>
                                    ...
                                    <tr>
                                                ...
                                                <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td height="36" colspan="2" align="left" class="black12">
                                                            <img src="Home/Room/images/1_2.jpg" width="19" height="14" />&nbsp;&nbsp; 追号标题：<input type="text"  id="tbTitle" name="tbTitle" size="45" />&nbsp;&nbsp;选取一个好的追号标题,也会有意外的幸运收获哦！
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td height="36" colspan="2" align="left" class="black12">
                                                    ...
                                                    <tr id="trPlayTypes">
                                                        <td colspan="2" align="left">
                                                            <iframe id="iframe_playtypes" name="iframe_playtypes" width="100%" frameborder="0" src="Home/Room/Chase/SSQ.htm" scrolling="no" onload="document.getElementById('iframe_playtypes').height=iframe_playtypes.document.body.scrollHeight;">
                                                            </iframe>
                                                        </td>
                                                    </tr>
                                                    <tr id="trPlayTypes_JX">
                                                        <td height="9" colspan="2" align="left" class="black12">
                                                            <table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" bgcolor="#C0D0E9"
                                                                class="table">
                                                                <tr>
                                                                    <td width="152" height="29" align="left" background="Home/Room/images/by_bg_r1_c3.jpg" bgcolor="#e7f1fa"  style="padding-left: 5px">
                                                                ...
                                                                <tr id="trXYXH" style="display: none">
                                                                    <td height="81" bgcolor="#ffffff">
                                                                        <table cellspacing="0" cellpadding="0" width="100%" background="Home/Room/images/ssq_qh_bg.jpg"  border="0">
                                                                            <tbody>
                                                                                <tr>
                                                                        ...
                                                                        <table style="background-position: center bottom; background-image: url(Home/Room/images/ssq_bg_di.jpg); background-repeat: repeat-x" cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td height="50" style="padding-right: 10px; padding-left: 10px; padding-bottom: 10px; padding-top: 5px">
                                                                                                    ...
                                                                                                    <td width="20%" height="30" valign="bottom">
                                                                                                        <span id="spanXZ">
                                                                                                            ...
                                                                                                            <asp:TextBox ID="tbDate" runat="server" Width="80" CssClass="hui12" ToolTip="格式：1980-01-01"
                                                                                                                Text="1980-01-01" onfocus="this.value='';" onblur="if(this.value==''){this.className='hui12'; this.value='1980-01-01';}"></asp:TextBox>
                                                                                                        </span><span id="spanXM" style="display: none">
                                                                                                            <asp:TextBox ID="tbName" runat="server" Width="80" CssClass="hui12" ToolTip="支持中英文"
                                                                                                                Text="支持中英文" onfocus="if(this.value=='支持中英文') {this.value='';}"
                                                                                                                onblur="if(this.value=='') {this.className='hui12';this.value='支持中英文';}"></asp:TextBox>
                                                                                                        </span>
                                                                                                    </td>
                                                                                                    <td width="24%" style="padding-top:10px">
                                                                                                        <img src="Home/Room/images/ssq_bt_1.jpg" width="100" height="21" alt="" border="0" style="cursor: pointer" onclick="return GetLuckNumber()" />
                                                                                                    </td>
                                                                ...
                                                                <tr id="trSJXH" style="display: none">
                                                                    <td height="50" bgcolor="#ffffff">
                                                                        <table style="background-position: center bottom; background-image: url(Home/Room/images/ssq_bg_di.jpg); background-repeat: repeat-x;" cellspacing="0" cellpadding="0" width="100%" border="0">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td  height="50" align="center" class="blue12" style="padding-right: 10px; padding-left: 10px; padding-bottom: 10px; padding-top: 5px">
                                                                                        <img src="Home/Room/images/1.gif" width="18" height="16" />
                                                                                    </td>
                                                                                    <td class="blue12"  align="left"style="padding-right: 10px; padding-left: 0px; padding-bottom: 3px; padding-top: 3px;">
                                                                                       选择随机选号购买追号套餐时，系统将自动为您在指定追号期间内，每期随机选出一或者多注号码进行投注。
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                                                        </table>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td height="24" align="left" class="pb10 af00">
                                                         套餐时长：约<span class="red14" id="spanMonthCount"></span>个月 投注期数：<span class="red14"
                                                            ...
                                                            套餐单价：<span class="red14" id="spanMoney1"></span>元</td>
                                                    </tr>
                                                    <tr id="trPlayTypes1">
                                                    <td height="40" colspan="2" align="center" class="black12"><img src="Home/Room/images/zfb_bt_queren.jpg" width="146" height="33" id="btn_2_Add" style="cursor:pointer" onclick="iframe_playtypes.btn_2_AddClick();"/></td>
                                                    </tr>
                                                    <tr id="trPlayTypes2">
                                        <td  width="460px" valign="top" style="padding-left:28px" align="left">
                                            <select  name="list_LotteryNumber" multiple="multiple" id="list_LotteryNumber" style="width: 550px; height: 150px;">
                                            </select>
                                        </td>
                                        <td width="134" style="padding-left: 10px;padding-bottom:10px">
                                            <table width="100%" cellspacing="0" cellpadding="0">
                                                ...
                                                <tr>
                                                    <td height="30">
                                                        <input type="button" name="btn_ClearSelect" id="btn_ClearSelect" value="删除选择" style="cursor: pointer; width: 80px;" onclick="return btn_ClearSelectClick();" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td height="30">
                                                        <input type="button" name="btn_Clear" id="btn_Clear" value="清空全部" style="cursor: pointer; width: 80px;" onclick="return btn_ClearClick();" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                                    ...
                                                    <tr>
                                                        <td colspan="2" align="center"><img src="Home/Room/images/bt_xiayibu.jpg" style="cursor:pointer;" onclick="return btnNext_OK()" width="91" height="28" border="0" alt="" /></td>
                                                    </tr>
                                                </table>
                                            </div>
                                            <div id="CustomChaseTwo" runat="server" style="display: none">
                                                <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td height="36" align="left" class="hui14_2">
                                                            <p>您购买的是：<span id="spanChaseType"></span></p>
                                                            <p>追号标题是：<input type="text" id="tbTitle1" name="tbTitle1" size="50" /></p>
                                                            <p>您设定的具体内容是：每期<span id="spanBetType"></span><span class="red14" id="spanLotteryNum2">1</span>注、投注期为<span
                                                                    class="red14" id="spanIsuseCount2"></span>期、每期投注倍数为<span class="red14" id="spanMultiple">1</span>倍、截止条件为
                                                                    <span class="red14">完成方案</span></p>
                                                            <p>合计金额：<span class="red14" id="spanMoney2"></span>元</p>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                ...
                                                <div id="NoLogin" runat="server">
                                                    <iframe id="iframe_Login" name="iframe_Login" width="100%" frameborder="0" scrolling="no" height="240px"></iframe>
                                                </div>
                                                <div id="Login" runat="server">
                                                    <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
                                                        <tr>
                                                            <td height="54" align="left" class="hui12" style="padding-left: 36px;" width="20%">
                                                                <asp:ImageButton ID="btnOK" runat="server" ImageUrl="Home/Room/images/bt_tijiao.jpg" Width="120px" Height="32px" OnClick="btnOK_Click"  />
                                                            </td>
            ...
            <td align="right" valign="top" align="right" style="padding-top:10px;">
                <table width="260" border="0" align="right" cellpadding="0" cellspacing="1" bgcolor="#E3E3E4">
                    <tr>
                        <td height="32" class="bg1x bgp5" align="left">
                            <div class="bg1x bgp1 fs14 afff tc" style="width:120px; height:32px; line-height:32px;">追号套餐小喇叭</div>
                        </td>
                    </tr>
                    <tr>
...
<script type="text/javascript">
   ...
   //         }
       // }
  var bevaa = document.getElementById('tdLottery5');
  var bevbb = document.getElementById('tdTC1');
  var bevcc = document.getElementById('hrefXYXH');
  var bevdd = document.getElementById('hrefXZ');
  ClickSJXH(bevcc,2);
  ClickXYJX(bevdd,1);
  ClickLottery(bevaa,0);
  ClickTC(bevbb,1);
