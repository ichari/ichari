<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_CJDLT.aspx.cs" Inherits="Lottery_Buy_CJDLT" %>
...
<head id="Head1" runat="server">
    <title>大乐透：3元赢取￥2400万-超级大乐透选号投注、合买、玩法介绍－<%=_Site.Name %></title>
    ...
    <script src="JScript/buy_CJDLT.js" type="text/javascript"></script>
            ...
            <div id="cz_center">
                ...
                <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 19%; text-align: center; vertical-align: middle;
                        ...
                        <img id="LotteryImg" src="../Home/Room/Images/logo_39.jpg" alt="大乐透" width="105"
                            height="108" />
                    </div>
                    <div style="float: left; width: 81%; margin-top: 0px;">
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">
                            <a href="<%= ResolveUrl("~/TrendCharts/CJDLT/Default.aspx") %>" target="_blank">大乐透走势图</a>&nbsp;&nbsp;
                            <a href="<%= ResolveUrl("~/WinQuery/39-0-0.aspx") %>" target="_blank">大乐透中奖查询</a>
                        </div>
                    </div>
                </div>
                <!-- 期信息结束 -->
                ...
                <div id="divNewBuy">
                    <table width="612" cellspacing="1" cellpadding="0" bgcolor="#C0DBF9" style="margin-top: 10px;
                        ...
                        <tbody>
                            ...
                            <input type='radio' name='playType' id='playType3907' value='3907' onclick='clickPlayType(this.value)' />胆拖
                            ...
                            <input type='radio' name='playType' id='playType3908' value='3908' onclick='clickPlayType(this.value)' />追加胆拖
                            ...
                            <input type='radio' name='playType' id='playType3909' value='3909' onclick='clickPlayType(this.value)' /><span class='blue12'>智能机选</span></td></tr>
                        </tbody>
                        <tr>
                ...
                <div style="width: 218px; border: solid 1px #BCD2E9; border-top: none; margin-bottom: 10px;">
                    <div style="text-align: center; padding: 15px 5px 10px 5px;">
                        <div id="divPlayIntroduce" style="background-image: url('Images/zfb_playIntroduce.jpg');
                            ...
                            <a href="../Help/play_39.aspx" target="_blank" style="text-decoration: none; cursor: hand;">
