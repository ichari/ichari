<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_15X5.aspx.cs" Inherits="Lottery_Buy_15X5" %>
...
<head id="Head1" runat="server">
    ...
    <script src="JScript/buy_15X5.js" type="text/javascript"></script>
            ...
            <div id="cz_center">
                ...
                <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 19%; text-align: center; vertical-align: middle;
                        ...
                        <img id="LotteryImg" src="../Home/Room/Images/logo_59.jpg" alt="15选5" width="105"
                            height="108" />
                    </div>
                ...
                <div id="TabMenu" style="margin-top: 15px; border-bottom: #FF6600 2px solid; text-align: center;
                    ...
                    <div id="td2" class="whiteMenu" onclick="schemeAll(<%=LotteryID %>);showSameHeight();">
                        全部方案</div>
                    <div style="float: left; width: 2px;">
                    </div>
                ...
                <div style="width: 218px; border: solid 1px #BCD2E9; border-top: none; margin-bottom: 10px;">
                    <div style="text-align: center; padding: 15px 5px 10px 5px;">
                        <div id="divPlayIntroduce" style="background-image: url('Images/zfb_playIntroduce.jpg');
                            ...
                            <a href="../Help/play_59.aspx" target="_blank" style="text-decoration: none; cursor: hand;">
