<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_SFC.aspx.cs" Inherits="Lottery_Buy_SFC" %>
...
<head id="Head1" runat="server">
    <title>胜负彩：看足球买彩票，2元可中￥500万！-胜负彩选号投注、合买、玩法介绍－<%=_Site.Name %></title>
    <meta name="keywords" content="胜负彩选号投注、胜负彩合买、胜负彩玩法介绍" />
    <meta name="description" content="<%=_Site.Name %>提供胜负彩选号投注、合买、玩法介绍等服务。" />
    ...
    <script src="JScript/buy_SFC.js" type="text/javascript"></script>
            ...
            <div id="cz_center">
                ...
                <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 19%; text-align: center;">
                        <img id="LotteryImg" src="../Home/Room/Images/logo_1.jpg" alt="胜负彩" width="105"
                            height="108" />
                    </div>
                    <div style="float: left; width: 81%; margin-top: 0px;">
                        ...
                        <div id="tdLotteryIntroduce" class="hui12" style="padding: 0px 0px 2px 0px;">
                            <h1 class='blue18' style="display:inline; ">胜负彩：看足球买彩票，2元可中￥500万！ </h1> 
                        </div>
                        <div class="black12" style="width: 100%; height: 24px; line-height: 24px;">
                            <asp:DropDownList ID="ddlIsuses" runat="server" onchange="loadLottery(74)"></asp:DropDownList>期&nbsp;截止时间:<span
                                id="currIsuseName" class="black12"></span>&nbsp;离截止还有:<span id='toCurrIsuseEndTime'
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%= ResolveUrl("~/WinQuery/74-0-0.aspx") %>" target="_blank">胜负彩中奖查询</a>
                        </div>
                    </div>
                </div>
                <!-- 期信息结束 -->
                ...
                <div id="divNewBuy">
                    <table width="612" cellspacing="1" cellpadding="0" bgcolor="#C0DBF9" style="margin-top: 10px;">
                        <tbody>
                            ...
                            <input type='radio' name='playType' id='playType7401' value='7401' checked='checked' onclick='clickPlayType(this.value)' />单式
                            <input type='radio' name='playType' id='playType7402' value='7402' onclick='clickPlayType(this.value)' />复式
                            <input type='radio' name='playType' id='playType74011' value='74011' onclick='clickPlayType(this.value)' />单式预投
                            <input type='radio' name='playType' id='playType74022' value='74022' onclick='clickPlayType(this.value)' />复式预投
</td></tr>
                        </tbody>
                        <tr id="trXH">
                                ...
                                <td align="left">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" onkeypress="return InputMask_Number();" id="tb_MinSchemeMoney" name="tb_MinSchemeMoney"
                                            ...
                                            onblur="return checkSchemeMoney(this);" style="width: 56px;" value="12" disabled="disabled" />元 <br />
