<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_PL3.aspx.cs" Inherits="Lottery_Buy_PL3" %>
...
<head id="Head1" runat="server">
    <title>排列3：2元赢取￥1000元-排列3选号投注、合买、玩法介绍－<%=_Site.Name %></title>
    <meta name="keywords" content="排列3选号投注、排列3合买、排列3玩法介绍" />
    <meta name="description" content="<%=_Site.Name %>提供排列3选号投注、合买、玩法介绍等服务。" />
    <script src="../JScript/Public.js" type="text/javascript"></script>
    <script src="JScript/buy_PL3.js" type="text/javascript"></script>
            ...
            <div id="cz_center">
                ...
                <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 19%; text-align: center; vertical-align: middle;
                        ...
                        <img id="LotteryImg" src="../Home/Room/Images/logo_63.jpg" alt="排列3" width="105"
                            height="108" />
                    </div>
                    <div style="float: left; width: 81%; margin-top: 0px;">
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">
                            <a href="<%= ResolveUrl("~/TrendCharts/PL3/Default.aspx") %>" target="_blank">排列三走势图</a>&nbsp;&nbsp;
                ...
                <div id="divNewBuy">
                    <table width="612" cellspacing="1" cellpadding="0" bgcolor="#C0DBF9" style="margin-top: 10px;
                        ...
                        <tbody>
                            <tr><td width='70' height='28' align='center' bgcolor='#F7F7F7' class='black12'>选择玩法</td>
                ...
                <div style="width: 218px; border: solid 1px #BCD2E9; border-top: none; margin-bottom: 10px;">
                    <div style="text-align: center; padding: 15px 5px 10px 5px;">
                        <div id="divPlayIntroduce" style="background-image: url('Images/zfb_playIntroduce.jpg');
                            ...
                            <a href="../Help/play_63.aspx" target="_blank" style="text-decoration: none; cursor: hand;">
