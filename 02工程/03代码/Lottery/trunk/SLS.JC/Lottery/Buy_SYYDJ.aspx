<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_SYYDJ.aspx.cs" Inherits="Lottery_Buy_SYYDJ" %>
...
<head id="Head1" runat="server">
     <title>十一运夺金：2元赢取￥1170元 -十一运夺金选号投注、合买、玩法介绍－<%=_Site.Name %></title>
    <meta name="keywords" content="十一运夺金选号投注、十一运夺金合买、十一运夺金玩法介绍" />
    <meta name="description" content="<%=_Site.Name %>提供十一运夺金选号投注、合买、玩法介绍等服务。" />
   
    <link href="../Style/dahecp.css" rel="stylesheet" type="text/css" />
    <link href="style/Buy_SYYDJ.css" rel="stylesheet" type="text/css" />
    <script src="../JScript/Public.js" type="text/javascript"></script>
    <script src="JScript/JScript.js" type="text/javascript"></script>
    <script src="JScript/buy_SYYDJ.js" type="text/javascript"></script>
...
<body onload="showSameHeight();">
        ...
        <div id="menu_right">
            <div id="cz_center">
               ...
               <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 19%;text-align:center;">
                        <img id="LotteryImg" src="../Home/Room/Images/logo_62.jpg" alt="十一运夺金" width="105" height="108" />
                    </div>
                    <div style="float: left; width: 80%;margin-top:6px;">
                        ...
                        <div id="tdLotteryIntroduce" class="hui12" style="padding: 8px 0px 2px 0px;">
                            <h1 class='blue18' style="display:inline; ">十一运夺金：2元赢取￥1170元</h1>每12分钟开奖，每天65期
                        </div>
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">
                            <a href="<%= ResolveUrl("~/TrendCharts/SYYDJ/SYDJ_FBZS.aspx") %>" target="_blank">十一运夺金走势图</a>&nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%= ResolveUrl("~/WinQuery/62-0-0.aspx") %>" target="_blank">十一运夺金中奖查询</a>
                        </div>
                    </div>
                </div>
                <!-- 期信息结束 -->
                ...
                <div id="TabMenu" style="margin-top: 15px; border-bottom: #FF6600 2px solid; text-align: center;
                    ...
                    <div class="redMenu" onclick="newBuy(62);showSameHeight();">
                        选号投注
                    </div>
                    <div style="float: left; width: 2px;">
                    </div>
                    <div class="whiteMenu" onclick="schemeAll(62);showSameHeight();">
                        全部方案</div>
                    <div style="float: left; width: 2px;">
                    </div>
                    <div class="whiteMenu" onclick="followScheme(62);showSameHeight();">
                        定制跟单</div>
                    <div style="float: left; width: 2px;">
                    </div>
                    <div class="whiteMenu1" onclick="playTypeIntroduce(62);showSameHeight();">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td bgcolor='#FFFFFF' class='black12' style='padding-left: 5px; padding-top: 5px;'>
                                    <table width='100%' cellpadding='0' border='0' cellspacing='0' style='text-align: center;
                                        margin-top: 5px;' id='tbPlayTypeMenu62'>
                                        <tr>
                            ...
                            <tr id='playTypes'>
                                ...
                                <td bgcolor='#FFFFFF' style='padding-left: 5px; text-align: left;'>
                                    <span id='playTypes0'>
                                        <input type='radio' name='playType' id='playType6201' value='6201' checked='checked'
                                            onclick='clickPlayType(this.value)' />复式
                                            </span>
                                            <span id='playTypes1'>
                                        <input type='radio' name='playType' id='playType6202' value='6202' onclick='clickPlayType(this.value)' />复式
                                        <input type='radio' name='playType' id='playType62022' value='62022' onclick='clickPlayType(this.value)' />胆拖
                                        </span>
                                        <span id='playTypes2'>
                                        <input type='radio' name='playType' id='playType6203' value='6203' onclick='clickPlayType(this.value)' />复式
                                        <input type='radio' name='playType' id='playType62033' value='62033' onclick='clickPlayType(this.value)' />胆拖
                                        </span>
                                        <span id='playTypes3'>
                                        <input type='radio' name='playType' id='playType6204' value='6204' onclick='clickPlayType(this.value)' />复式
                                        <input type='radio' name='playType' id='playType62044' value='62044' onclick='clickPlayType(this.value)' />胆拖
                                        </span>
                                        <span id='playTypes4'>
                                        <input type='radio' name='playType' id='playType6205' value='6205' onclick='clickPlayType(this.value)' />复式
                                        <input type='radio' name='playType' id='playType62055' value='62055' onclick='clickPlayType(this.value)' />胆拖
                                        </span>
                                        <span id='playTypes5'>
                                        <input type='radio' name='playType' id='playType6206' value='6206' onclick='clickPlayType(this.value)' />复式
                                        <input type='radio' name='playType' id='playType62066' value='62066' onclick='clickPlayType(this.value)' />胆拖
                                        </span>
                                        <span id='playTypes6'>
                                        <input type='radio' name='playType' id='playType6207' value='6207' onclick='clickPlayType(this.value)' />复式
                                        <input type='radio' name='playType' id='playType62077' value='62077' onclick='clickPlayType(this.value)' />胆拖
                                        </span>
                                        <span id='playTypes7'>
                                        <input type='radio' name='playType' id='playType6208' value='6208' onclick='clickPlayType(this.value)' />复式
                                    </span><span id='playTypes8' style='display: none;'>
                                        <input type='radio' name='playType' id='playType6210' value='6210' onclick='clickPlayType(this.value)' />直选
                                        <input type='radio' name='playType' id='playType6213' value='6213' onclick='clickPlayType(this.value)' />复选
                                        <input type='radio' name='playType' id='playType6212' value='6212' onclick='clickPlayType(this.value)' />组选
                                        <input type='radio' name='playType' id='playType62122' value='62122' onclick='clickPlayType(this.value)' />胆拖
                                    </span><span id='playTypes9' style='display: none;'>
                                        <input type='radio' name='playType' id='playType6209' value='6209' onclick='clickPlayType(this.value)' />直选
                                        <input type='radio' name='playType' id='playType6214' value='6214' onclick='clickPlayType(this.value)' />复选
                                        <input type='radio' name='playType' id='playType6211' value='6211' onclick='clickPlayType(this.value)' />组选
                                        <input type='radio' name='playType' id='playType62111' value='62111' onclick='clickPlayType(this.value)' />胆拖
                                    </span>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <tr>
                            <td height="30" colspan="2" bgcolor="#F7F7F7" align="center" style="padding-bottom: 20px;
                                ...
                                我已经阅读并同意 <span class="blue12">
                                    <asp:HyperLink runat="server" ID="hlAgreement" NavigateUrl="../Home/Room/BuyProtocol.aspx?LotteryID=62" Target="_blank">《用户电话短信投注协议》</asp:HyperLink></span><br />
            ...
            <div id="cz_right">
                ...
                <div style="margin-top: 10px; margin-bottom: 10px;">
                        ...
                        <img src="../Home/Room/Images/ad_250_80_syydj.gif" width="220" height="80" border="0" alt="十一运夺金代购/合买" />
                </div>
                 <!-- 中奖排行榜 开始-->
                <div style="width: 218px; background-color: #E7F1FA; border: solid 1px #BCD2E9; overflow: hidden;">
    ...
    <input id="HidLotteryID" name="HidLotteryID" type="hidden" value="62" />
