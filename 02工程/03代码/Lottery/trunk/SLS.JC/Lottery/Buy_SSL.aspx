<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_SSL.aspx.cs" Inherits="Lottery_Buy_SSL" %>
...
<head id="Head1" runat="server">
    ...
    <link href="style/Buy_SSL.css" rel="stylesheet" type="text/css" />
    <script type="text/javascript" language="javascript" src="../JScript/Public.js"></script>
    <script src="JScript/buy_SSL.js" type="text/javascript"></script>
...
<body onload="showSameHeight();">
 ...
 <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 19%; text-align: center;">
                        <img id="LotteryImg" alt="时时乐" src="../Home/Room/Images/logo_29.jpg" width="105" height="108" />
                    </div>
                    <div style="float: left; width: 80%; margin-top: 6px;">
                        ...
                        <div id="tdLotteryIntroduce" class="hui12" style="padding: 18px 0px 2px 0px;">
                            <h1 class='blue18' style="display:inline; ">时时乐：2元赢取￥980元</h1> &nbsp;&nbsp;&nbsp;<span id="IsuseCount"><img
                                src='../Home/Room/Images/londing.gif' alt="" /></span>
                        </div>
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">
                            <a href="<%= ResolveUrl("~/TrendCharts/SHSSL/SHSSL_ZHFB.aspx") %>" target="_blank">时时乐走势图</a>&nbsp;&nbsp;
                            <a href="<%= ResolveUrl("~/WinQuery/29-0-0.aspx") %>" target="_blank">时时乐中奖查询</a>
                        </div>
                    </div>
                </div>
                <!-- 期信息结束 -->
                ...
                <div style="width: 100%;">
                    ...
                    <div style="float: left; width: 85%;">
                        <iframe id="iframe2" name="iframeWinNotice" width="100%" height="25px" frameborder="0"
                            scrolling="no" src="../Home/Room/SSL_WinNotice.aspx"></iframe>
                    </div>
                </div>
                <!-- 中奖播报结束 -->
                <!-- 选项卡开始 -->
                <div id="TabMenu" style="margin-top: 15px; border-bottom: #FF6600 2px solid; text-align: center;
                    ...
                    <div class="redMenu" onclick="newBuy(29);showSameHeight();">
                        选号投注
                    </div>
                    <div style="float: left; width: 2px;">
                    </div>
                    <div class="whiteMenu" onclick="schemeAll(29);showSameHeight();">
                        全部方案</div>
                    <div style="float: left; width: 2px;">
                    </div>
                    <div class="whiteMenu" onclick="followScheme(29);showSameHeight();">
                        定制跟单</div>
                    <div style="float: left; width: 2px;">
                    </div>
                    <div class="whiteMenu1" onclick="playTypeIntroduce(29);showSameHeight();">
                                ...
                                <td bgcolor='#FFFFFF' class='black12' style='padding-left: 5px; padding-top: 5px;'>
                                    <table width='100%' cellpadding='0' border='0' cellspacing='0' style='text-align: center;
                                        ...
                                        <tr>
                                            ...
                                            <td class='msplay' onclick='clickPlayClass(0,this);showSameHeight();' onmouseover='mOver(this,1)'
                                                onmouseout='mOver(this,2)'>
                                                直选
                                            </td>
                                            <td width='1'>
                                            </td>
                                            <td class='nsplay' onclick='clickPlayClass(1,this);showSameHeight();' onmouseover='mOver(this,1)'
                                                onmouseout='mOver(this,2)'>
                                                组选单式
                                            </td>
                                            <td width='1'>
                                            </td>
                                            <td class='nsplay' onclick='clickPlayClass(2,this);showSameHeight();' onmouseover='mOver(this,1)'
                                                onmouseout='mOver(this,2)'>
                                                组选6
                                            </td>
                                            <td width='1'>
                                            </td>
                                            <td class='nsplay' onclick='clickPlayClass(3,this);showSameHeight();' onmouseover='mOver(this,1)'
                                                onmouseout='mOver(this,2)'>
                                                组选3
                                            </td>
                                            <td width='1'>
                                            ...
                                            <td class='nsplay' onclick='clickPlayClass(5,this);showSameHeight()' onmouseover='mOver(this,1)'
                                                onmouseout='mOver(this,2)'>
                                                前二后二
                                            </td>
                                            <td width='1'>
                                            </td>
                                            <td class='nsplay' onclick='clickPlayClass(6,this);showSameHeight();' onmouseover='mOver(this,1)'
                                                onmouseout='mOver(this,2)'>
                                                和值
                                            </td>
                                            <td>
                        ...
                        <tr>
                            <td height="30" colspan="2" bgcolor="#F7F7F7" align="center" style="padding-bottom: 20px;
                                ...
                                我已经阅读并同意 <span class="blue12">
                                    <asp:HyperLink runat="server" ID="hlAgreement" NavigateUrl="../Home/Room/BuyProtocol.aspx?LotteryID=29"
            ...
            <div id="cz_right">
                ...
                <div style="margin-top: 10px; margin-bottom: 10px;">
                        ...
                        <img src="../Home/Room/Images/ad_250_80.jpg" alt="会员注册" width="220" height="80" border="0" />
                </div>
                 <!-- 中奖排行榜 开始-->
