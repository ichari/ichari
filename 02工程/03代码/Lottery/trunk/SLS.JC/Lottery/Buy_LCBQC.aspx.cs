...
public partial class Lottery_Buy_LCBQC : RoomPageBase
{
    ...
    {
        AjaxPro.Utility.RegisterTypeForAjax(typeof(Lottery_Buy_LCBQC), this.Page);
        LotteryID = 15;
    ...
    public string GetAddone(int LotteryID, string IsuseID)
    {
        ...
        DataTable dt = Shove._Web.Cache.GetCacheAsDataTable("DataCache_LCBQC" + IsuseID);
        ...
        if (dt == null || dt.Rows.Count == 0)
        {
            ...
            Shove._Web.Cache.SetCache("DataCache_LCBQC" + IsuseID, dt, 300);
        }
