<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_DF6J1.aspx.cs" Inherits="Lottery_Buy_DF6J1" %>
...
<head id="Head1" runat="server">
    <title>东方6+1：2元最高可达￥500万-东方6+1选号投注、合买、玩法介绍－<%=_Site.Name %></title>
    <meta name="keywords" content="东方6+1选号投注、东方6+1合买、东方6+1玩法介绍" />
    <meta name="description" content="<%=_Site.Name %>提供东方6+1选号投注、合买、玩法介绍等服务。" />
    <script src="../JScript/Public.js" type="text/javascript"></script>

    <script src="JScript/buy_DF6J1.js" type="text/javascript"></script>
            ...
            <div id="cz_center">
                ...
                <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 19%; text-align: center; vertical-align: middle;
                        ...
                        <img id="LotteryImg" src="../Home/Room/Images/logo_58.jpg" alt="东方6+1" width="105"
                            height="108" />
                    </div>
                    <div style="float: left; width: 81%; margin-top: 0px;">
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">
                            <a href="<%= ResolveUrl("~/TrendCharts/DF6J1/DF61_ZHFB.aspx") %>" target="_blank">东方6+1走势图</a>&nbsp;&nbsp;
                            <a href="<%= ResolveUrl("~/WinQuery/58-0-0.aspx") %>" target="_blank">东方6+1中奖查询</a>
                        </div>
                    </div>
                </div>
                <!-- 期信息结束 -->
                ...
                <div style="width: 218px; border: solid 1px #BCD2E9; border-top: none; margin-bottom: 10px;">
                    <div style="text-align: center; padding: 15px 5px 10px 5px;">
                        <div id="divPlayIntroduce" style="background-image: url('Images/zfb_playIntroduce.jpg');
                            ...
                            <a href="../Help/play_58.aspx" target="_blank" style="text-decoration: none; cursor: hand;">
