<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_JQC.aspx.cs" Inherits="Lottery_Buy_JQC" %>
...
<head id="Head1" runat="server">
    ...
    <script src="JScript/buy_JQC.js" type="text/javascript"></script>
            ...
            <div id="cz_center">
                ...
                <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 19%; text-align: center;">
                        <img id="LotteryImg" src="../Home/Room/Images/logo_2.jpg" alt="四场进球彩" width="105"
                            height="108" />
                    </div>
                    <div style="float: left; width: 81%; margin-top: 0px;">
                        ...
                        <div id="tdLotteryIntroduce" class="hui12" style="padding: 0px 0px 2px 0px;">
                            <h1 class='blue18' style="display:inline; ">四场进球彩：看足球买彩票，2元可中￥500万！</h1> 
                        </div>
                        <div class="black12" style="width: 100%; height: 24px; line-height: 24px;">
                            <asp:DropDownList ID="ddlIsuses" runat="server" onchange="loadLottery(2)"></asp:DropDownList>期&nbsp;截止时间:<span
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%= ResolveUrl("~/WinQuery/2-0-0.aspx") %>" target="_blank">四场进球彩中奖查询</a>
                        </div>
                    </div>
                </div>
                <!-- 期信息结束 -->
                ...
                <div id="divNewBuy">
                    <table width="612" cellspacing="1" cellpadding="0" bgcolor="#C0DBF9" style="margin-top: 10px;">
                        <tbody>
                            ...
                            <input type='radio' name='playType' id='playType201' value='201' checked='checked' onclick='clickPlayType(this.value)' />单式
                            <input type='radio' name='playType' id='playType202' value='202' onclick='clickPlayType(this.value)' />复式
                            <input type='radio' name='playType' id='playType2011' value='2011' checked='checked' onclick='clickPlayType(this.value)' />单式预投
                            <input type='radio' name='playType' id='playType2022' value='2022' onclick='clickPlayType(this.value)' />复式预投
</td></tr>
                        </tbody>
                        <tr id="trXH">
