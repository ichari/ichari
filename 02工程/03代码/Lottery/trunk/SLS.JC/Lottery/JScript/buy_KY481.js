...
function GetSchemeBonusScalec() {
    ...
    if (!isGetSchemeBonusScalec) {
        try {
            ...
            Lottery_Buy_KY481.GetSchemeBonusScalec(GetSchemeBonusScalec_callback);

            isGetSchemeBonusScalec = true;
        }
        catch (e) {
            time_GetSchemeBonusScalec = setTimeout("Lottery_Buy_KY481.GetSchemeBonusScalec(GetSchemeBonusScalec_callback);", 2000);
        }
    }
}
...
function GetServerTime(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_KY481.GetSysTime(GetServerTime_callback);
...
function GetIsuseInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_KY481.GetIsuseInfo(lotteryID, GetIsuseInfo_callback);
...
function GetNewsInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_KY481.GetNewsInfo(lotteryID, GetNewsInfo_callback);
...
function HidBtnRand(playTypeName) {
    ...
    var isHidRandTR = playTypeName.indexOf("复式") > -1 || playTypeName.indexOf("任选") > -1;
    if (isHidRandTR) {
...
function playTypeIntroduce(lotteryID) {
    ...
    if ($Id("iframePlayTypeIntroduce").src == "") {
        $Id("iframePlayTypeIntroduce").src = "../Home/Room/Help/help_68.htm";
    }
...
function clickPlayType(t) {
    ...
    switch (t) {
        case '6801':
            ...
            $Id("labShowWinMoney").innerHTML = '<br/>&nbsp&nbsp单注固定奖金 <span style="color:red" id="spanPlayTypeMoney">8</span> 元。';
            iframe_playtypes.location.href = '../Lottery/playtypes/KY481/KY481_RX1.htm';
            break;

        case '6802':
            playTypeName = '任选二';
            $Id("labShowWinMoney").innerHTML = '<br/>&nbsp&nbsp 单注固定奖金 <span style="color:red" id="spanPlayTypeMoney">64</span> 元。';
            iframe_playtypes.location.href = '../Lottery/playtypes/KY481/KY481_RX2.htm';
            break;

        case '6803':
            playTypeName = '任选三';
            $Id("labShowWinMoney").innerHTML = '<br/>&nbsp&nbsp单注固定奖金 <span style="color:red" id="spanPlayTypeMoney">512</span> 元。';
            iframe_playtypes.location.href = '../Lottery/playtypes/KY481/KY481_RX3.htm';
            break;

        case '6804':
            playTypeName = '直选单式';
            $Id("labShowWinMoney").innerHTML = '<br/>&nbsp&nbsp单注固定奖金 <span style="color:red" id="spanPlayTypeMoney">4096</span> 元。';
            iframe_playtypes.location.href = '../Lottery/playtypes/KY481/KY481_ZhiD.htm';
            break;

        case '6805':
            playTypeName = '直选复式';
            $Id("labShowWinMoney").innerHTML = '<br/>&nbsp&nbsp单注固定奖金 <span style="color:red" id="spanPlayTypeMoney">4096</span> 元。';
            iframe_playtypes.location.href = '../Lottery/playtypes/KY481/KY481_ZhiF.htm';
            break;

        case '6806':
            playTypeName = '组选24单式';
            $Id("labShowWinMoney").innerHTML = '<br/>&nbsp&nbsp单注固定奖金 <span style="color:red" id="spanPlayTypeMoney">170</span> 元。';
            iframe_playtypes.location.href = '../Lottery/playtypes/KY481/KY481_Zu24_D.htm';
            break;

        case '6807':
            playTypeName = '组选24复式';
            $Id("labShowWinMoney").innerHTML = '<br/>&nbsp&nbsp单注固定奖金 <span style="color:red" id="spanPlayTypeMoney">170</span> 元。';
            iframe_playtypes.location.href = '../Lottery/playtypes/KY481/KY481_Zu24_F.htm';
            break;

        case '6808':
            playTypeName = '组选12单式';
            $Id("labShowWinMoney").innerHTML = '<br/>&nbsp&nbsp单注固定奖金 <span style="color:red" id="spanPlayTypeMoney">341</span> 元。';
            iframe_playtypes.location.href = '../Lottery/playtypes/KY481/KY481_Zu12_D.htm';
            break;

        case '6809':
            playTypeName = '组选12复式';
            $Id("labShowWinMoney").innerHTML = '<br/>&nbsp&nbsp单注固定奖金 <span style="color:red" id="spanPlayTypeMoney">341</span> 元。';
            iframe_playtypes.location.href = '../Lottery/playtypes/KY481/KY481_Zu12_F.htm';
            break;

        case '6810':
            playTypeName = '组选6单式';
            $Id("labShowWinMoney").innerHTML = '<br/>&nbsp&nbsp单注固定奖金 <span style="color:red" id="spanPlayTypeMoney">682</span> 元。';
            iframe_playtypes.location.href = '../Lottery/playtypes/KY481/KY481_Zu6_D.htm';
            break;

        case '6811':
            playTypeName = '组选6复式';
            $Id("labShowWinMoney").innerHTML = '<br/>&nbsp&nbsp单注固定奖金 <span style="color:red" id="spanPlayTypeMoney">682</span> 元。';
            iframe_playtypes.location.href = '../Lottery/playtypes/KY481/KY481_Zu6_F.htm';
            break;

        case '6812':
            playTypeName = '组选4单式';
            $Id("labShowWinMoney").innerHTML = '<br/>&nbsp&nbsp单注固定奖金 <span style="color:red" id="spanPlayTypeMoney">1024</span> 元。';
            iframe_playtypes.location.href = '../Lottery/playtypes/KY481/KY481_Zu4_D.htm';
            break;

        case '6813':
            playTypeName = '组选4复式';
            $Id("labShowWinMoney").innerHTML = '<br/>&nbsp&nbsp单注固定奖金 <span style="color:red" id="spanPlayTypeMoney">1024</span> 元。';
            iframe_playtypes.location.href = '../Lottery/playtypes/KY481/KY481_Zu4_F.htm';
            break;
...
function clickPlayClass(i, obj) {
    ...
    if (i == 2) {
        pt.childNodes[2].checked = true;
        clickPlayType(pt.childNodes[2].value);
    }
    else {
...
function btn_OK() {
    ...
    try {
        var LotteryNumber = Lottery_Buy_KY481.AnalyseScheme(document.getElementById("tbLotteryNumbers").value, document.getElementById('HidLotteryID').value, document.getElementById('tbPlayTypeID').value);
