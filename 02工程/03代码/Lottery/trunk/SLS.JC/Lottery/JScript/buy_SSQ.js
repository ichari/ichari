...
function GetIsuseInfo_callback(response) {
	...
	//$Id("lastIsuseInfo").innerHTML = lastIsuse;
...
function btn_OKClick() {
    ...
    if ($Id("Chase").checked) {
        ...
        if ((SumMoney < o_tb_Price) || (SumMoney > 20000)) {
            msg("单个方案的总金额必须在" + o_tb_Price + "元至 20000 元之间。");
            return false;
        }
//        if (o_list_LotteryNumber.length > 5) {
//            msg("一次不能超过5注");
//            o_list_LotteryNumber.focus();
//            return false;
//        }
...
function clickPlayType(t) {document.getElementById('tbPlayTypeID').value = t;
    ...
    var hosthtml = gethosturl() + '/Lottery/'; var strhtml = "";
        ...
        case '502':
            ...
            playTypeName = '复式';
            strhtml = '../Lottery/playtypes/ssq/SSQ_F.htm';
            break;
        ...
        case '503':
            ...
            document.getElementById('btnPaste').style.display = '';
            playTypeName = '胆拖';
            strhtml = '../Lottery/playtypes/ssq/SSQ_DanT.htm';
            break;
        ...
        case '504':
            ...
            playTypeName = '单式';
            strhtml = '../Lottery/playtypes/ssq/SSQ_ZNJX.htm';
            break;
        ...
        default:
            ...
            t = '501';
            playTypeName = '单式';
            strhtml = '../Lottery/playtypes/ssq/SSQ_D.htm';
            break;
        }
