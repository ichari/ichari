...
function clickPlayType(t) {
    ...
    switch (t) {
        ...
        default:
            ...
            playTypeName = '直选单式';
            $Id("labShowWinMoney").innerHTML = '(所选号码与开奖号码数字及顺序一致 即为中奖，奖金<span id="spanPlayTypeMoney">980</span>元)';
            strhtml = '../Lottery/playtypes/shssl/SHSSL_ZhiD.htm';
            break;
    }
