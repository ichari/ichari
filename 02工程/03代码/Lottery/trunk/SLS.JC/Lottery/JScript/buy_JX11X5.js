...
function GetSchemeBonusScalec() {
    ...
    if (!isGetSchemeBonusScalec) {
        try {
            ...
            Lottery_Buy_JX11X5.GetSchemeBonusScalec(GetSchemeBonusScalec_callback);

            isGetSchemeBonusScalec = true;
        }
        catch (e) {
            time_GetSchemeBonusScalec = setTimeout("Lottery_Buy_JX11X5.GetSchemeBonusScalec(GetSchemeBonusScalec_callback);", 2000);
        }
    }
}
...
function GetServerTime(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_JX11X5.GetSysTime(GetServerTime_callback);
...
function showIsuseTime(eTime, tPoor, goTime, lotteryID) {
    ...
    var to1 = to - 486000;
    var m1 = Math.floor(to1 / (1000 * 60)) % 60;
    var s1 = Math.floor(to1 / 1000) % 60;

    if (!isNaN(d)) {
        if (d < 0) {

            $Id("spanShowInfo").innerHTML = "离下期投注开始还有:";
            $Id("spanWin").style.display = "none";
            IsuseStartTime = null;
            setTimeout("showNextIsuseTime(" + lotteryID + "," + tPoor + ")", 1000);
            return;
        }
        else {

            $Id("spanShowInfo").innerHTML = "离本期投注截止还有:";
            $Id("spanWin").style.display = "";
            $Id("toOpenIsuseTime").innerHTML = ((m1 > 9 ? String(m1) : "0" + String(m1)) + "分") + ((s1 > 9 ? String(s1) : "0" + String(s1)) + "秒");
...
//获取下期开始时间
var lockNextIsuseTime = null;
var IsuseStartTime = null;
function showNextIsuseTime(lotteryID, tPoor) {

    var serverTime = new Date().getTime() + tPoor;
    if (IsuseStartTime == null) {
        IsuseStartTime = new Date(Lottery_Buy_JX11X5.GetNextIsuseInfo(lotteryID).value.replace(new RegExp("-", "g"), "/"));
    }

    var to = IsuseStartTime.getTime() - serverTime;
    ...
    if (!isNaN(d)) {
        if (d < 0) {
            ...
            var lottery = setTimeout("loadLottery(70);", 1000);
            return;
        }
        else {
    ...
    if (lockNextIsuseTime != null) {
        clearTimeout(lockNextIsuseTime);
    }

    lockNextIsuseTime = setTimeout("showNextIsuseTime(" + lotteryID + "," + tPoor + ")", 1000);
}
...
function GetIsuseInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_JX11X5.GetIsuseInfo(lotteryID, GetIsuseInfo_callback);
...
function GetNewsInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_JX11X5.GetNewsInfo(lotteryID, GetNewsInfo_callback);
...
function clickPlayType(t) {
    ...
    switch (t) {
        case '7002':
            playTypeName = '任选二';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>2</font>个号码投注，选号与开奖号码<font color=red>任意2位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">6</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_RX2.htm';
            break;

        case '70022':
            playTypeName = '任选二';
            document.getElementById('tbPlayTypeID').value = '7002';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>2</font>个号码投注，选号与开奖号码<font color=red>任意2位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">6</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_RX2_DT.htm';
            break;

        case '7003':
            playTypeName = '任选三';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>3</font>个号码投注，选号与开奖号码<font color=red>任意3位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">19</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_RX3.htm';
            break;

        case '70033':
            playTypeName = '任选三';
            document.getElementById('tbPlayTypeID').value = '7003';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>3</font>个号码投注，选号与开奖号码<font color=red>任意3位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">19</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_RX3_DT.htm';
            break;

        case '7004':
            playTypeName = '任选四';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>4</font>个号码投注，选号与开奖号码<font color=red>任意4位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">78</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_RX4.htm';
            break;

        case '70044':
            playTypeName = '任选四';
            document.getElementById('tbPlayTypeID').value = '7004';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>4</font>个号码投注，选号与开奖号码<font color=red>任意4位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">78</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_RX4_DT.htm';
            break;

        case '7005':
            playTypeName = '任选五';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>5</font>个号码投注，选号与开奖号码<font color=red>全部</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">540</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_RX5.htm';
            break;

        case '70055':
            playTypeName = '任选五';
            document.getElementById('tbPlayTypeID').value = '7005';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>5</font>个号码投注，选号与开奖号码<font color=red>全部</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">540</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_RX5_DT.htm';
            break;

        case '7006':
            playTypeName = '任选六';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>6</font>个号码投注，选号与开奖号码<font color=red>任意5位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">90</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_RX6.htm';
            break;

        case '70066':
            playTypeName = '任选六';
            document.getElementById('tbPlayTypeID').value = '7006';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>6</font>个号码投注，选号与开奖号码<font color=red>任意5位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">90</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_RX6_DT.htm';
            break;

        case '7007':
            playTypeName = '任选七';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>7</font>个号码投注，选号与开奖号码<font color=red>任意5位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">26</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_RX7.htm';
            break;

        case '70077':
            playTypeName = '任选七';
            document.getElementById('tbPlayTypeID').value = '7007';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>7</font>个号码投注，选号与开奖号码<font color=red>任意5位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">26</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_RX7_DT.htm';
            break;

        case '7008':
            playTypeName = '任选八';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>8</font>个号码投注，选号与开奖号码<font color=red>任意5位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">9</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_RX8.htm';
            break;

        case '7009':
            playTypeName = '前二直选';
            $Id('tdIntroduce').innerHTML = '每位各选<font color=red>1</font>个或多个号码投注，选号与开奖号码<font color=red>前2位</font>号码(顺序一致),即中奖<font color=red><span id="spanPlayTypeMoney">130</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_Q2Zhi.htm';
            break;

        case '7010':
            playTypeName = '前三直选';
            $Id('tdIntroduce').innerHTML = '每位各选<font color=red>1</font>个或多个号码投注，选号与开奖号码<font color=red>前3位</font>号码(顺序一致),即中奖<font color=red><span id="spanPlayTypeMoney">1170</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_Q3Zhi.htm';
            break;

        case '7011':
            playTypeName = '前二组选';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>2</font>个号码投注，选号与开奖号码<font color=red>前2位</font>(顺序不限),即中奖<font color=red><span id="spanPlayTypeMoney">65</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_Q2Zu.htm';
            break;

        case '70111':
            playTypeName = '前二组选';
            document.getElementById('tbPlayTypeID').value = '7011';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>2</font>个号码投注，选号与开奖号码<font color=red>前2位</font>(顺序不限),即中奖<font color=red><span id="spanPlayTypeMoney">65</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_Q2Zu_DT.htm';
            break;

        case '7012':
            playTypeName = '前三组选';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>3</font>个号码投注，选号与开奖号码<font color=red>前3位</font>(顺序不限),即中奖<font color=red><span id="spanPlayTypeMoney">195</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_Q3Zu.htm';
            break;

        case '70122':
            playTypeName = '前三组选';
            document.getElementById('tbPlayTypeID').value = '7012';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>3</font>个号码投注，选号与开奖号码<font color=red>前3位</font>(顺序不限),即中奖<font color=red><span id="spanPlayTypeMoney">195</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_Q3Zu_DT.htm';
            break;

        case '7013':
            document.getElementById('tbPlayTypeID').value = '7010';
            playTypeName = '前三复选';
            $Id('tdIntroduce').innerHTML = '每位各选<font color=red>1</font>个或多个号码投注，选号与开奖号码<font color=red>前3位</font>号码(顺序一致),即中奖<font color=red><span id="spanPlayTypeMoney">1170</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_Q3Fu.htm';
            break;

        case '7014':
            document.getElementById('tbPlayTypeID').value = '7009';
            playTypeName = '前二复选';
            $Id('tdIntroduce').innerHTML = '每位各选<font color=red>1</font>个或多个号码投注，选号与开奖号码<font color=red>前2位</font>号码(顺序一致),即中奖<font color=red><span id="spanPlayTypeMoney">130</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_Q2Fu.htm';
            break;

        default:
            t = '7001';
            playTypeName = '任选1';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>1</font>个号码投注，选号与开奖号码<font color=red>第1位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">13</span>元</font>';
            strhtml = '../Lottery/playtypes/JX11X5/JX11X5_RX1.htm';
            break;
    }
    iframe_playtypes.location.href = (strhtml).replace(new RegExp("../Lottery/"), hosthtml);
    $Id('tdIntroduce').innerHTML += '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><span style="color:red;cursor:pointer" id="spanExample">示例</span></strong>';

    document.getElementById("spanExample").title = Lottery_Buy_JX11X5.GetExample(document.getElementById('tbPlayTypeID').value).value;
...
function clickPlayClass(i, obj) {
    ...
    if (i == 0 || i == 7) {
        document.getElementById("playTypes").style.display = "none";
    } else {
        document.getElementById("playTypes").style.display = "";
    }
}

function splitScheme(lotteryNumber) {
    return Lottery_Buy_JX11X5.SplitScheme(lotteryNumber, document.getElementById("tbPlayTypeID").value).value;
}
...
function btn_OK() {
    ...
    try {
        var LotteryNumber = Lottery_Buy_JX11X5.AnalyseScheme(document.getElementById("tbLotteryNumbers").value, document.getElementById('HidLotteryID').value, document.getElementById('tbPlayTypeID').value);
...
function btn_OKClick() {
    ...
    if ($Id("spanShowInfo").innerHTML == "离下期投注开始时间还有:") {
        msg("本期投注已截止，谢谢。");
...
function ConvertDanToDT(number) {
    return Lottery_Buy_JX11X5.ConvertDanToDT(number, parseInt(document.getElementById("tbPlayTypeID").value)).value;
}
...
function PageEvent() {
    ...
    clickPlayClass(4, document.getElementById("tdRX5"));
    scrollTo(0, 147);
}
