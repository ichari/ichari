...
function GetSchemeBonusScalec() {
    ...
    if (!isGetSchemeBonusScalec) {
        try {
            ...
            Lottery_Buy_SYYDJ.GetSchemeBonusScalec(GetSchemeBonusScalec_callback);

            isGetSchemeBonusScalec = true;
        }
        catch (e) {
            time_GetSchemeBonusScalec = setTimeout("Lottery_Buy_SYYDJ.GetSchemeBonusScalec(GetSchemeBonusScalec_callback);", 2000);
        }
    }
}
...
function GetServerTime(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_SYYDJ.GetSysTime(GetServerTime_callback);
...
function showNextIsuseTime(lotteryID, tPoor) {
    ...
    if (IsuseStartTime == null) {
        IsuseStartTime = new Date(Lottery_Buy_SYYDJ.GetNextIsuseInfo(lotteryID).value.replace(new RegExp("-", "g"), "/"));
    }
    ...
    if (!isNaN(d)) {
        if (d < 0) {
            ...
            var lottery = setTimeout("loadLottery(62);", 1000);
            return;
        }
        else {
...
function GetIsuseInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_SYYDJ.GetIsuseInfo(lotteryID, GetIsuseInfo_callback);
...
function GetNewsInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_SYYDJ.GetNewsInfo(lotteryID, GetNewsInfo_callback);
...
function clickPlayType(t) {
    ...
    switch (t) {
        case '6202':
            ...
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_RX2.htm';
            break;

        case '62022':
            playTypeName = '任选二';
            document.getElementById('tbPlayTypeID').value = '6202';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>2</font>个号码投注，选号与开奖号码<font color=red>任意2位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">6</span>元</font>';
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_RX2_DT.htm';
            break;
        ...
        case '6203':
            ...
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_RX3.htm';
            break;

        case '62033':
            playTypeName = '任选三';
            document.getElementById('tbPlayTypeID').value = '6203';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>3</font>个号码投注，选号与开奖号码<font color=red>任意3位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">19</span>元</font>';
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_RX3_DT.htm';
            break;
        ...
        case '6204':
            ...
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_RX4.htm';
            break;

        case '62044':
            playTypeName = '任选四';
            document.getElementById('tbPlayTypeID').value = '6204';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>4</font>个号码投注，选号与开奖号码<font color=red>任意4位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">78</span>元</font>';
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_RX4_DT.htm';
            break;
        ...
        case '6205':
            ...
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_RX5.htm';
            break;

        case '62055':
            playTypeName = '任选五';
            document.getElementById('tbPlayTypeID').value = '6205';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>5</font>个号码投注，选号与开奖号码<font color=red>全部</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">540</span>元</font>';
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_RX5_DT.htm';
            break;
        ...
        case '6206':
            ...
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_RX6.htm';
            break;

        case '62066':
            playTypeName = '任选六';
            document.getElementById('tbPlayTypeID').value = '6206';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>6</font>个号码投注，选号与开奖号码<font color=red>任意5位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">90</span>元</font>';
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_RX6_DT.htm';
            break;
        ...
        case '6207':
            ...
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_RX7.htm';
            break;

        case '62077':
            playTypeName = '任选七';
            document.getElementById('tbPlayTypeID').value = '6207';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>7</font>个号码投注，选号与开奖号码<font color=red>任意5位</font>一致即中奖<font color=red><span id="spanPlayTypeMoney">26</span>元</font>';
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_RX7_DT.htm';
            break;
        ...
        case '6208':
            ...
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_RX8.htm';
            break;
        ...
        case '6209':
            ...
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_Q2Zhi.htm';
            break;
        ...
        case '6210':
            ...
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_Q3Zhi.htm';
            break;
        ...
        case '6211':
            ...
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_Q2Zu.htm';
            break;

        case '62111':
            playTypeName = '前二组选';
            document.getElementById('tbPlayTypeID').value = '6211';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>2</font>个号码投注，选号与开奖号码<font color=red>前2位</font>(顺序不限),即中奖<font color=red><span id="spanPlayTypeMoney">65</span>元</font>';
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_Q2Zu_DT.htm';
            break;
        ...
        case '6212':
            ...
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_Q3Zu.htm';
            break;

        case '62122':
            playTypeName = '前三组选';
            document.getElementById('tbPlayTypeID').value = '6212';
            $Id('tdIntroduce').innerHTML = '至少选择<font color=red>3</font>个号码投注，选号与开奖号码<font color=red>前3位</font>(顺序不限),即中奖<font color=red><span id="spanPlayTypeMoney">195</span>元</font>';
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_Q3Zu_DT.htm';
            break;
            
        case '6213':
            document.getElementById('tbPlayTypeID').value = '6210';
            playTypeName = '前三复选';
            $Id('tdIntroduce').innerHTML = '每位各选<font color=red>1</font>个或多个号码投注，选号与开奖号码<font color=red>前3位</font>号码(顺序一致),即中奖<font color=red><span id="spanPlayTypeMoney">1170</span>元</font>';
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_Q3Fu.htm';
            break;

        case '6214':
            document.getElementById('tbPlayTypeID').value = '6209';
            playTypeName = '前二复选';
            $Id('tdIntroduce').innerHTML = '每位各选<font color=red>1</font>个或多个号码投注，选号与开奖号码<font color=red>前2位</font>号码(顺序一致),即中奖<font color=red><span id="spanPlayTypeMoney">130</span>元</font>';
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_Q2Fu.htm';
            break;
        ...
        default:
            ...
            strhtml = '../Lottery/playtypes/SYYDJ/SYYDJ_RX1.htm';
            break;
    }
    ...
    document.getElementById("spanExample").title = Lottery_Buy_SYYDJ.GetExample(document.getElementById('tbPlayTypeID').value).value;
...
function splitScheme(lotteryNumber) {
    return Lottery_Buy_SYYDJ.SplitScheme(lotteryNumber, document.getElementById("tbPlayTypeID").value).value;
}
...
function btn_OK() {
    ...
    try {
        var LotteryNumber = Lottery_Buy_SYYDJ.AnalyseScheme(document.getElementById("tbLotteryNumbers").value, document.getElementById('HidLotteryID').value, document.getElementById('tbPlayTypeID').value);
...
function ConvertDanToDT(number) {
    return Lottery_Buy_SYYDJ.ConvertDanToDT(number, parseInt(document.getElementById("tbPlayTypeID").value)).value;
}
