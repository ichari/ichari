...
function bindWinNumber(type) {
    try {
        ...
        headHtm += "</table>";
        var moreUrl = "../TrendCharts/SYYDJ/SYDJ_FBZS.aspx";
        if (currentLotteryId == "61") {
            moreUrl = "../TrendCharts/JXSSC/SSC_5X_ZHFB.aspx";
        }else if (currentLotteryId == "62"){
            moreUrl = "../TrendCharts/SYYDJ/SYDJ_FBZS.aspx";
        }else if (currentLotteryId == "28") {
        moreUrl = "../TrendCharts/CQSSC/SSC_5X_ZHFB.aspx";
        }else if (currentLotteryId == "77") {
            moreUrl = "../TrendCharts/11X5/SYDJ_FBZS.aspx";
        }else if (currentLotteryId == "68") {
			moreUrl = "../TrendCharts/KY481/Default.aspx";
        }
