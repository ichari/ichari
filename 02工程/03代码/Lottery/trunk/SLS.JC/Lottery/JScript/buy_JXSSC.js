...
function GetSchemeBonusScalec() {
    ...
    if (!isGetSchemeBonusScalec) {
        try {
            ...
            Lottery_Buy_SSC.GetSchemeBonusScalec(GetSchemeBonusScalec_callback);

            isGetSchemeBonusScalec = true;
        }
        catch (e) {
            time_GetSchemeBonusScalec = setTimeout("Lottery_Buy_SSC.GetSchemeBonusScalec(GetSchemeBonusScalec_callback);", 2000);
        }
    }
}
...
function GetServerTime(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_SSC.GetSysTime(GetServerTime_callback);
...
function GetNewsInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_SSC.GetNewsInfo(lotteryID, GetNewsInfo_callback);
...
function HidBtnRand(playTypeName) {
    ...
    var isHidRandTR = playTypeName.indexOf("组合") > -1 || playTypeName.indexOf("复式") > -1 || playTypeName.indexOf("包点") > -1 || playTypeName.indexOf("包胆") > -1 || playTypeName.indexOf("小单") > -1 || playTypeName.indexOf("组三") > -1 || playTypeName.indexOf("组六") > -1 || playTypeName.indexOf("任选一") > -1 || playTypeName.indexOf("任选二") > -1;
    if (isHidRandTR) {
...
function accountAllMoney() {
    ...
    if (needMoney < 1) {
        ...
        $Id("spanFJL").innerText = Round(parseFloat($Id("spanWinMoney").innerText) / needMoney, 2);
    }
}
...
function clickPlayType(t) {
    ...
    switch (t) {
        case 'playType6101':
            ...
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp投注号码万、千、百、十、个位与开奖号码全部相同且顺序一致，奖金 <span style="color:red" id="spanPlayTypeMoney">116000</span>元。';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_5XDS.htm';
            break;

        case 'playType6102':
            playTypeName = '复选';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 包括五星、四星、三星、二星、一星投注号码各一注，最高奖金可达<span style="color:red" id="spanPlayTypeMoney">127287</span>元。';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_5XFS.htm';
            break;

        case 'playType6103':
            playTypeName = '组合';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp投注号码万、千、百、十、个位与开奖号码全部相同且顺序一致，奖金<span style="color:red" id="spanPlayTypeMoney">116000</span>元。';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_5XZH.htm';
            break;

        case 'playType6105':
            playTypeName = '五星通选单式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp一注号码，三个奖级通吃，五次中奖机会，大奖<span style="color:red" id="spanPlayTypeMoney">20000</span> 元。';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_5XTXDS.htm';
            break;

        case 'playType6106':
            playTypeName = '五星通选复式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp一注号码，三个奖级通吃，五次中奖机会，大奖 <span style="color:red" id="spanPlayTypeMoney">20000</span>元。';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_5XTXFS.htm';
            break;

        case 'playType6161':
            playTypeName = '单式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 投注号码千、百、十、个位与开奖号码全部相同且顺序一致，奖金 <span style="color:red" id="spanPlayTypeMoney">10000</span>元。';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_4XDS.htm';
            break;

        case 'playType6162':
            playTypeName = '复选';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 包括四星、三星、二星、一星投注号码各一注，最高奖金可达 <span style="color:red" id="spanPlayTypeMoney">11287</span>元。';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_4XFS.htm';
            break;

        case 'playType6163':
            playTypeName = '组合';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 投注号码千、百、十、个位与开奖号码全部相同且顺序一致，奖金 <span style="color:red" id="spanPlayTypeMoney">10000</span> 元。 ';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_4XZH.htm';
            break;

        case 'playType6171':
            playTypeName = '单式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 投注号码百、十、个位与开奖号码全部相同且顺序一致，奖金 <span style="color:red" id="spanPlayTypeMoney">1160</span>元。  ';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_3XDS.htm';
            break;

        case 'playType6172':
            playTypeName = '复选';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 包括三星、二星、一星投注号码各一注，最高奖金可达 <span style="color:red" id="spanPlayTypeMoney">1287</span>元。';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_3XFS.htm';
            break;

        case 'playType6173':
            playTypeName = '组合';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 投注号码百、十、个位与开奖号码全部相同且顺序一致，奖金<span style="color:red" id="spanPlayTypeMoney">1160</span>元。';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_3XZH.htm';
            break;

        case 'playType6181':
            playTypeName = '单式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 投注号码十、个位与开奖号码全部相同且顺序一致，奖金<span style="color:red" id="spanPlayTypeMoney">116</span>元。  ';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_2XDS.htm';
            break;

        case 'playType6182':
            playTypeName = '复选';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 包括二星、一星投注号码各一注，最高奖金可达<span style="color:red" id="spanPlayTypeMoney">127</span>元。';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_2XFS.htm';
            break;

        case 'playType6112':
            playTypeName = '包点';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 十、个位两个号码之和，奖金<span style="color:red" id="spanPlayTypeMoney">116</span>元。 ';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_2XBD.htm';
            break;

        case 'playType6183':
            playTypeName = '组合';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 选择十、个位两个号码进行投注，奖金<span style="color:red" id="spanPlayTypeMoney">116</span>元。';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_2XZH.htm';
            break;

        case 'playType6187':
            playTypeName = '二星组选单式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 选择两个数字进行投注，不包含对子，奖金<span style="color:red" id="spanPlayTypeMoney">58</span>元。 '
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_2XZXDS.htm';
            break;

        case 'playType6188':
            playTypeName = '二星组选复式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 任选3至7个不同数字进行投注，开奖号码不排序，奖金<span style="color:red" id="spanPlayTypeMoney">58</span>元，开奖号码为对子奖金<span style="color:red">  116</span>元。';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_2XZXFS.htm';
            break;

        case 'playType6110':
            playTypeName = '二星组选包点';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 十、个位两个号码之和，开奖号码不排序，奖金<span style="color:red" id="spanPlayTypeMoney">58</span>元，开奖号码为对子奖金<span style="color:red">  116</span>元。 '
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_2XZXBD.htm';
            break;

        case 'playType6111':
            playTypeName = '二星组选包胆';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 选择一个数字进行投注，奖金<span style="color:red" id="spanPlayTypeMoney">58</span>元，开奖号码为对子奖金<span style="color:red"> 116</span>元。  ';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_2XZXBDan.htm';
            break;

        case 'playType6191':
            playTypeName = '单式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 投注号码个位与开奖号码全部相同且顺序一致，奖金<span style="color:red" id="spanPlayTypeMoney">11</span>元。  '
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_1XDS.htm';
            break;

        case 'playType6193':
            playTypeName = '组合';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 投注号码个位与开奖号码全部相同且顺序一致，奖金<span style="color:red" id="spanPlayTypeMoney">11</span>元。;'
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_1XZH.htm';
            break;
        ...
        case 'playType6104':
            ...
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_CDX.htm';
            break;

        case 'playType6113':
            playTypeName = '三星组三单式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 选择2个数字(其中有一个数字必须选择两次)进行组三投注。奖金<span style="color:red" id="spanPlayTypeMoney">385</span>元。';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_2_3.htm';
            break;

        case 'playType6114':
            playTypeName = '三星组三复式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 从0-9共10个数中任选2-10个号码进行组三的投注。奖金<span style="color:red" id="spanPlayTypeMoney">385</span>元。'
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_2_4.htm';
            break;

        case 'playType6115':
            playTypeName = '三星组六单式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 选择3个数字(不能出现重复)进行组六投注。奖金<span style="color:red" id="spanPlayTypeMoney">190</span>元。';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_2_5.htm';
            break;

        case 'playType6116':
            playTypeName = '三星组六复式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 从0-9共10个数中任选4-10个号码进行组六的投注。奖金<span style="color:red" id="spanPlayTypeMoney">190</span>元。'
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_2_6.htm';
            break;

        case 'playType6117':
            playTypeName = '任选一';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 从五个位置上任选一个位置进行投注，奖金<span style="color:red" id="spanPlayTypeMoney">11</span>元。'
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_6_0.htm';
            break;

        case 'playType6118':
            playTypeName = '任选二';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 从五个位置上任选两个位置进行投注，奖金<span style="color:red" id="spanPlayTypeMoney">116</span>元。'
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_7_0.htm';
            break;
        default:
            t = 'playType6101';
            playTypeName = '五星单式';
            $Id("labShowWinMoney").innerHTML = '<br/><br/>&nbsp&nbsp 投注号码万、千、百、十、个位与开奖号码全部相同且顺序一致，奖金<span style="color:red" id="spanPlayTypeMoney">116000</span>元。';
            strhtml = '../Lottery/playtypes/JXSSC/JXSSC_5XDS.htm';
            break;
    }
...
function clickPlayClass(i, obj) {
    ...
    switch (i) {
        case 0:
            ...
            $Id("labShowWinMoney").innerText = '\n\n 投注号码万、千、百、十、个位与开奖号码全部相同且顺序一致，奖金116000元。';
            break;
        case 1:

            $Id("labShowWinMoney").style.display = '';
            $Id("labShowWinMoney").innerText = '\n\n 投注号码千、百、十、个位与开奖号码全部相同且顺序一致，奖金10000元。';
            break;
        case 2:

            $Id("labShowWinMoney").style.display = '';
            $Id("labShowWinMoney").innerText = '\n\n 投注号码百、十、个位与开奖号码全部相同且顺序一致，奖金1160元。';
            break;
        case 3:

            $Id("labShowWinMoney").style.display = '';
            $Id("labShowWinMoney").innerText = '\n\n 投注号码十、个位与开奖号码全部相同且顺序一致，奖金116元。';
            break;
        case 4:
            $Id("labShowWinMoney").style.display = '';
            $Id("labShowWinMoney").innerText = ' \n\n 投注号码个位与开奖号码全部相同且顺序一致，奖金11元。';
            break;
        case 5:
            $Id("labShowWinMoney").style.display = '';
...
function SelectXing(r) {
    if (r <= 5) {
        var tempR = 5 - r;
        document.getElementById("tbMiss").value = Lottery_Buy_SSC.BindHotAndCoolAndMiss(tempR).value;
    }
}
...
function btn_OK() {
    ...
    try {
        var LotteryNumber = Lottery_Buy_SSC.AnalyseScheme(document.getElementById("tbLotteryNumbers").value, document.getElementById('HidLotteryID').value, document.getElementById('tbPlayTypeID').value);
