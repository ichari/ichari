...
function GetSchemeBonusScalec() {
    ...
    if (!isGetSchemeBonusScalec) {
        try {
            ...
            Lottery_Buy_ZJTC6J1.GetSchemeBonusScalec(GetSchemeBonusScalec_callback);

        }
        catch (e) {
            time_GetSchemeBonusScalec = setTimeout("Lottery_Buy_ZJTC6J1.GetSchemeBonusScalec(GetSchemeBonusScalec_callback);", 2000);
        }
    }
}
...
function GetServerTime(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_ZJTC6J1.GetSysTime(GetServerTime_callback);
...
function GetLastIsuseInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_ZJTC6J1.GetLastIsuseInfo(lotteryID, GetLastIsuseInfo_callback);
...
function GetIsuseInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_ZJTC6J1.GetIsuseInfo(lotteryID, GetIsuseInfo_callback);
...
function GetNewsInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_ZJTC6J1.GetNewsInfo(lotteryID, GetNewsInfo_callback);
...
function DataBindIsuseCount(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_ZJTC6J1.DataBindIsuseCount(lotteryID, DataBindIsuseCount_callback);
...
function GetBindWinNumber(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_ZJTC6J1.GetWinNumber(lotteryID, GetBindWinNumber_callback);
...
function clickPlayType(t) {
    ...
    switch (t) {
        case '4101':
            ...
            strhtml = '../Lottery/playtypes/ZJTC6J1/ZJTC6J1_D.htm';
            break;

        case '4102':
            playTypeName = '复式';
            $Id("labShowWinMoney").innerHTML = '';
            strhtml = '../Lottery/playtypes/ZJTC6J1/ZJTC6J1_F.htm';
            break;
...
function btn_OK() {
    ...
    try {
        var LotteryNumber = Lottery_Buy_ZJTC6J1.AnalyseScheme(document.getElementById("tbLotteryNumbers").value, document.getElementById('HidLotteryID').value, document.getElementById('tbPlayTypeID').value);
