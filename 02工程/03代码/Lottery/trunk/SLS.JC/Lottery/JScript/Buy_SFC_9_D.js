...
function GetSchemeBonusScalec() {
    ...
    if (!isGetSchemeBonusScalec) {
        try {
            ...
            Lottery_Buy_SFC_9_D.GetSchemeBonusScalec(currentLotteryID, GetSchemeBonusScalec_callback);

            isGetSchemeBonusScalec = true;
        }
        catch (e) {
            time_GetSchemeBonusScalec = setTimeout("Lottery_Buy_SFC_9_D.GetSchemeBonusScalec(" + currentLotteryID + ",GetSchemeBonusScalec_callback);", 2000);
        }
    }
}
...
function GetServerTime(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_SFC_9_D.GetSysTime(GetServerTime_callback);
...
function GetAddone(lotteryID, IssueId) {
    ...
    try {
        ...
        Lottery_Buy_SFC_9_D.GetAddone(lotteryID, IssueId, GetAddone_callback);

    }
    catch (e) {

        time_GetAddone = setTimeout("Lottery_Buy_SFC_9_D.GetAddone(" + lotteryID + "," + IssueId + " ,GetAddone_callback);", 2000);
    }
...
function GetAddone_callback(response) {
    ...
    if (response == null || response.value == null) {
        ...
        time_GetAddone = setTimeout("Lottery_Buy_SFC_9_D.GetAddone(" + currentLotteryID + "," + $Id("HidIsuseID").value + ",GetAddone_callback);", 2000);
...
function GetIsuseInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_SFC_9_D.GetIsuseInfo(lotteryID, $Id('ddlIsuses').value, GetIsuseInfo_callback);
...
function GetNewsInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_SFC_9_D.GetNewsInfo(lotteryID, GetNewsInfo_callback);
...
function GetBindZCExpertList(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_SFC_9_D.GetZCExpertList(lotteryID, GetBindZCExpertList_callback);
...
function btn_OK() {
    ...
    try {
        var LotteryNumber = Lottery_Buy_SFC_9_D.AnalyseScheme(document.getElementById("tbLotteryNumbers").value, document.getElementById('HidLotteryID').value, document.getElementById('tbPlayTypeID').value);
...
function clickPlayType(t) {
        ...
        case '7501':
            playTypeName = '任九场单式';
            strhtml = '../Lottery/playtypes/SFC/SFC_9_D.htm';
            break;

        case '7502':
            playTypeName = '任九场复式';
            strhtml = '../Lottery/playtypes/SFC/SFC_9_F.htm';
            break;
