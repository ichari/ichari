...
function GetSchemeBonusScalec() {
    ...
    if (!isGetSchemeBonusScalec) {
        try {
            ...
            Lottery_Buy_CJDLT.GetSchemeBonusScalec(currentLotteryID, GetSchemeBonusScalec_callback);

        }
        catch (e) {
            time_GetSchemeBonusScalec = setTimeout("Lottery_Buy_CJDLT.GetSchemeBonusScalec(" + currentLotteryID + ",GetSchemeBonusScalec_callback);", 2000);
        }
    }
}
...
function GetServerTime(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_CJDLT.GetSysTime(GetServerTime_callback);
...
function GetIsuseInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_CJDLT.GetIsuseInfo(lotteryID, GetIsuseInfo_callback);
...
function GetNewsInfo(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_CJDLT.GetNewsInfo(lotteryID, GetNewsInfo_callback);
...
function GetBindWinNumber(lotteryID) {
    ...
    try {
        ...
        Lottery_Buy_CJDLT.GetWinNumber(lotteryID, GetBindWinNumber_callback);
...
function BindWinNumber(type) {
    ...
    headHtm += "<div style=\"text-align:right;\"><span id=\"Span1\" class=\"hui12\" ><a href=\"../TrendCharts/CJDLT/Default.aspx\" target=\"_blank\">更多&gt;&gt;</a></span></div>";
...
function loadLottery(lotteryID) {
    ...
    //加载资讯信息
    if ($Id("tbNews") != undefined && $Id("tbNews") != null) {
...
function GetLuckNumber(lotteryID) {
    ...
    var v = Lottery_Buy_CJDLT.GenerateLuckLotteryNumber(lotteryID, type, name).value;
    if (v.split("|").length < 2) {
        msg(v);
...
function btn_OK() {
    ...
    try {
        var LotteryNumber = Lottery_Buy_CJDLT.AnalyseScheme(document.getElementById("tbLotteryNumbers").value, document.getElementById('HidLotteryID').value, document.getElementById('tbPlayTypeID').value);
 ...
 function clickPlayType(t) {document.getElementById('tbPlayTypeID').value = t;
     ...
     var hosthtml = gethosturl() + '/Lottery/'; var strhtml = "";
        ...
        case '3902':
            ...
            playTypeName = '复式';
            strhtml = '../Lottery/playtypes/dlt/DLT_F.htm';
            $Id('HidPrice').value = '2';
            break;
        ...
        case '3903':
            ...
            document.getElementById('btnPaste').style.display = '';
            playTypeName = '追加单式';
            strhtml = '../Lottery/playtypes/dlt/DLT_ZJ_D.htm';
            $Id('HidPrice').value = '3';
            break;
        ...
        case '3904':
            ...
            document.getElementById('btnPaste').style.display = '';
            playTypeName = '追加复式';
            strhtml = '../Lottery/playtypes/dlt/DLT_ZJ_F.htm';
            $Id('HidPrice').value = '3';
            break;
        ...
        case '3905':
            ...
            document.getElementById('btnPaste').style.display = '';
            playTypeName = '12选2单式';
            strhtml = '../Lottery/playtypes/dlt/DLT_2_D.htm';
            $Id('HidPrice').value = '2';
            break;
        ...
        case '3906':
            ...
            document.getElementById('btnPaste').style.display = '';
            playTypeName = '12选2复式';
            strhtml = '../Lottery/playtypes/dlt/DLT_2_F.htm';
            $Id('HidPrice').value = '2';
            break;
        ...
        case '3907':
            ...
            document.getElementById('btnPaste').style.display = '';
            playTypeName = '胆拖';
            strhtml = '../Lottery/playtypes/dlt/DLT_DT.htm';
            $Id('HidPrice').value = '2';
            break;
        ...
        case '3908':
            ...
            document.getElementById('btnPaste').style.display = '';
            playTypeName = '追加胆拖';
            strhtml = '../Lottery/playtypes/dlt/DLT_ZJ_DT.htm';
            $Id('HidPrice').value = '3';
            break;
        ...
        case '3909':
            ...
            playTypeName = '单式';
            strhtml = '../Lottery/playtypes/dlt/DLT_ZNJX.htm';
            $Id('HidPrice').value = '2';
            break;
        ...
        default:
            ...
            t='3901';
            playTypeName = '单式';
            strhtml = '../Lottery/playtypes/dlt/DLT_D.htm';
            $Id('HidPrice').value = '2';
            break;
        }
