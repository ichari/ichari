<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_LCBQC.aspx.cs" Inherits="Lottery_Buy_LCBQC" %>
...
<head id="Head1" runat="server">
    <title>六场半全场：看足球买彩票，2元可中￥500万！-六场半全场选号投注、合买、玩法介绍－<%=_Site.Name %></title>
    <meta name="keywords" content="六场半全场选号投注、六场半全场合买、六场半全场玩法介绍" />
    <meta name="description" content="<%=_Site.Name %>提供六场半全场选号投注、合买、玩法介绍等服务。" />
    <meta http-equiv="X-UA-Compatible" content="IE=EmulateIE7" />
    <link href="../Style/dahecp.css" rel="stylesheet" type="text/css" />
    <link href="style/Buy_ZC.css" rel="stylesheet" type="text/css" />

    <script src="../JScript/Public.js" type="text/javascript"></script>

    <script src="JScript/buy_LCBQC.js" type="text/javascript"></script>
        ...
        <div id="menu_right">
            <div id="cz_center">
                ...
                <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 19%; text-align: center;">
                        <img id="LotteryImg" src="../Home/Room/Images/logo_15.jpg" alt="六场半全场" width="105"
                            height="108" />
                    </div>
                    <div style="float: left; width: 81%; margin-top: 0px;">
                        ...
                        <div id="tdLotteryIntroduce" class="hui12" style="padding: 0px 0px 2px 0px;">
                            <h1 class='blue18' style="display:inline; ">六场半全场：看足球买彩票，2元可中￥500万！ </h1> 
                        </div>
                        <div class="black12" style="width: 100%; height: 24px; line-height: 24px;">
                            <asp:DropDownList ID="ddlIsuses" runat="server" onchange="loadLottery(15)"></asp:DropDownList>期&nbsp;截止时间:<span
                                id="currIsuseEndTime" class="black12"></span>&nbsp;离截止还有:<span id='toCurrIsuseEndTime'
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%= ResolveUrl("~/WinQuery/15-0-0.aspx") %>" target="_blank">六场半全场中奖查询</a>
                        </div>
                    </div>
                </div>
                <!-- 期信息结束 -->
                ...
                <div id="divNewBuy">
                    <table width="612" cellspacing="1" cellpadding="0" bgcolor="#C0DBF9" style="margin-top: 10px;">
                        <tbody>
                            ...
                            <input type='radio' name='playType' id='playType1501' value='1501' checked='checked' onclick='clickPlayType(this.value)' />单式
                            <input type='radio' name='playType' id='playType1502' value='1502' onclick='clickPlayType(this.value)' />复式
                            <input type='radio' name='playType' id='playType15011' value='15011' checked='checked' onclick='clickPlayType(this.value)' />单式预投
                            <input type='radio' name='playType' id='playType15022' value='15022' onclick='clickPlayType(this.value)' />复式预投
</td></tr>
                        </tbody>
                        <tr id="trXH">
                        ...
                        <tbody id="trShowJion" style="display: none; line-height: 2; height: 36px; background-color: #FFEEEE;
                            ...
                            <tr id="trSchemeMoney">
                                ...
                                <td align="left">
                                    <div style="border-bottom: #C0DBF9 1px solid;">
                                        <input type='radio' name='Bet' id='Radio1' value="Bet01" onclick='clickBetPlay(this)' checked="checked" />固定投注
                                        <input type="text" onkeypress="return InputMask_Number();" id="tb_SchemeMoney" name="tb_SchemeMoney"
                                            onblur="return checkSchemeMoney(this);" style="width: 56px;" value="2" /> 元 <font color="#ff0000">【注】</font>只能是2的倍数。
                                    </div>
                                    <div>
                                        <input type='radio' name='Bet' id='Radio2' value="Bet02" onclick='clickBetPlay(this)' />区间投注
                                        <input type="text" onkeypress="return InputMask_Number();" id="tb_MinSchemeMoney" name="tb_MinSchemeMoney"
                                            onblur="return checkSchemeMoney(this);" style="width: 56px;" value="10" disabled="disabled" />
                                            至&nbsp;<input type="text" onkeypress="return InputMask_Number();" id="tb_MaxSchemeMoney" name="tb_MaxSchemeMoney"
                                            onblur="return checkSchemeMoney(this);" style="width: 56px;" value="10" disabled="disabled" />元 <br />
                                            <font color="#ff0000">【注】</font>推荐最大注数范围不要超过最小注数范围的1.4倍。
                                     </div>
                                </td>
                            </tr>
                            <tr>
                ...
                <div id="divCoBuy" style="display: none;">
                    <iframe id="iframeCoBuy" name="iframeCoBuy" width="100%" frameborder="0" scrolling="no"
                        onload="document.getElementById('iframeCoBuy').style.height=iframeCoBuy.document.body.scrollHeight + 100;showSameHeight();">
                    </iframe>
                </div>
            ...
            <div id="cz_right">
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" background="../Home/Room/Images/ssq_qh_bg.jpg">
                        <tr>
                            ...
                            <td width="63" align="center" background="../Home/Room/Images/ZC50.jpg" class="blue12">
                                <a href="javascript:;" id="hrefSFC" onclick="return ClickHMTJ(this)">胜负彩</a>
                            </td>
                            <td width="1">
                                &nbsp;
                            </td>
                            ...
                            <td width="63" align="center" class="blue12">
                                <a href="javascript:;" id="hrefLCJQC" onclick="return ClickHMTJ(this)">半全场</a>
                            </td>
                            <td width="4">
                                &nbsp;
                            </td>
                ...
                <div style="margin-top: 10px; margin-bottom: 10px;">
                        ...
                        <img src="../Home/Room/Images/ad_250_80.jpg" width="220" height="80" alt="会员注册" border="0" />
                </div>
                 <!-- 中奖排行榜 开始-->
