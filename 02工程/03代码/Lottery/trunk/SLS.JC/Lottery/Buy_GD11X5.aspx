<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_GD11X5.aspx.cs" Inherits="Lottery_Buy_GD11X5" %>
...
<head id="Head1" runat="server">
    ...
    <script src="JScript/buy_GD11X5.js" type="text/javascript"></script>
...
<body onload="showSameHeight();">
               ...
               <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 80%;margin-top:6px;">
                        ...
                        <div id="tdLotteryIntroduce" class="hui12" style="padding: 8px 0px 2px 0px;">
                            <h1 class='blue18' style="display:inline; ">11选5：2元赢取￥1170元</h1>每12分钟开奖，每天70期
                        </div>
                ...
                <div id="TabMenu" style="margin-top: 15px; border-bottom: #FF6600 2px solid; text-align: center;
                    ...
                    <div class="redMenu" onclick="newBuy(78);showSameHeight();">
                        选号投注
                    </div>
                    <div style="float: left; width: 2px;">
                    </div>
                    <div class="whiteMenu" onclick="schemeAll(78);showSameHeight();">
                        全部方案</div>
                    <div style="float: left; width: 2px;">
                    </div>
                    <div class="whiteMenu" onclick="followScheme(78);showSameHeight();">
                        定制跟单</div>
                    <div style="float: left; width: 2px;">
                    </div>
                    <div class="whiteMenu1" onclick="playTypeIntroduce(78);showSameHeight();">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td bgcolor='#FFFFFF' class='black12' style='padding-left: 5px; padding-top: 5px;'>
                                    <table width='100%' cellpadding='0' border='0' cellspacing='0' style='text-align: center;
                                        margin-top: 5px;' id='tbPlayTypeMenu78'>
                                        <tr>
                            ...
                            <tr id='playTypes'>
                                ...
                                <td bgcolor='#FFFFFF' style='padding-left: 5px; text-align: left;'>
                                    <span id='playTypes0'>
                                        <input type='radio' name='playType' id='playType7801' value='7801' checked='checked'
                                            onclick='clickPlayType(this.value)' />复式
                                            </span>
                                            <span id='playTypes1'>
                                        <input type='radio' name='playType' id='playType7802' value='7802' onclick='clickPlayType(this.value)' />复式
                                        <input type='radio' name='playType' id='playType78022' value='78022' onclick='clickPlayType(this.value)' />胆拖
                                        </span>
                                        <span id='playTypes2'>
                                        <input type='radio' name='playType' id='playType7803' value='7803' onclick='clickPlayType(this.value)' />复式
                                        <input type='radio' name='playType' id='playType78033' value='78033' onclick='clickPlayType(this.value)' />胆拖
                                        </span>
                                        <span id='playTypes3'>
                                        <input type='radio' name='playType' id='playType7804' value='7804' onclick='clickPlayType(this.value)' />复式
                                        <input type='radio' name='playType' id='playType78044' value='78044' onclick='clickPlayType(this.value)' />胆拖
                                        </span>
                                        <span id='playTypes4'>
                                        <input type='radio' name='playType' id='playType7805' value='7805' onclick='clickPlayType(this.value)' />复式
                                        <input type='radio' name='playType' id='playType78055' value='78055' onclick='clickPlayType(this.value)' />胆拖
                                        </span>
                                        <span id='playTypes5'>
                                        <input type='radio' name='playType' id='playType7806' value='7806' onclick='clickPlayType(this.value)' />复式
                                        <input type='radio' name='playType' id='playType78066' value='78066' onclick='clickPlayType(this.value)' />胆拖
                                        </span>
                                        <span id='playTypes6'>
                                        <input type='radio' name='playType' id='playType7807' value='7807' onclick='clickPlayType(this.value)' />复式
                                        <input type='radio' name='playType' id='playType78077' value='78077' onclick='clickPlayType(this.value)' />胆拖
                                        </span>
                                        <span id='playTypes7'>
                                        <input type='radio' name='playType' id='playType7808' value='7808' onclick='clickPlayType(this.value)' />复式
                                    </span><span id='playTypes8' style='display: none;'>
                                        <input type='radio' name='playType' id='playType7810' value='7810' onclick='clickPlayType(this.value)' />直选
                                        <input type='radio' name='playType' id='playType7813' value='7813' onclick='clickPlayType(this.value)' />复选
                                        <input type='radio' name='playType' id='playType7812' value='7812' onclick='clickPlayType(this.value)' />组选
                                        <input type='radio' name='playType' id='playType78122' value='78122' onclick='clickPlayType(this.value)' />胆拖
                                    </span><span id='playTypes9' style='display: none;'>
                                        <input type='radio' name='playType' id='playType7809' value='7809' onclick='clickPlayType(this.value)' />直选
                                        <input type='radio' name='playType' id='playType7814' value='7814' onclick='clickPlayType(this.value)' />复选
                                        <input type='radio' name='playType' id='playType7811' value='7811' onclick='clickPlayType(this.value)' />组选
                                        <input type='radio' name='playType' id='playType78111' value='78111' onclick='clickPlayType(this.value)' />胆拖
                                    </span>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <tr>
                            <td height="30" colspan="2" bgcolor="#F7F7F7" align="center" style="padding-bottom: 20px;
                                ...
                                我已经阅读并同意 <span class="blue12">
                                    <asp:HyperLink runat="server" ID="hlAgreement" NavigateUrl="../Home/Room/BuyProtocol.aspx?LotteryID=78" Target="_blank">《用户电话短信投注协议》</asp:HyperLink></span><br />
    ...
    <input id="HidLotteryID" name="HidLotteryID" type="hidden" value="78" />
