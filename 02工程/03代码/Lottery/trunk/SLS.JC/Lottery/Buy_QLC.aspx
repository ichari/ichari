<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_QLC.aspx.cs" Inherits="Lottery_Buy_QLC" %>
...
<head id="Head1" runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="../Style/part_b.css" />
    <link rel="stylesheet" type="text/css" href="../Style/dahecp.css" />
    <link rel="stylesheet" type="text/css" href="style/Buy.css" />
    <script type="text/javascript" src="../JScript/Marquee.js"></script>
    <script type="text/javascript" src="../JScript/Public.js"></script>
    <script type="text/javascript" src="JScript/buy_QLC.js"></script>
            ...
            <div id="cz_center">
                ...
                <div style="border: #E3E3E4 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 19%; text-align: center; vertical-align: middle;
                        ...
                        <img id="LotteryImg" src="../Home/Room/Images/logo_13.jpg" alt="七乐彩" width="105"
                            height="108" />
                    </div>
                    <div style="float: left; width: 81%; margin-top: 0px;">
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">
                            <a href="<%= ResolveUrl("~/TrendCharts/QLC/7LC_CGXMB.aspx") %>" target="_blank">七乐彩走势图</a>&nbsp;&nbsp;
                            <a href="<%= ResolveUrl("~/WinQuery/13-0-0.aspx") %>" target="_blank">七乐彩中奖查询</a>
                        </div>
                    </div>
                </div>
                <!-- 期信息结束 -->
                ...
                <div id="divNewBuy">
                    <table width="100%" cellspacing="1" cellpadding="0" bgcolor="#E3E3E4" style="margin-top: 10px;">
                        <tbody>
                            <tr>
                                <td width='70' height='28' align='center' bgcolor='#F7F7F7' class='black12'>选择玩法</td>
                ...
                <div id="divFollowScheme" style="display: none;">
                    <iframe id="iframeFollowScheme" name="iframeFollowScheme" width="100%" frameborder="0"
                        scrolling="no" onload="document.getElementById('iframeFollowScheme').height=iframeFollowScheme.document.body.scrollHeight;showSameHeight();">
                    </iframe>
                </div>
            ...
            <div id="cz_right">
                ...
                <div id="FC" runat="server" style="display:none;">
                    <div style="width: 218px;  border: solid 1px #e3e3e4;color:#FFF; line-height:32px;" class="bg1x bgp3">
                        <div style="float: left; width: 135px; line-height: 28px; padding-left: 15px;" class="blue12_1">
                            <strong>福彩专家栏</strong>
                        </div>
                ...
                <!-- 福彩专家栏 结束-->
                <table width="220" class="hidden" id="tdNumber"  border="0" cellspacing="1"
                ...
                <!-- 开奖列表结束-->
                <!-- 帮助 开始-->
                <div class="hidden" style="width: 220px; background-color: #6699CC;">
                ...
                <div class="hidden" style="width: 218px; border: solid 1px #BCD2E9; border-top: none; margin-bottom: 10px;">
                    <div style="text-align: center; padding: 15px 5px 10px 5px;">
                        <div id="divPlayIntroduce" style="background-image: url('Images/zfb_playIntroduce.jpg');
                            ...
                            <a href="../Help/play_13.aspx" target="_blank" style="text-decoration: none; cursor: hand;">
