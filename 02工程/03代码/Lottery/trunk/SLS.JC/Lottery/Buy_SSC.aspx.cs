...
public partial class Lottery_Buy_SSC : RoomPageBase
{
    ...
    {
        //未结束的期
        string CahceKey = "Lottery_Buy_SSC_BindHotAndCoolAndMiss";
        DataTable dt = Shove._Web.Cache.GetCacheAsDataTable(CahceKey);

        if (dt == null)
        {
            dt = new DAL.Tables.T_Isuses().Open("Top 100 WinLotteryNumber", "LotteryID=61 and IsOpened = 1 and WinLotteryNumber <> ''", "[EndTime] desc");
