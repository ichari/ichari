<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_SFC_9_D.aspx.cs" Inherits="Lottery_Buy_SFC_9_D" %>
...
<head id="Head1" runat="server">
    ...
    <script src="JScript/Buy_SFC_9_D.js" type="text/javascript"></script>
                ...
                <div style="border: #C0DBF9 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 81%; margin-top: 0px;">
                        ...
                        <div class="black12" style="width: 100%; height: 24px; line-height: 24px;">
                            <asp:DropDownList ID="ddlIsuses" runat="server" onchange="loadLottery(75)"></asp:DropDownList>期&nbsp;截止时间:<span
                        ...
                        <div class="red12" style="width: 100%; height: 24px; line-height: 24px;">
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <a href="<%= ResolveUrl("~/WinQuery/75-0-0.aspx") %>" target="_blank">任九场中奖查询</a>
                        </div>
                    </div>
                </div>
                <!-- 期信息结束 -->
                    ...
                    <table width="612" cellspacing="1" cellpadding="0" bgcolor="#C0DBF9" style="margin-top: 10px;">
                        <tbody>
                          <tr ><td width='70' height='28' align='center' bgcolor='#F7F7F7' class='black12'>选择玩法</td><td bgcolor='#FFFFFF' class='black12' style='padding-left: 5px;'>
                            <input type='radio' name='playType' id='playType7501' value='7501'  onclick='clickPlayType(this.value)' />任九场单式
                            <input type='radio' name='playType' id='playType7502' value='7502' onclick='clickPlayType(this.value)' />任九场复式
                            <input type='radio' name='playType' id='playType75011' value='75011'  onclick='clickPlayType(this.value)' />任九场单式预投
                            <input type='radio' name='playType' id='playType75022' value='75022' onclick='clickPlayType(this.value)' />任九场复式预投
</td></tr>
                        </tbody>
                        <tr id="trXH">
