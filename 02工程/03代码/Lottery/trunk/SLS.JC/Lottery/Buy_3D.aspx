<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Buy_3D.aspx.cs" Inherits="Lottery_Buy_3D" %>
...
<head id="Head1" runat="server">
    ...
    <script src="JScript/buy_3D.js" type="text/javascript"></script>
            ...
            <div id="cz_center">
                ...
                <div style="border: #E3E3E4 1px solid; background-image: url(../Home/Room/Images/bg_hui.jpg);
                    ...
                    <div style="float: left; width: 19%; text-align: center; vertical-align: middle; height: 100%; overflow: hidden;">
                        <img id="LotteryImg" src="../Home/Room/Images/logo_6.jpg" alt="福彩3D" width="105" height="108" />
                    </div>
                    <div style="float: left; width: 81%; margin-top: 0px;">
                        ...
                        <div id="tdLotteryIntroduce" class="hui12" style="padding: 4px 0px 2px 0px;">
                            <h1 class='blue18' style="display: inline;">福彩3D：2元赢取￥1000元</h1>
                            &nbsp;&nbsp;多种玩法,更多中奖机会,每日20:30开奖
                        </div>
                        <div class="black12" style="width: 100%; height: 24px; line-height: 24px;">
                            第<span id='currIsuseName' class='red12' style='font-weight: bold;'></span>期投注截止时间:&nbsp;
                ...
                <div id="divWinNotice" style="width: 100%;" runat="server" visible="false">
                    ...
                    <div id="div3D" style="float: left; width: 85%;" runat="server">
                        <iframe id="iframe3" name="iframeWinNotice" width="100%" height="25px" frameborder="0" scrolling="no" src="../Home/Room/3D_WinNotice.aspx"></iframe>
                    </div>
                </div>
                --%>
                <!-- 中奖播报结束 -->
                ...
                <div id="divNewBuy">
                    <table width="100%" cellspacing="1" cellpadding="0" bgcolor="#E3E3E4" style="margin-top: 10px;">
                        <tbody>
                            <tr>
                                <td width='70' height='28' align='center' bgcolor='#F7FCFF' class='black12'>选择玩法</td>
                                <td bgcolor='#FFFFFF' class='black12' style='padding-left: 5px;'>
                                    <strong>直选:</strong>
                                    <input type='radio' name='playType' id='playType601' value='601' checked='checked' onclick='clickPlayType(this.value)' />单式
                                    <input type='radio' name='playType' id='playType602' value='602' onclick='clickPlayType(this.value)' />复式
                                    <input type='radio' name='playType' id='playType606' value='606' onclick='clickPlayType(this.value)' />和值
                                    <%--
                                    <span style='margin-left: 10px;'></span><strong>组选:</strong>
                                    <input type='radio' name='playType' id='playType603' value='603' onclick='clickPlayType(this.value)' />单式
                                    <input type='radio' name='playType' id='playType604' value='604' onclick='clickPlayType(this.value)' />组6复式
                                    <input type='radio' name='playType' id='playType605' value='605' onclick='clickPlayType(this.value)' />组3复式
                                    <input type='radio' name='playType' id='playType607' value='607' onclick='clickPlayType(this.value)' />包点
                                    --%>
                                </td>
                            </tr>
                        </tbody>
                        <tr>
                            ...
                            <td valign="top" bgcolor="#FFFFFF">
                                <iframe id="iframe_playtypes" name="iframe_playtypes" width="100%" frameborder="0"
                                    scrolling="no" onload="document.getElementById('iframe_playtypes').height=iframe_playtypes.document.body.scrollHeight;showSameHeight();">
                                </iframe>
                            </td>
                        </tr>
                        <tr>
                                                ...
                                                <tr>
                                                    <td height="30">
                                                        ...
                                                        <span id="spanJX" style="display: none">
                                                            ...
                                                            <input id="btn_2_Randn" style="color: Blue" name="btn_2_Randn" type="button" value="机选"
                                                                ...
                                                                style="cursor: pointer; width: 40px;" class="red2" />
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                ...
                <div id="divCoBuy" style="display: none;">
                    <iframe id="iframeCoBuy" name="iframeCoBuy" width="100%" frameborder="0" scrolling="no"
                        onload="document.getElementById('iframeCoBuy').height=iframeCoBuy.document.body.scrollHeight;showSameHeight();">
                    </iframe>
                </div>
                <div id="divFollowScheme" style="display: none;">
                    <iframe id="iframeFollowScheme" name="iframeFollowScheme" width="100%" frameborder="0" scrolling="no" onload="document.getElementById('iframeFollowScheme').height=iframeFollowScheme.document.body.scrollHeight;showSameHeight();">
                    </iframe>
                </div>
                <div id="divSchemeAll" style="display: none;">
                    ...
                    <iframe id="iframeSchemeAll" name="iframeSchemeAll" width="100%" frameborder="0"
                        scrolling="no" onload="$Id('iframeSchemeAll').style.display ='';document.getElementById('divLoding').style.display='none';document.getElementById('iframeSchemeAll').height=iframeSchemeAll.document.body.scrollHeight;showSameHeight();">
                    </iframe>
                </div>
                <div id="divPlayTypeIntroduce" style="display: none;">
                    <iframe id="iframePlayTypeIntroduce" name="iframePlayTypeIntroduce" width="100%"
                        frameborder="0" scrolling="no" onload="document.getElementById('iframePlayTypeIntroduce').height=iframePlayTypeIntroduce.document.body.scrollHeight;showSameHeight();">
                    </iframe>
                </div>
            </div>
            <div id="cz_right">
                                        ...
                                        <tr>
                                            <td width="48%" height="30" align="left">
                                                <span id="spanXZ">
                                                    ...
                                                    <asp:TextBox ID="tbDate" runat="server" Width="80" CssClass="hui12" ToolTip="格式：1980-01-01" Text="1980-01-01" onfocus="this.className='';this.value='';" onblur="if(this.value==''){this.className='hui12'; this.value='1980-01-01';}"></asp:TextBox>
                                                </span><span id="spanXM" style="display: none">
                                                    <asp:TextBox ID="tbName" runat="server" Width="80" CssClass="hui12" ToolTip="支持中英文" Text="支持中英文" onfocus="if(this.value=='支持中英文') {this.className='';this.value='';}" onblur="if(this.value=='') {this.className='hui12';this.value='支持中英文';}"></asp:TextBox>
                                                </span>
                                            </td>
                                            <td width="52%">
                                                <img src="../Home/Room/Images/ssq_bt_1.jpg" width="100" height="21" alt="" border="0" style="cursor: pointer" onclick="return GetLuckNumber(<%=LotteryID %>)" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" runat="server" id="tdLuckNumber"></td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" align="center" style="padding-top: 15px; padding-bottom: 5px">
                                                <img src="../Home/Room/Images/ssq_bt_2.jpg" width="140" height="30" alt="" border="0" style="cursor: pointer" onclick="return BetLuckNumber(<%=LotteryID %>);" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                ...
                <!-- 幸运号码 结束-->
                <!-- 福彩专家栏 开始-->
                <div id="FC" runat="server" style="display:none;">
                    <div style="width: 218px;  border: solid 1px #e3e3e4; color:#FFF; line-height:32px;" class="bg1x bgp3">
                        <div style="float: left; width: 135px; line-height: 28px; padding-left: 15px;">
                            <strong>福彩专家栏</strong>
                        </div>
                    ...
                    <div id="ExpertList" style="width: 210px; border: solid 1px #e3e3e4; border-top: none; text-align: center; height: 100%; overflow: hidden; margin-bottom: 10px; padding: 4px;">
                        <br />
                ...
                <!-- 帮助 开始-->
                <div style="width: 220px; background-color: #6699CC;" class="hidden">
                    <div style="width: 100%; line-height: 28px; margin-left: 15px;" class="white14"">
                        <strong>相关信息</strong>
                    </div>
                </div>
                <div class="hidden" style="width: 218px; border: solid 1px #BCD2E9; border-top: none; margin-bottom: 10px;">
                    <div style="text-align: center; padding: 15px 5px 10px 5px;">
                        <div id="divPlayIntroduce" style="background-image: url('Images/zfb_playIntroduce.jpg');
                ...
                <!-- 帮助 结束-->
                <div style="margin-top: 10px; margin-bottom: 10px;"class="hidden">
                    <img src="../Home/Room/Images/ad_250_80.jpg" width="220" height="80" border="0" alt="会员注册" />
                </div>
                <!-- 中奖排行榜 开始-->
                <div style="width: 218px;  border: solid 1px #e3e3e4; color:#FFF; line-height:32px;" class="bg1x bgp3">
                    <div style="width: 100%; line-height: 28px; float: left; padding-left: 15px;">
                        <strong>中奖排行榜</strong>
                    </div>
                </div>
                <div style="width: 210px; border: solid 1px #e3e3e4; border-top: none; height: 100%; overflow: hidden; margin-bottom: 10px; padding: 4px;">
                    <table cellspacing="1" cellpadding="0" style="text-align: center; margin: 1%;" width="98%">
                        <tbody id="tbWin1" runat="server"></tbody>
                    </table>
                </div>
                <!-- 中奖排行榜 结束-->
            </div>
...
<div style="display: none"><asp:Label ID="lbMiss" runat="server"></asp:Label></div>
</form>
</body>
</html>
