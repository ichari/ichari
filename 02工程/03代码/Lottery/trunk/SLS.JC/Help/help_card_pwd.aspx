<%@ Page Language="C#" AutoEventWireup="true" CodeFile="help_card_pwd.aspx.cs" Inherits="Help_help_card_pwd" %>

<%@ Register Src="../UserControls/HelpCenter.ascx" TagName="Help" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>如何使用卡密-<%=_Site.Name %>-手机买彩票，就上<%=_Site.Name %> ！</title>
    <meta name="keywords" content="<%=_Site.Name %>帮助中心-如何使用卡密" />
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C0DBF9">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="black12" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            <span class="blue14">第一步、</span><br />
                            &nbsp;&nbsp;&nbsp;&nbsp;注册<%=_Site.Name %>会员或<%=_Site.Name %>会员登录
                            <br />
                            <br />
                            <span class="blue14">第二步、</span><br />
                            <img src="../Home/Room/Images/cdpw.jpg" />
                        </p>
                    </td>
                </tr>
            </table>
