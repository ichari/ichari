<%@ Page Language="C#" AutoEventWireup="true" CodeFile="help_DoubleAndChase.aspx.cs"
    Inherits="Help_help_DoubleAndChase" %>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E3E3E4">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>第二步：<span>确认号码</span><br /><img src="images/help_12_2.jpg" /></p>
                        <p>第三步：<span>选择追号设置</span><br /><img src="images/help_13_1.jpg" /></p>
                        <p>第四步：<span>设置倍数</span><br /><img src="images/help_13_2.jpg" /></p>
                        <p>第五步：<span>确定投注</span><br /><img src="images/help_4_3.jpg" /></p>
                    </td>
                </tr>
            </table>
        </div>
