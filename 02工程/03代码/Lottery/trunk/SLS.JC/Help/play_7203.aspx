<%@ Page Language="C#" AutoEventWireup="true" CodeFile="play_7203.aspx.cs" Inherits="Help_play_7203" %>

<%@ Register Src="../UserControls/PlayType.ascx" TagName="Help" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>竞彩足球总进球数玩法介绍-手机买彩票！ </title>
                ...
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="black12" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            ...
                            <p>
                                第二条 中国足球彩票单场竞猜总进球数游戏（以下简称"单场总进球数游戏"）由国家体育总局体育彩票管理中心统一发行。</p>
                            <p>
                                第三条 "单场总进球数游戏"实行自愿购买，凡购买该彩票者即被视为同意并遵守本规则。</p>
                            <h3>
                                第二章 游戏方法</h3>
                            <p>
                                第四条 "单场总进球数游戏"以国家体育总局体育彩票管理中心选定的国际重要足球比赛为竞猜对象，由购票人对指定的比赛场次在全场90分钟（含伤停补时）的主队和客队的总进球数结果进行投注。每一场比赛设置8种总进球数选项：<br />
                                &nbsp;&nbsp;（一）"0"：表示主队和客队总进球数为0个；<br />
                                &nbsp;&nbsp;（二）"1"：表示主队和客队总进球数为1个；<br />
                                &nbsp;&nbsp;（三）"2"：表示主队和客队总进球数为2个；<br />
                                &nbsp;&nbsp;（四）"3"：表示主队和客队总进球数为3个；<br />
                                &nbsp;&nbsp;（五）"4"：表示主队和客队总进球数为4个；<br />
                                &nbsp;&nbsp;（六）"5"：表示主队和客队总进球数为5个；<br />
                                &nbsp;&nbsp;（七）"6"：表示主队和客队总进球数为6个；<br />
                                &nbsp;&nbsp;（八）"7+"：表示主队和客队总进球数为7个或7个以上。<br />
                                购买"单场总进球数游戏"时，选择1场比赛投注为单场投注，选择2场或2场以上比赛投注为过关投注。<br />
                                投注方式包括单式投注和复式投注。其中，对所选比赛场次的比赛结果均选择1种投注结果为单式投注。对于某个或某几个比赛场次选择2种或2种以上的投注结果为复式投注。<br />
                                购票人可对其选定的结果进行多倍投注，投注倍数范围为2至99倍。</p>
                            <p>
                                第五条 "单场总进球数游戏"每注2元，单张彩票最大投注金额不超过20000元。彩票不记名、不挂失，不返还本金，不流通使用。</p>
                            <p>
                                第六条 投注内容由购票人选定，通过销售终端机人工输入进行投注或利用"单场总进球数游戏"销售终端提供的投注单辅助进行投注。投注内容经投注系统确认后打印出的兑奖凭证即为"单场总进球数游戏"彩票，交购票人保存。</p>
                            <p>
                                第七条 投注单投注：<br />
                                （一）投注单有4个供购票人填写的独立区域，分别为"过关方式"区、"赛事编号"区、"竞猜选项"区、"倍数"区。<br />
                                "过关方式"区的格式为："选择竞猜场次数量 * 购买彩票注数"，购票人必须且只能选择单场投注或过关投注中的1种方式，不选或多选均为无效投注。<br />
                                具体投注注数的分配如下表：<br />
                                <img src="images/spf.jpg" alt="竞彩足球总进球数" /><br />
                            ...
                            <p>
                                第八条 销售终端打印出的"单场总进球数游戏"彩票为该游戏唯一兑奖凭证。投注单只用于辅助购票人投注，不作为兑奖凭证，也不作为购票人投注结果的间接证明。</p>
                            <h3>
                                第三章 设 奖</h3>
                            <p>
                                第九条 奖金分配办法如下：<br />
                            ...
                            <p>
                                第十条 "单场总进球数游戏"根据投注场次数量限定过关投注的单注彩票最高奖金限额，具体为：<br />
                            ...
                            <h3>
                                第四章 奖金管理</h3>
                            <p>
                                第十一条 "单场总进球数游戏"奖金为销售额的69％，其中68％为返奖奖金、1％为调节基金；公益金为销售额的18％；发行费为销售额的13％。</p>
                            <p>
                                第十二条 "单场总进球数游戏" 设置奖池，奖池由每个竞猜场次的应计提奖金与实际中出奖金的差额累计而成。当某个竞猜场次的应计提奖金大于其实际中出奖金时，余额滚入奖池；当单场投注奖金没有中出时，未中出奖金滚入奖池。当某个竞猜场次的应计提奖金小于其实际中出奖金时，差额用奖池补足；若奖池不足时，用调节基金补足，调节基金不足时，从发行经费中垫支。在出现发行费垫支的情况下，当奖池有资金滚入时优先偿还发行费垫支部分。</p>
                            <p>
                                第十三条 "单场总进球数游戏" 设置调节基金，调节基金由销售额的1%、浮动奖奖金取整后的余额、弃奖收入和逾期未退票的票款组成，专项用于支付不可预见情况下的奖金支出风险及设置特别奖。</p>
                            <p>
                                第十四条 "单场总进球数游戏"单注奖金不足2元补足至2元，补足部分从调节基金支出，调节基金不足时，从发行经费中垫支。在出现发行费垫支的情况下，当调节基金有资金滚入时优先偿还发行费垫支部分。</p>
                            <p>
                                第十五条 "单场总进球数游戏" 之奖池、调节基金与其它中国足球彩票单场竞猜游戏之奖池、调节基金统一管理，相互间可调剂使用。</p>
                            <h3>
                                第五章 开奖及公告</h3>
                            <p>
                                第十六条 "单场总进球数游戏"在竞猜的比赛场次结束后，根据实际比赛结果进行开奖。实际比赛结果以当值裁判员在本规则涉及的比赛时长结束时刻裁定的比赛结果为准，其后对比赛结果的各类更改不影响原确认的开奖结果。开奖结果、销售情况等信息，通过销售网点和指定的互联网网站及其他媒体等信息渠道向社会公布。</p>
                            <h3>
                                第六章 中 奖</h3>
                            <p>
                                第十七条 每注"单场总进球数游戏"有效投注与对应开奖结果对照，与开奖结果一致即为中奖。</p>
                            <p>
                                第十八条 在 "单场总进球数游戏"销售过程中，如遇以下情形发生，则特别规定如下：<br />
                            ...
                            <h3>
                                第七章 兑 奖</h3>
                            <p>
                                第二十条 "单场总进球数游戏"中奖者到当地指定的彩票机构或投注站进行兑奖。每张彩票所涉及的所有比赛场次的开奖结果全部公布后次日起28天为兑奖期，逾期未兑，视为弃奖。</p>
                            <p>
