<%@ Page Language="C#" AutoEventWireup="true" CodeFile="play_39.aspx.cs" Inherits="Help_play_39" %>
                ...
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="black12" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC">
                            ...
                            <tr>
                                <td height="25" colspan="7" valign="center" bgcolor="#FFFFFF" class="red12" style="padding-left: 20px;">
                                    <p>
