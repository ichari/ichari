<%@ Page Language="C#" AutoEventWireup="true" CodeFile="help_BankAndAlipay.aspx.cs"
    Inherits="Help_help_BankAndAlipay" %>

<%@ Register Src="../UserControls/HelpCenter.ascx" TagName="Help" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>如何银行卡绑定与支付宝绑定-<%=_Site.Name %>-手机买彩票，就上<%=_Site.Name %>！</title>
    <meta name="keywords" content="<%=_Site.Name %>帮助中心-银行卡绑定与支付宝绑定" />
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E3E3E4">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <h1>银行卡绑定与支付宝绑定</h1>
                        <p>
                            第一步：<span>点击用户中心</span><br />
                            <img src="images/help_5_1.jpg" />
                        </p>
                        <p>
                            第二步：<span>点击绑定银行卡、绑定支付宝</span><br /><img src="images/help_21_1.jpg" />
                        </p>
                        <p>
                            第三步：<span>激活邮箱</span><br /><img src="images/help_22_1.jpg" /><br /><img src="images/help_22_6.jpg" />
                        </p>
                    </td>
                </tr>
            </table>
