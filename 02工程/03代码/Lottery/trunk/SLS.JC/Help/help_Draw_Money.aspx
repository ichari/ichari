<%@ Page Language="C#" AutoEventWireup="true" CodeFile="help_Draw_Money.aspx.cs"
    Inherits="Help_help_Draw_Money" %>

<%@ Register Src="../UserControls/HelpCenter.ascx" TagName="Help" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>如何提款-<%=_Site.Name %>-手机买彩票，就上<%=_Site.Name %> ！</title>
    <meta name="keywords" content="<%=_Site.Name %>帮助中心-提现" />
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E3E3E4">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            第二步：<span>点击我要提款</span><br /><img src="images/help_23_5.jpg" />
                        </p>
                        <p>
                            第三步：<span>输入相关密码</span><br /><img src="images/help_22_2.jpg" /><br /><img src="images/help_23_4.jpg" />
                        </p>
                        <p>
                            第四步：<span>点击下一步</span><br /><img src="images/help_22_3.jpg" />
                        </p>
                    </td>
                </tr>
            </table>
