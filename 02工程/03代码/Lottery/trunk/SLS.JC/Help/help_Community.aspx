<%@ Page Language="C#" AutoEventWireup="true" CodeFile="help_Community.aspx.cs" Inherits="Help_help_Community" %>

<%@ Register Src="../UserControls/HelpCenter.ascx" TagName="Help" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>如何参与社区讨论-<%=_Site.Name %>-手机买彩票，就上<%=_Site.Name %> ！</title>
    <meta name="keywords" content="<%=_Site.Name %>帮助中心-如何参与社区讨论" />
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C0DBF9">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            <img src="images/help_17-1.jpg" />
                            <br />
                        </p>
                        <p>
                            第三步：发帖讨论或回帖讨论</p>
                        <p>
                            <img src="images/help_17_2.gif" /><br />
                        </p>
                        <p>
                            <img src="images/help_17_3.gif" /><br />
                        </p>
                    </td>
                </tr>
            </table>
