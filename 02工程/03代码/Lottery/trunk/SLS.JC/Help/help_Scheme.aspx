<%@ Page Language="C#" AutoEventWireup="true" CodeFile="help_Scheme.aspx.cs" Inherits="Help_help_Scheme" %>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E3E3E4">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <h1>方案保密</h1>
                        <p>第一步：<span>选择彩种，选择球码</span></p>
                        <p>第二步：<span>保密设置、确认投注</span><br /><img src="images/help_12_3.jpg" /></p>
                    </td>
                </tr>
            </table>
        </div>
