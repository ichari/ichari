<%@ Page Language="C#" AutoEventWireup="true" CodeFile="play_2.aspx.cs" Inherits="Help_help_2" %>

<%@ Register Src="../UserControls/PlayType.ascx" TagName="Help" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>四场进球彩票玩法介绍-<%=_Site.Name %>-手机买彩票，就上<%=_Site.Name %>！ </title>
    <meta name="keywords" content="四场进球彩票玩法介绍" />
    <meta name="description" content="<%=_Site.Name %>提供四场进球彩票玩法介绍"/>
                ...
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="hei12" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            ...
                            <br />
                            四场进球游戏的投注场次为4场比赛的比分，由购买者对4场比赛8支球队在全场90分钟(含伤情补时)的进球数量(0、1、2、3+)进行投注；投注内容为0、1、2、3+；
                            其中进球数为3个或3个以上都计为3+，4场比赛共8个竞猜内容。</p>
                        <p>
                            <strong><span class="blue14">二．设奖</span></strong><br />
                            <br />
                            “4场进球游戏”只设1个浮动奖级，即一等奖</p>
                        <p>
                        ...
                        <p>
                            ...
                            <br />
                            4场进球游戏”返奖奖金为销售总额的65%；（最高限额封顶500万）</p>
                        <br />
                    </td>
                </tr>
            </table>
