<%@ Page Language="C#" AutoEventWireup="true" CodeFile="help_account_safe.aspx.cs"
    Inherits="Help_help_account_safe" %>
<%@ Register Src="../UserControls/HelpCenter.ascx" TagName="Help" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>方案保密-<%=_Site.Name %>-手机买彩票，就上<%=_Site.Name %> ！</title>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C0DBF9">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="black12" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            <span class="blue14">一、实名制认证</span><br />
                            本站采用支付宝实名制认证，须填写真实姓名与身份证号码</p>
                        <p>
                            <span class="blue14">二、用户昵称</span><br />
                            支付宝用户第一次登录时需填写用户昵称，以保证支付宝账户的安全性。</p>
                        <p>
                            <br />
                            <span class="blue14">三、安全保护问题</span><br />
                            支付宝用户第一次登录时需设置安全问题与答案，在修改用户信息以及提款的时候需要验证安全保护问题。<br />
                            <span class="red12">注：请务必记住问题答案</span></p>
                        <p>
                            &nbsp;</p>
                    </td>
                </tr>
