<%@ Page Language="C#" AutoEventWireup="true" CodeFile="help_ChaseAndBuy.aspx.cs"
    Inherits="Help_help_ChaseAndBuy" %>

<%@ Register Src="../UserControls/HelpCenter.ascx" TagName="Help" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>如何发追号合买-<%=_Site.Name %>-手机买彩票，就上<%=_Site.Name %> ！</title>
    <meta name="keywords" content="<%=_Site.Name %>帮助中心-如何发追号合买" />
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E3E3E4">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <h1 class="tc" style="line-height:45px;">如何发追号合买</h1>
                        <p>
                            第一步：选择号码<br />
                        </p>
                        <p>
                            <img src="images/help_7_2.jpg" />
                        </p>
                        <p>
                            第二步：确认选号<br />
                        </p>
                        <p>
                            <img src="images/help_12_2.jpg" /><br />
                        </p>
                        <p>
                            第三步：选择发合买同时勾选追号<br />
                        </p>
                        <p>
                            <img src="images/help_12_5.gif" /><br />
                        </p>
                        <p>
                            第四步：确认投注<br />
                        </p>
