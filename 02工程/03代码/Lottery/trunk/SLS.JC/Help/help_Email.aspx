<%@ Page Language="C#" AutoEventWireup="true" CodeFile="help_Email.aspx.cs" Inherits="Help_help_Email" %>

<%@ Register Src="../UserControls/HelpCenter.ascx" TagName="Help" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>如何绑定邮箱-<%=_Site.Name %>-手机买彩票，就上<%=_Site.Name %> ！</title>
    <meta name="keywords" content="<%=_Site.Name %>帮助中心-邮箱绑定" />
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E3E3E4">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            第二步：<span>选择修改资料</span><br /><img src="images/help_20_2.jpg" />
                        </p>
                        <p>
                            第三步：<span>激活邮箱</span><br /><img src="images/help_20_3.gif" /><br /><img src="images/help_20_4.gif" />
                        </p>
                        <p>
                            第四步：<span>登录邮箱</span><br />
                        </p>
                        <p>
                            <hr class="blue14" />
                        </p>
