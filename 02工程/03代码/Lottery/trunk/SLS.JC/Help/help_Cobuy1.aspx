<%@ Page Language="C#" AutoEventWireup="true" CodeFile="help_Cobuy1.aspx.cs" Inherits="Help_help_Cobuy1" %>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E3E3E4">
                <tr >
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <h1>如何合买</h1>
                        <p>第一步：<span>登录账号</span></p>
                        <p>第二步：<span>导航上点击合买跟单</span><br /><img src="images/help_11_1.jpg" class="img"/></p>
                        <p>第三步：<span>选择彩种</span><br /><img src="images/help_11_2.jpg" class="img"/></p>
                        <p>第四步：<span>选择玩法</span><br /><img src="images/help_11_3.jpg" class="img"/></p>
                        <p>第五步：<span>选择份数、确定参与</span><br /><img src="images/help_11_4.jpg" class="img"/></p>
                    </td>
                </tr>
            </table>
        </div>
