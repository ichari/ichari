<%@ Page Language="C#" AutoEventWireup="true" CodeFile="help_viewbuy.aspx.cs" Inherits="Help_help_viewbuy" %>

<%@ Register Src="../UserControls/HelpCenter.ascx" TagName="Help" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>查看投注纪录-<%=_Site.Name %>-手机买彩票，就上<%=_Site.Name %> ！</title>
    <meta name="keywords" content="<%=_Site.Name %>帮助中心-查看投注纪录" />
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C0DBF9">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="black12" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            <span class="blue14">查看购彩投注记录</span><br />
                            进入“用户中心” &gt; &quot;我的彩票记录&quot; &gt; “彩票投注记录”
                            <br />
                            选择查询时间即可查看投注记录。</p>
                        <p>
                            &nbsp;</p>
