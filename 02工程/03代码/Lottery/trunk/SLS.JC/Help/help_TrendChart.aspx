<%@ Page Language="C#" AutoEventWireup="true" CodeFile="help_TrendChart.aspx.cs"
    Inherits="Help_help_TrendChart" %>

<%@ Register Src="../UserControls/HelpCenter.ascx" TagName="Help" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>如何看走势图-<%=_Site.Name %>-手机买彩票，就上<%=_Site.Name %> ！</title>
    <meta name="keywords" content="<%=_Site.Name %>帮助中心-如何看走势图" />
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E3E3E4">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <h1>如何看走势图</h1>
                        <p>第一步：<span>在导航区域点击图表走势</span><br /><img src="images/help_14_2.jpg" /></p>
                        <p>第二步：<span>选择相应走势分类</span></p>
                    </td>
                </tr>
            </table>
        </div>
