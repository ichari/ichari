<%@ Page Language="C#" AutoEventWireup="true" CodeFile="play_70.aspx.cs" Inherits="Help_play_70" %>

<%@ Register Src="../UserControls/PlayType.ascx" TagName="Help" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>江西11选5彩票玩法介绍-<%= _Site.Name %>！ </title>
    <meta name="keywords" content="江西11选5彩票玩法介绍" />
    <meta name="description" content="<%= _Site.Name %>提供江西11选5彩票玩法介绍">
                ...
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="hei12" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            ...
                            江西11选5每日发行65期，9:05~21:53每12分钟开奖一次。<br />
                        </p>
                        <p class="blue14">
                            <strong>二、怎么玩 </strong>
                        </p>
                        <p>
                            江西11选5开奖范围为11个数字，由01~11组成，每期将从中随机开出5个号码作为开奖结果。江西11选5玩法众多，具体说明如下：
                        </p>
                        ...
                        <p>
                            江西11选5的各种玩法中奖概率和难度各不相同，中奖奖金也不同，明细如下：
                        </p>
                        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#DDDDDD">
                            <tr>
                                <td height="25" colspan="2" align="center" valign="center" bgcolor="#EBEBEB">
