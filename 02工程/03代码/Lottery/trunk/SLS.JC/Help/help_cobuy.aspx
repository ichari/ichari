<%@ Page Language="C#" AutoEventWireup="true" CodeFile="help_cobuy.aspx.cs" Inherits="Help_help_cobuy" %>

<%@ Register Src="../UserControls/HelpCenter.ascx" TagName="Help" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>如何发起合买，参与合买-<%=_Site.Name %>-手机买彩票，就上<%=_Site.Name %> ！</title>
    <meta name="keywords" content="<%=_Site.Name %>帮助中心-如何发起合买，参与合买" />
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#C0DBF9">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="black12" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            <span class="blue14">一、发起合买</span><br />
                            选择投注号码后，在下面的“合买代购”旁有个选项“我要发起合买方案”，点击填写相关信息即可发起合买。</p>
                        <p>
                            <span class="blue14">二、参与合买</span><br />
                            点击“参与合买”进入合买页面，选择“入伙”即可参与合买。</p>
                        <p>
                            <br />
                        </p>
                    </td>
