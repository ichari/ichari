<%@ Page Language="C#" AutoEventWireup="true" CodeFile="play_78.aspx.cs" Inherits="Help_play_78" %>

<%@ Register Src="../UserControls/PlayType.ascx" TagName="Help" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>广东11选5彩票玩法介绍！ </title>
    <meta name="keywords" content="广东11选5彩票玩法介绍" />
    <meta name="description" content="提供广东11选5彩票玩法介绍">
                ...
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="hei12" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            ...
                            广东11选5每日发行70期，9:00~23:00每12分钟开奖一次。<br />
                        </p>
                        <p class="blue14">
                            <strong>二、怎么玩 </strong>
                        </p>
                        <p>
                            广东11选5开奖范围为11个数字，由01~11组成，每期将从中随机开出5个号码作为开奖结果。广东11选5玩法众多，具体说明如下：
                        </p>
                        ...
                        <p>
                            广东11选5的各种玩法中奖概率和难度各不相同，中奖奖金也不同，明细如下：
                        </p>
                        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#DDDDDD">
                            <tr>
                                <td height="25" colspan="2" align="center" valign="center" bgcolor="#EBEBEB">
