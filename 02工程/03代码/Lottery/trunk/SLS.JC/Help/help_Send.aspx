<%@ Page Language="C#" AutoEventWireup="true" CodeFile="help_Send.aspx.cs" Inherits="Help_help_Send" %>

<%@ Register Src="../UserControls/HelpCenter.ascx" TagName="Help" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>充值流程-<%=_Site.Name %>-手机买彩票，就上<%=_Site.Name %> ！</title>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#E3E3E4">
                <tr bgcolor="#CCCCCC">
                    <td bgcolor="#ffffff" class="blue14" style="padding: 20px 25px 20px 25px; background-image: url(../images/zfb_bg_blue.jpg);
                        ...
                        <p>
                            第二步：<span>点击充值</span><br />
                            <img src="images/help_3_1.jpg" class="img"/>
                        </p>
                        <p>
                            第三步：<span>输入充值金额，选择充值方式，点击下一步</span><br />
                            <img src="images/help_3_2.jpg" class="img"/>
                        </p>
                        <p>
                            第四步：<span>确认充值</span><br />
                        <img src="images/help_3_3.jpg" class="img"/>    
                        </p>
                    </td>
                </tr>
            </table>
