<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AgentQueryBet.aspx.cs" Inherits="Agent_ElectronTicket_AgentQueryBet" %>
                ...
                <td>
                    <asp:DataGrid ID="g" runat="server" Width="100%" AllowPaging="True" PageSize="30"
                        ...
                        <Columns>
                            ...
                            <asp:BoundColumn DataField="State" HeaderText="是否出票">
