<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrameTop.aspx.cs" Inherits="Agent_ElectronTicket_FrameTop" %>
                                ...
                                <table width="92%" height="95%" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        ...
                                        <td width="96%" valign="bottom" class="bai">
                                            欢迎<asp:Label ID="labUserName" runat="server"></asp:Label>登录代理商管理后台！&nbsp;<asp:LinkButton ID="lbLogout" runat="server" OnClick="lbLogout_Click">【安全退出】</asp:LinkButton></td>
                                    </tr>
                                </table>
                            </td>
                            <td width="293">
