<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FrameLeft.aspx.cs" Inherits="Agent_CardPassword_FrameLeft" %>
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <table width="136" height="24" border="0" cellpadding="0" cellspacing="1" bgcolor="92BBDD">
                                                                <tr>
                                                                    <td bgcolor="#C0E0FE">
                                                                        <a href="QueryCardPassword.aspx" target="mainFrame">查询卡密号码</a></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <table width="136" height="24" border="0" cellpadding="0" cellspacing="1" bgcolor="92BBDD">
                                                                <tr>
                                                                    <td bgcolor="#C0E0FE">
                                                                        <a href="QueryUseCardPassword.aspx" target="mainFrame">查询已使用卡密</a></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <table width="136" height="24" border="0" cellpadding="0" cellspacing="1" bgcolor="92BBDD">
                                                                <tr>
                                                                    <td bgcolor="#C0E0FE">
                                                                        <a href="QueryExpiredCardPassword.aspx" target="mainFrame">查询已过期卡密</a></td>
                                                                </tr>
                                                            </table>
                                                        </td>
                                                    </tr>
