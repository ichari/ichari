<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ClientKj_lanq.aspx.cs" Inherits="Open_ClientKj_lanq" %>
...
<body>
    ...
    <div style="width:800px;">
        <div id="wrap" class="kj_box" style="width:800px;">
            <div class="c_box clear">
                <div class="tab_box fl" style="width:800px;">
                    <a class="kj_btn2 fl" href="ClientIndex.aspx">足球开奖</a><a class="kj_btn1 fl" href="ClientKj_lanq.aspx">篮球开奖</a></div>
            </div>
            <div class="sg_search clear" style="width:800px;">
                <div class="fl" style="width:800px;">
                    赛果查询：<asp:TextBox runat="server" ID="tbBeginTime" Width="140px" onblur="if(this.value=='') this.value=document.getElementById('tbBeginTime').value"
                                                        name="tbBeginTime" onFocus="WdatePicker({el:'tbBeginTime',dateFmt:'yyyy-MM-dd', maxDate:'%y-%M-%d'})" Height="15px" />
                    至
                    <asp:TextBox runat="server" ID="tbEndTime" Width="140px" name="tbEndTime" onblur="if(this.value=='') this.value=document.getElementById('tbEndTime').value"
