<%@ Page Language="C#" AutoEventWireup="true" CodeFile="kj_lanq.aspx.cs" Inherits="Open_kj_lanq" %>
...
<body>
    ...
    <div>
        ...
        <div id="position">
            ...
            <span class="sub_t">篮球开奖</span></div>
        <div id="wrap" class="kj_box">
            <div class="c_box clear">
                <div class="tab_box fl">
                    <a class="kj_btn2 fl" href="index.aspx">足球开奖</a><a class="kj_btn1 fl" href="kj_lanq.aspx">篮球开奖</a></div>
            </div>
