...
function init() {
    ...
    function ClickLottery(obj, type) {
		...
		for(var i=0; i<tab.length; i++){
            ...
            //lastLottery.className = "";
            //lastLottery.bgColor = "#FFFFFF";

            obj.className = "afff fs14 bg1x bgp4";
    ...
    function ClickTC(obj, type) {
        init();
		var tab = ['tdTC1','tdTC2','tdTC3','tdTC4'];
		for(var i=0; i<tab.length; i++){
			 document.getElementById(tab[i]).className = "";
		}
            document.getElementById("CustomChaseOne").style.display = "";
			...
			obj.className = "af00 fs14 bg1x bgp5";
    ...
    function btnNext_OK() {
        ...
        document.getElementById("CustomChaseOne").style.display = "none";
        document.getElementById("CustomChaseTwo").style.display = "";
        var iframe = document.getElementById("iframe_Login");
        if(iframe){
            iframe.src = "/Home/Room/ChaseLogin.aspx"; 
        }
    }
        ...
        function ClickSJXH(obj,type){
           ...
           // document.getElementById(obj.id.replace("href","tr")).style.display = "";
			//alert(obj.id.replace("href","td"));tdXYXH;tdSJXH;trXYXH;trSJXH;
			
			if(type==1){
				document.getElementById('tdXYXH').style.background = "";
				document.getElementById('trXYXH').style.display = "none";
				document.getElementById('tdSJXH').style.background = "url(Home/Room/images/by_bg_r1_c1.gif)";
				document.getElementById('trSJXH').style.display = "";
			}else{
				document.getElementById('tdXYXH').style.background = "url(Home/Room/images/by_bg_r1_c1.gif)";
				document.getElementById('trXYXH').style.display = "";
				document.getElementById('tdSJXH').style.background = "";
				document.getElementById('trSJXH').style.display = "none";
			}
            if(type == 1){
...
function ClickXYJX(obj, type) {
	...
	var ben_v = ['hrefXZ','hrefSX','hrefCSRQ','hrefXM']
	for(var i =0; i<ben_v.length; i++){
		document.getElementById(ben_v[i]).parentNode.style.background = "";
	}
	//obj.parentNode.style.background = "url(Home/Room/images/ssq_qh_2.jpg)";
    if (obj.id == "hrefCSRQ") {
        obj.parentNode.style.background = "url(Home/Room/images/ssq_qh_2.jpg)";
    } else {
        obj.parentNode.style.background = "url(Home/Room/images/ssq_qh_1.jpg)";
    }
...
function btn_ClearSelectClick() {
    ...
    for (i = o_list_LotteryNumber.length - 1; i >= 0; i--) {
        if (o_list_LotteryNumber.options[i].selected) {
            o_lab_Num1.innerHTML = parseInt(o_lab_Num1.innerHTML) - 1;
...
function btn_OK() {
    ...
    for (var i = 0; i < Lotterys.length; i++) {
        ...
        o_lab_Num1.innerHTML = parseInt(o_lab_Num1.innerHTML) + Num;
    }
    calculateMoney();
    document.body.removeChild(document.getElementById("bgDiv2"));
    document.body.removeChild(document.getElementById("msgDiv2"));
