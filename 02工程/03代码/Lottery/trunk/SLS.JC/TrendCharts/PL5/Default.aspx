<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="TrendCharts_PL5_Default" %>
...
<head runat="server">
<title>排列5走势图-彩票走势图表和数据分析－<%=_Site.Name %></title>
<meta name="keywords" content="排列5走势图" />
<meta name="description" content="排列5走势图、彩票走势图表和数据分析。" />
...
<body>
    ...
    <div id="box1">
        <a href="<%= _Site.Url %>" target="_blank" style="text-decoration: none; font-size: 14px;
         ...
         <iframe id="mainFrame" name="mainFrame" width="1002px" height="800px" frameborder="0" src="PL5_KJFB.aspx"
