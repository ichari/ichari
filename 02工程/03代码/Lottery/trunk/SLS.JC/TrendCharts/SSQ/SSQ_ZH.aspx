<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SSQ_ZH.aspx.cs" Inherits="Home_TrendCharts_SSQ_SSQ_ZH" %>
...
<head runat="server">
<title>双色球质合分析图-双色球走势图-彩票走势图表和数据分析－<%=_Site.Name %></title>
<meta name="keywords" content="双色球走势图-双色球质合分析图" />
<meta name="description" content="双色球走势图-双色球质合分析图、彩票走势图表和数据分析。" />
    <style type="text/css">
        .td
        {
            color: #cc0000;
            ...
            <tbody>
                <tr>
                    <td style="width: 280px" align="center" valign="middle">
                        <h1 style="display:inline;"><span class="td" style="font-weight: bold; font-size: 18px;">双色球&nbsp;&nbsp;质合分析图走势图</h1>
                    </td>
        ...
        <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="RQ_0" HeaderText="红球号码">
                    <ItemStyle CssClass="itemstyle2" Width="150" Font-Bold="true" />
                </asp:BoundField>
                <asp:BoundField DataField="BQ_0" HeaderText="蓝球号码">
                    <ItemStyle CssClass="itemstyle1" Width="80" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="Z_H" HeaderText="Z_H">
                    <ItemStyle Width="40" ForeColor="#0000ff" Height="18" />
                </asp:BoundField>
            </Columns>
