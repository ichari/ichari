<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FC3D_DZXZST.aspx.cs" Inherits="Home_TrendCharts_FC3D_FC3D_DZXZST" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>福彩3D 大中小走势图-彩票走势图表和数据分析－<%=_Site.Name %></title>
    <meta name="keywords" content="福彩3D 大中小走势图" />
    <meta name="description" content="福彩3D 大中小走势图、彩票走势图表和数据分析。" />
    <style type="text/css">
        .td
        {
            color: #cc0000;
        ...
        <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="LotteryNumber" HeaderText="01">
                    <ItemStyle Width="60" BackColor="#FFFFFF" Height="30px" ForeColor="#ff0000" />
                </asp:BoundField>
                <asp:BoundField DataField="B_1" HeaderText="01">
                    <ItemStyle CssClass="itemstyle3" Height="35px" />
                </asp:BoundField>
