<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FC3D_HZZST.aspx.cs" Inherits="Home_TrendCharts_FC3D_FC3D_HZZST" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>福彩3D 和值走势图-彩票走势图表和数据分析－<%=_Site.Name %></title>
    <meta name="keywords" content="福彩3D 和值走势图" />
    <meta name="description" content="福彩3D 和值走势图、彩票走势图表和数据分析。" />
    <style type="text/css">
        .td
        {
            color: #cc0000;
...
<!--
        ...
        function ShowBlueImg(e) {
            if (e.innerHTML == "&nbsp;") {
                e.innerHTML = "<img src='../../../Images/2[1].jpg' />";
            }
            else {
                e.innerHTML = "&nbsp;";
            }
...
<body>
    ...
    <div id="div1" runat="server">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" FooterStyle-HorizontalAlign="Center"
            ...
            ShowHeader="true" OnRowCreated="GridView1_RowCreated" ShowFooter="true">
            <Columns>
                ...
                <asp:BoundField DataField="LotteryNumber" HeaderText="01">
                    <ItemStyle Width="30px" ForeColor="#ff0000" />
                </asp:BoundField>
                <asp:BoundField DataField="H_Z" HeaderText="H_Z">
                    <ItemStyle CssClass="itemstyle3" Width="30px" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="D_0" HeaderText="14">
                    <ItemStyle CssClass="itemstyle2" />
                </asp:BoundField>
                <asp:BoundField DataField="S_0" HeaderText="15">
                    <ItemStyle CssClass="itemstyle3" />
                </asp:BoundField>
                <asp:BoundField DataField="D" HeaderText="16">
                    <ItemStyle CssClass="itemstyle2" />
                </asp:BoundField>
                <asp:BoundField DataField="X" HeaderText="16">
                    <ItemStyle CssClass="itemstyle3" />
                </asp:BoundField>
            </Columns>
        </asp:GridView>
