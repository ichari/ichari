<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FC3D_ZHZST.aspx.cs" Inherits="Home_TrendCharts_FC3D_FC3D_ZHZST" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">

<title>福彩3D 质合形态走势图-彩票走势图表和数据分析－<%=_Site.Name %></title>
<meta name="keywords" content="福彩3D 质合形态走势图" />
<meta name="description" content="福彩3D 质合形态走势图、彩票走势图表和数据分析。" />
    ...
    <div id="div1" runat="server">
            ...
            <tbody>
                <tr>
                    <td style="width: 280px" align="center" valign="middle">
                        <h1 class="td" style="font-weight: bold; font-size: 18px;display:inline;">福彩3D&nbsp;&nbsp;质合形态走势图</h1>
                    </td>
        ...
        <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Z_H" HeaderText="H_Z">
                    <ItemStyle BackColor="#ffe8eb" Height="30px" />
                </asp:BoundField>
                <asp:BoundField DataField="B_1" HeaderText="01">
                    <ItemStyle CssClass="itemstyle2" Height="30px" />
                </asp:BoundField>
                ...
                <tr>
                    <td style="background-color: #EFEFEF; text-align: left;">
                        <a href="<%= _Site.Url %>" target="_blank"
                            style="text-decoration: none; padding-left: 10px;"><%=_Site.Name %>首页</a><a href="<%= _Site.Url %>" target="_blank" style="text-decoration: none; font-size: 14px;
                            padding-left: 10px;"><%=_Site.Name %>首页</a> <a href="<%= ResolveUrl("~/Lottery/Buy_3D.aspx") %>"
                                target="_blank" style="padding-left: 10px; text-decoration: none; color: Red;">福彩3D投注/合买</a>
                        <a href="<%= ResolveUrl("~/WinQuery/6-0-0.aspx") %>" target="_blank" style="padding-left: 10px;
