<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FC3D_XTZST.aspx.cs" Inherits="Home_TrendCharts_FC3D_FC3D_XTZST" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
  
<title>福彩3D 形态走势图-彩票走势图表和数据分析－<%=_Site.Name %></title>
<meta name="keywords" content="福彩3D 形态走势图" />
<meta name="description" content="福彩3D 形态走势图、彩票走势图表和数据分析。" />
            ...
            <tbody>
                <tr>
                    <td style="width: 280px" align="center" valign="middle">
                        <h1 class="td" style="font-weight: bold; font-size: 18px;display:inline;">福彩3D&nbsp;&nbsp;形态走势图</h1>
                    </td>
        ...
        <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="LotteryNumber" HeaderText="01">
                    <ItemStyle Width="60" Height="35px" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="D_X" HeaderText="D_X">
                    <ItemStyle Width="60" ForeColor="#FF0000" />
                </asp:BoundField>
                <asp:BoundField DataField="J_O" HeaderText="J_O">
                    <ItemStyle Width="60" BackColor="#FFE8EB" />
                </asp:BoundField>
                <asp:BoundField DataField="B_1" HeaderText="01">
                    <ItemStyle CssClass="itemstyle2" Height="35px" />
                </asp:BoundField>
