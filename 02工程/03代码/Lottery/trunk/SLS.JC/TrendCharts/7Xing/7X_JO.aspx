<%@ Page Language="C#" AutoEventWireup="true" CodeFile="7X_JO.aspx.cs" Inherits="TrendCharts_7Xing_7X_JO" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>七星彩奇偶分布图</title>
    <style type="text/css">
        body
        {
            font-family: tahoma;
                            ...
                            <tr style="background-color: #EEEEEE">
                                <td style="background-color: #EFEFEF; text-align: left; font-size: 12px; width: 500px;">
                                    <a href="<%= _Site.Url %>" target="_blank" style="text-decoration: none; font-size: 14px;
                                        padding-left: 10px;">首页</a> <a href="<%= ResolveUrl("~/Lottery/Buy_QXC.aspx") %>"
