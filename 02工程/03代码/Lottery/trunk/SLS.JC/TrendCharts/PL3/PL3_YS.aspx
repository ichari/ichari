<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PL3_YS.aspx.cs" Inherits="View_PL3_YS" %>

<%@ Register Assembly="Shove.Web.UI.4 For.NET 3.5" Namespace="Shove.Web.UI" TagPrefix="ShoveWebUI" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>排列3余数走试图</title>
    <style type="text/css">
        body
        {
            font-family: tahoma;
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" UseAccessibleHeader="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="LotteryNumber" HeaderText="开奖号码">
                                            <ItemStyle Width="60px" Font-Bold="True" Font-Names="宋体" />
                                        </asp:BoundField>
