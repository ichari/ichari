<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="TrendCharts_CQSSC_Default" %>

<%@ Register Src="~/Home/Room/UserControls/TrendChartHead.ascx" TagName="TrendChartHead" TagPrefix="uc2" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
<title>重庆时时彩走势图-彩票走势图表和数据分析－<%=_Site.Name %></title>
<meta name="keywords" content="重庆时时彩走势图" />
<meta name="description" content="重庆时时彩走势图、彩票走势图表和数据分析。" />
    <style type="text/css">
        .td
        {
            color: #cc0000;
...
<body>
    ...
    <div id="box1">
        ...
        <a href="<%= ResolveUrl("~/Lottery/Buy_CQSSC.aspx") %>" target="_blank" style="padding-left: 10px; text-decoration: none; color: Red;">投注/合买</a>
        <a href="<%= ResolveUrl("~/WinQuery/28-0-0.aspx") %>" target="_blank" style="padding-left: 10px; text-decoration: none; color: Red;">中奖查询</a>
        <iframe id="mainFrame" name="mainFrame" width="960px" height="800px" frameborder="0" src="SSC_5X_ZST.aspx" style="overflow-x: auto; overflow-y: hidden;"></iframe>
    </div>
