<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SSC_2XPJZZST.aspx.cs" Inherits="Home_TrendCharts_JXSSC_SSC_2XPJZZST" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>时时彩二星均值走势图-时时彩走势图-彩票走势图表和数据分析－<%=_Site.Name %></title>
    <meta name="keywords" content="时时彩走势图-时时彩二星均值走势图" />
    <meta name="description" content="时时彩走势图-时时彩二星均值走势图、彩票走势图表和数据分析。" />
    <style type="text/css">
        .td
        {
            color: #cc0000;
        ...
        <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="LotteryNumber" HeaderText="奖号">
                    <ItemStyle Font-Bold="true" Width="59" />
                </asp:BoundField>
