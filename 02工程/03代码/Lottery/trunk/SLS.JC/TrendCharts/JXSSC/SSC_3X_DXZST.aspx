<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SSC_3X_DXZST.aspx.cs" Inherits="Home_TrendCharts_JXSSC_SSC_3X_DXZST" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>时时彩三星大小走势图-时时彩走势图-彩票走势图表和数据分析－<%=_Site.Name %></title>
    <meta name="keywords" content="时时彩走势图-时时彩三星大小走势图" />
    <meta name="description" content="时时彩走势图-时时彩三星大小走势图、彩票走势图表和数据分析。" />
    <style type="text/css">
        .td
        {
            color: #cc0000;
...
<body>
    ...
    <div id="box1">
        ...
        <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="false"
            ...
            <HeaderStyle Font-Size="12px" BackColor='#FFCC66' />
            <FooterStyle HorizontalAlign="Center" Font-Size="12px" BackColor='#FFCC66'></FooterStyle>
            ...
            <Columns>
                ...
                <asp:BoundField DataField="LotteryNumber" HeaderText="奖号">
                    <ItemStyle Width="120" BackColor="#FFE8EB" Height="18px" Font-Bold="true" />
                </asp:BoundField>
                <asp:BoundField DataField="D_X_Type" HeaderText="类型">
                    <ItemStyle Width="100" ForeColor="#999999" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_0" HeaderText="大大大">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_1" HeaderText="大大小">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_2" HeaderText="大小大">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_3" HeaderText="大小小">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_4" HeaderText="小大大">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_5" HeaderText="小大小">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_6" HeaderText="小小大">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_7" HeaderText="小小小">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="D_X" HeaderText="值">
                    <ItemStyle CssClass="itemstyle2" />
                </asp:BoundField>
                <asp:BoundField DataField="D_0" HeaderText="0大">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="D_1" HeaderText="1大">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="D_2" HeaderText="2大">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="D_3" HeaderText="3大">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
            </Columns>
