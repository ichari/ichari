<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="TrendCharts_JXSSC_Default" %>
...
<head runat="server">
<title>江西时时彩走势图-彩票走势图表和数据分析－<%=_Site.Name %></title>
<meta name="keywords" content="江西时时彩走势图" />
<meta name="description" content="江西时时彩走势图、彩票走势图表和数据分析。" />
    <style type="text/css">
        .td
        {
            color: #cc0000;
...
<body>
    ...
    <div id="box1">
        ...
        <iframe id="mainFrame" name="mainFrame" width="1002px" height="800px" frameborder="0" src="SSC_5X_ZST.aspx" style="overflow-x: auto; overflow-y: hidden;"></iframe>
    </div>
