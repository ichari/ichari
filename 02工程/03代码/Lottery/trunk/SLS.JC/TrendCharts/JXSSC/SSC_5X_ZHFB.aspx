<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SSC_5X_ZHFB.aspx.cs" Inherits="Home_TrendCharts_JXSSC_SSC_5X_ZHFB" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>新时时彩标准五星综合走势图-时时彩走势图-<%= _Site.Name %></title>
    <meta name="keywords" content="时时彩走势图-时时彩标准五星综合走势图" />
    <meta name="description" content="时时彩走势图-时时彩标准五星综合走势图、彩票走势图表和数据分析。" />
    <style type="text/css">
        .td
        {
            color: #cc0000;
...
<body>
    ...
    <div id="box1">
        <table style="width: 100%; height: 40px; background-image: url(../Images/bg11111.jpg);margin: 0 auto 0 auto;"
            cellspacing="0" cellpadding="0">
            <tbody align="center">
                <tr>
                    <td style="width: 280px" align="center" valign="middle">
                        <h1 class="td" style="font-weight: bold; font-size: 18px;display:inline;">新时时彩&nbsp;&nbsp;标准五星综合走势图</h1>
                    </td>
                    <td align="right">
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" Width="100%"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="S_T_H" HeaderText="上期重复号码个数" FooterText="上期重复号码个数">
                    <ItemStyle CssClass="itemstyle1" Width="120" />
                    <HeaderStyle />
                </asp:BoundField>
                <asp:BoundField DataField="C_H" HeaderText="0—9出号个数" FooterText="0—9出号个数">
                    <ItemStyle CssClass="itemstyle2" Width="100" />
                    <HeaderStyle />
                </asp:BoundField>
            </Columns>
