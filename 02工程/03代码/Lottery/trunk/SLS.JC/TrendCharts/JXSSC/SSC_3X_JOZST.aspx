<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SSC_3X_JOZST.aspx.cs" Inherits="Home_TrendCharts_JXSSC_SSC_3X_JOZST" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>时时彩三星奇偶走势图-时时彩走势图-彩票走势图表和数据分析－<%=_Site.Name %></title>
    <meta name="keywords" content="时时彩走势图-时时彩三星奇偶走势图" />
    <meta name="description" content="时时彩走势图-时时彩三星奇偶走势图、彩票走势图表和数据分析。" />
    <style type="text/css">
        .td
        {
            color: #cc0000;
        ...
        <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="LotteryNumber" HeaderText="奖号">
                    <ItemStyle Width="120" Font-Bold="true" BackColor="#FFE8EB" />
                </asp:BoundField>
                <asp:BoundField DataField="D_X_Type" HeaderText="类型">
                    <ItemStyle Width="100" ForeColor="#999999" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_0" HeaderText="奇奇奇">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_1" HeaderText="奇奇偶">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_2" HeaderText="奇偶奇">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_3" HeaderText="奇偶偶">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_4" HeaderText="偶奇奇">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_5" HeaderText="偶奇偶">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_6" HeaderText="偶偶奇">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_7" HeaderText="偶偶偶">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="D_X" HeaderText="值">
                    <ItemStyle CssClass="itemstyle2" />
                </asp:BoundField>
                <asp:BoundField DataField="D_0" HeaderText="0奇">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="D_1" HeaderText="1奇">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="D_2" HeaderText="2奇">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="D_3" HeaderText="3奇">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
            </Columns>
