<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SSC_4X_ZHFB.aspx.cs" Inherits="Home_TrendCharts_JXSSC_SSC_4X_ZHFB" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>时时彩标准四星综合走势图-时时彩走势图-彩票走势图表和数据分析－<%=_Site.Name %></title>
    <meta name="keywords" content="时时彩走势图-时时彩标准四星综合走势图" />
    <meta name="description" content="时时彩走势图-时时彩标准四星综合走势图、彩票走势图表和数据分析。" />
    <style type="text/css">
        .td
        {
            color: #cc0000;
        ...
        <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="LotteryNumber" HeaderText="开奖号码" FooterText="开奖号码">
                    <ItemStyle Width="120" Font-Bold="true" Height="18px" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="S_T_H" HeaderText="上期重复号码个数" FooterText="上期重复号码个数">
                    <ItemStyle Width="140" CssClass="itemstyle2" />
                </asp:BoundField>
                <asp:BoundField DataField="C_H" HeaderText="0—9出号个数" FooterText="0—9出号个数">
                    <ItemStyle Width="130" CssClass="itemstyle1" />
                </asp:BoundField>
            </Columns>
