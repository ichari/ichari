<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SSC_3X_ZhiHeZST.aspx.cs"
    Inherits="Home_TrendCharts_JXSSC_SSC_3X_ZhiHeZST" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>时时彩三星质合走势图-时时彩走势图-彩票走势图表和数据分析－<%=_Site.Name %></title>
    <meta name="keywords" content="时时彩走势图-时时彩三星质合走势图" />
    <meta name="description" content="时时彩走势图-时时彩三星质合走势图、彩票走势图表和数据分析。" />
    <style type="text/css">
        .td
        {
            color: #cc0000;
    ...
    <div id="box1">
        ...
        <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="Z_0" HeaderText="质质质">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_1" HeaderText="质质合">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_2" HeaderText="质合质">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_3" HeaderText="质合合">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_4" HeaderText="合质质">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_5" HeaderText="合质合">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_6" HeaderText="合合质">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="Z_7" HeaderText="合合合">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="D_X" HeaderText="值">
                    <ItemStyle CssClass="itemstyle2" />
                </asp:BoundField>
                <asp:BoundField DataField="D_0" HeaderText="0质">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="D_1" HeaderText="1质">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="D_2" HeaderText="2质">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                <asp:BoundField DataField="D_3" HeaderText="3质">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
            </Columns>
