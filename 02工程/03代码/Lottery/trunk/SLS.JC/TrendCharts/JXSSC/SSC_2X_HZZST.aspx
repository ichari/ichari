<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SSC_2X_HZZST.aspx.cs" Inherits="Home_TrendCharts_JXSSC_SSC_2X_HZZST" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>时时彩标准二星和值走势图-时时彩走势图-彩票走势图表和数据分析－<%=_Site.Name %></title>
    <meta name="keywords" content="时时彩走势图-时时彩标准二星和值走势图" />
    <meta name="description" content="时时彩走势图-时时彩标准二星和值走势图、彩票走势图表和数据分析。" />
    <style type="text/css">
        .td
        {
            color: #cc0000;
...
<body>
    ...
    <div id="box1">
        ...
        <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="false"
            ...
            <FooterStyle HorizontalAlign="Center" Font-Size="12px" BackColor='#FFE8EB' Font-Bold="true">
            </FooterStyle>
            ...
            <Columns>
                ...
                <asp:BoundField DataField="LotteryNumber" HeaderText="开奖号码">
                    <ItemStyle Font-Bold="true" Width="72px" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="H_Z" HeaderText="值">
                    <ItemStyle Width="40" BackColor='#cbe5fe' ForeColor="#0000ff" Height="16px" />
                </asp:BoundField>
