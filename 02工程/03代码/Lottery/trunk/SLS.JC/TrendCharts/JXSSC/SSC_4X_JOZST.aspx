<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SSC_4X_JOZST.aspx.cs" Inherits="Home_TrendCharts_JXSSC_SSC_4X_JOZST" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>时时彩四星奇偶走势图-时时彩走势图-彩票走势图表和数据分析－<%=_Site.Name %></title>
    <meta name="keywords" content="时时彩走势图-时时彩四星奇偶走势图" />
    <meta name="description" content="时时彩走势图-时时彩四星奇偶走势图、彩票走势图表和数据分析。" />
    <style type="text/css">
        .td
        {
            color: #cc0000;
    ...
    <div id="box1">
        ...
        <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="J_O_Type" HeaderText="奇偶类型">
                    <ItemStyle CssClass="itemstyle1" Width="80px" />
                </asp:BoundField>
                <asp:BoundField DataField="J_S" HeaderText="奇数">
                    <ItemStyle Width="40" ForeColor="#0000ff" />
                </asp:BoundField>
                <asp:BoundField DataField="O_S" HeaderText="偶数">
                    <ItemStyle Width="40" ForeColor="#ff0000" BackColor="#FFE8EB" />
                </asp:BoundField>
                <asp:BoundField DataField="J_O_B" HeaderText="奇偶比">
                    <ItemStyle Width="60" ForeColor="#999999" />
                </asp:BoundField>
                <asp:BoundField DataField="J_S_H" HeaderText="奇数和">
                    <ItemStyle Width="40" CssClass="itemstyle4" />
                </asp:BoundField>
                <asp:BoundField DataField="O_S_H" HeaderText="偶数和">
                    <ItemStyle Width="40" ForeColor="#ff0000" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="J_max_9" HeaderText="9">
                    <ItemStyle CssClass="itemstyle5" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="O_max_2" HeaderText="2">
                    <ItemStyle CssClass="itemstyle2" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="J_min_9" HeaderText="9">
                    <ItemStyle CssClass="itemstyle1" />
                </asp:BoundField>
                ...
                <asp:BoundField DataField="O_min_2" HeaderText="2">
                    <ItemStyle CssClass="itemstyle5" />
                </asp:BoundField>
