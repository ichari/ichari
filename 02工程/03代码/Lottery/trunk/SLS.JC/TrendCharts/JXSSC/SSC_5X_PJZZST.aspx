<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SSC_5X_PJZZST.aspx.cs" Inherits="Home_TrendCharts_JXSSC_SSC_5X_PJZZST" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<title>时时彩五星均值走势图-时时彩走势图-彩票走势图表和数据分析－<%=_Site.Name %></title>
<meta name="keywords" content="时时彩走势图-时时彩五星均值走势图" />
<meta name="description" content="时时彩走势图-时时彩五星均值走势图、彩票走势图表和数据分析。" />
            ...
            <tbody>
                <tr>
                    <td style="width: 280px" align="center" valign="middle">
                        <h1 class="td" style="font-weight: bold; font-size: 18px;display:inline;">时时彩&nbsp;&nbsp;五星均值走势图</h1>
                    </td>
        ...
        <asp:GridView ID="GridView1" Width="100%" runat="server" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:BoundField DataField="P_Z" HeaderText="值">
                    <ItemStyle Width="26" Font-Bold="true" />
                </asp:BoundField>
