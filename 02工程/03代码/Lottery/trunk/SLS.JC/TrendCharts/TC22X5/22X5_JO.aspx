<%@ Page Language="C#" AutoEventWireup="true" CodeFile="22X5_JO.aspx.cs" Inherits="TC22X5_22X5_JO" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>22选5奇偶分布图</title>
    <style type="text/css">
        body
        {
            font-family: tahoma;
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" UseAccessibleHeader="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="LotteryNumber" HeaderText="开奖号码">
                                            <ItemStyle Width="80px" Font-Bold="True" ForeColor="Blue" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="J" HeaderText="J">
                                            <ItemStyle Width="22px" BackColor="#EDFFD7" />
                                        </asp:BoundField>
                                        ...
                                        <asp:BoundField DataField="J_C" HeaderText="J_C">
                                            <ItemStyle Width="22px" BackColor="#EDFFD7" />
                                        </asp:BoundField>
                                    </Columns>
                                </asp:GridView>
