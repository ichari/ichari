<%@ Page Language="C#" AutoEventWireup="true" CodeFile="22X5_WeiHaoCF.aspx.cs" Inherits="TC22X5_22X5_WeiHaoCF" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>22选5重复走势图</title>
    <style type="text/css">
        body
        {
            font-family: tahoma;
                                ...
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" UseAccessibleHeader="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="LotteryNumber" HeaderText="开奖号码">
                                            <ItemStyle Width="35%" Font-Bold="true" ForeColor="#FF0000" />
                                        </asp:BoundField>
