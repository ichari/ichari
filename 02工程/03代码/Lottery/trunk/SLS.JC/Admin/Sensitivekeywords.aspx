<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Sensitivekeywords.aspx.cs"
    Inherits="Admin_Sensitivekeywords" ValidateRequest="false" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <tr>
                <td>
                    <span style="color: Red">关键词与关键词之间请用逗号(,) 进行分隔</span>
                </td>
            </tr>
            <tr>
    ...
    <input id="hidID" runat="server" visible="false" />
    </form>
