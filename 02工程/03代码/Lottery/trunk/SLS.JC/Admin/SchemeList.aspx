                ...
                <tr>
                    ...
                    <td valign="top" align="center">
                        <table border="0" style="width: 98%; height: 100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:DataGrid ID="g" runat="server" Width="100%" BorderWidth="0px" BackColor="White" Font-Names="宋体" AutoGenerateColumns="False" CellPadding="0" PageSize="20" AllowSorting="True" AllowPaging="True" CellSpacing="1" GridLines="Horizontal" OnItemDataBound="g_ItemDataBound">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:BoundColumn DataField="SchemeNumber" HeaderText="方案号" SortExpression="SchemeNumber">
                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Center" CssClass="dotLineStyle"></ItemStyle>
                                            </asp:BoundColumn>
                                            <asp:BoundColumn DataField="InitiateName" HeaderText="发起人" SortExpression="InitiateName">
                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Center" CssClass="dotLineStyle"></ItemStyle>
                                            </asp:BoundColumn>
                                            <asp:BoundColumn DataField="PlayTypeName" HeaderText="玩法" SortExpression="PlayTypeName">
                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                                <ItemStyle HorizontalAlign="Center" CssClass="dotLineStyle"></ItemStyle>
                                            </asp:BoundColumn>
                                            ...
                                            <asp:BoundColumn DataField="LotteryNumber" HeaderText="投注内容" SortExpression="LotteryNumber">
                                                <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
