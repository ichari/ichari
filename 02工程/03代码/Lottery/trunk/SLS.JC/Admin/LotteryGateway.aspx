...
<body>
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" style="width: 567px">
                                ...
                                <asp:TemplateField HeaderText="出票方式">
                                    <ItemTemplate>
                                        <asp:DropDownList ID="ddlElectronTicket" runat="server">
                                            ...
                                            <asp:ListItem Value="103">深圳恒朋-江西福彩中心</asp:ListItem>
                                            <asp:ListItem Value="102">深圳恒朋-上海福彩中心</asp:ListItem>
                                            <asp:ListItem Value="104">深圳恒朋-山东体彩中心</asp:ListItem>
                                            <asp:ListItem Value="301">Sun BJ</asp:ListItem>
                ...
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="tb_HPSH_Getway" runat="server" Width="328px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="tb_AgentID" runat="server" Width="328px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="tb_AgentPwd" runat="server" Width="328px" TextMode="Password"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>
                        是否启用：
                    ...
                    <td>
                        <asp:CheckBox ID="cb_HPSH" runat="server"></asp:CheckBox></td>
                </tr>
                <tr>
                    <td colspan="2" style="height: 30px">
                        <strong>
                        深圳恒朋-山东体彩中心代理商参数：</strong>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="tb_HPSD_Getway" runat="server" Width="328px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="tb_HPSD_AgentID" runat="server" Width="328px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td>
                    ...
                    <td>
                        <asp:TextBox ID="tb_HPSD_AgentPwd" runat="server" Width="328px" TextMode="Password"></asp:TextBox></td>
                </tr>
                <tr>
                    <td>
                        是否启用：
                    ...
                    <td>
                        <asp:CheckBox ID="cb_HPSD" runat="server"></asp:CheckBox></td>
                </tr>
            </table>
            <br />
    </div>
