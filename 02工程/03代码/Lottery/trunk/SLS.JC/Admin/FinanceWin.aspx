            ...
            <table cellspacing="0" cellpadding="0" width="90%" border="0" align="center">
                <tr>
                    <td style="height: 30px">
                        ...
                        <span style="color: #ff0000">(不输入用户名表示全部用户)</span><asp:TextBox ID="tbID" runat="server" Width="100px" Visible="False"></asp:TextBox></td>
                </tr>
                <tr>
                    <td align="center">
                        <asp:DataGrid ID="g" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="1" BackColor="White" BorderWidth="2px" BorderStyle="None" BorderColor="#E0E0E0" Font-Names="宋体" PageSize="20" AllowPaging="True" OnItemDataBound="g_ItemDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="Money" HeaderText="中奖金额">
                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                    <ItemStyle HorizontalAlign="Right" Font-Bold="False" Font-Italic="False" Font-Overline="False" Font-Strikeout="False" Font-Underline="False" ForeColor="#FF0000"></ItemStyle>
                                </asp:BoundColumn>
                                <asp:HyperLinkColumn DataNavigateUrlField="SchemeID" HeaderText="方案" Target="_blank" Text="查看方案" DataNavigateUrlFormatString="../Home/Room/Scheme.aspx?id={0}"></asp:HyperLinkColumn>
                        ...
                        <ShoveWebUI:ShoveGridPager ID="gPager" runat="server" Width="100%" ShowSelectColumn="False" DataGrid="g" AllowShorting="False" AlternatingRowColor="Linen" GridColor="#E0E0E0" HotColor="MistyRose" Visible="False" OnPageWillChange="gPager_PageWillChange" />
                    </td>
                </tr>
            </table>
            <br />
