<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FinanceAddMoney.aspx.cs" Inherits="Admin_FinanceAddMoney" %>
                    ...
                    <td align="center">
                        <asp:DataGrid ID="g" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="1" BackColor="White" BorderWidth="2px" BorderStyle="None" BorderColor="#E0E0E0" Font-Names="宋体" PageSize="20" AllowPaging="True" OnItemDataBound="g_ItemDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn DataField="PayType" HeaderText="支付方式">
                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
                                </asp:BoundColumn>
                                <asp:BoundColumn DataField="Money" HeaderText="支付金额">
                                    <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
