<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IsuseAdd.aspx.cs" Inherits="Admin_IsuseAdd" %>
                ...
                <tr>
                    <td align="center">
                        <div style="width: 645px; position: relative; height: 150px;">
                            <asp:Label ID="Label15" Style="z-index: 104; left: 24px; position: absolute; top: 105px" runat="server">奖池累金额</asp:Label>
                            ...
                            <asp:TextBox ID="tbMoney" Style="z-index: 101; left: 88px; position: absolute; top: 105px" runat="server" Width="232px" MaxLength="19"></asp:TextBox>
                            ...
                            <ShoveWebUI:ShoveConfirmButton ID="btnAdd" Style="z-index: 106; left: 344px; position: absolute; top: 105px" BackgroupImage="../Images/Admin/buttbg.gif" runat="server" Width="60px" Height="20px" AlertText="确认书写无误并增加一期吗？" Text="增加" OnClick="btnAdd_Click" />
                            ...
                            <asp:CheckBox ID="cbAutoNext10Isuse" 
                                Style="z-index: 109; left: 85px; position: absolute; top: 125px; right: 144px;" 
                                runat="server" Text="按开奖间隔连续增加 10 期(系统对此不设期号是否重复检查，请谨慎操作)" />
                        </div>
                        <asp:Panel ID="pnMultiAdd" runat="server" Width="645" Visible="false">
                        <div style="text-align:left; margin:0 22px 0 22px;">
                            <span style="border: 1px solid black;padding:10px;">增加天数
                                <asp:TextBox ID="tbMultiDays" runat="server" Text="" />
                                <asp:Button ID="btnMultiAdd" runat="server" Text="增加" OnClick="btnMultiAdd_Click" />
                                <span style="color:Red;">*截止时间会自动计算</span>
                            </span>
                        </div>
                        </asp:Panel>
                        ...
                        <asp:Panel ID="pJQC" runat="server" Visible="False">
                            <div style="width: 644px; position: relative; height: 288px; left: 0px; top: 0px;">
                                ...
                                <asp:Label ID="Label54" Style="z-index: 105; left: 264px; position: absolute; top: 47px" runat="server">比赛时间</asp:Label>
                                ...
                                <asp:TextBox ID="tbJQC1_2" Style="z-index: 104; left: 320px; position: absolute; top: 47px" runat="server" MaxLength="19" Width="160px"></asp:TextBox>
                                <asp:Label ID="Label56" Style="z-index: 108; left: 72px; position: absolute; top: 64px" runat="server">2</asp:Label>
                                <asp:TextBox ID="tbJQC2_2" Style="z-index: 110; left: 496px; position: absolute; top: 47px" runat="server" MaxLength="19" Width="1px" Visible="False"></asp:TextBox>
                                &nbsp;
                                ...
                                <asp:Label ID="Label60" Style="z-index: 124; left: 264px; position: absolute; top: 111px" runat="server">比赛时间</asp:Label>
                                <asp:TextBox ID="tbJQC3_2" Style="z-index: 126; left: 320px; position: absolute; top: 111px" runat="server" MaxLength="19" Width="160px"></asp:TextBox>
                                <asp:Label ID="Label61" Style="z-index: 107; left: 72px; position: absolute; top: 64px" runat="server">1</asp:Label>
                                <asp:TextBox ID="tbJQC5_2" Style="z-index: 109; left: 320px; position: absolute; top: 175px" runat="server" MaxLength="19" Width="160px"></asp:TextBox>
                                <asp:Label ID="Label62" Style="z-index: 112; left: 264px; position: absolute; top: 175px" runat="server">比赛时间</asp:Label>
                                ...
                                &nbsp;
                                <asp:TextBox ID="tbJQC4_2" Style="z-index: 127; left: 499px; position: absolute; top: 112px" runat="server" MaxLength="19" Width="1px" Visible="False"></asp:TextBox>
                                ...
                                &nbsp;
                                <asp:TextBox ID="tbJQC6_2" Style="z-index: 144; left: 499px; position: absolute; top: 176px" runat="server" MaxLength="19" Width="1px" Visible="False"></asp:TextBox>
                                ...
                                <asp:Label ID="Label73" Style="z-index: 131; left: 264px; position: absolute; top: 239px" runat="server">比赛时间</asp:Label>
                                <asp:TextBox ID="tbJQC7_2" Style="z-index: 132; left: 320px; position: absolute; top: 239px" runat="server" MaxLength="19" Width="160px"></asp:TextBox>
                                ...
                                &nbsp;
                                <asp:TextBox ID="tbJQC8_2" Style="z-index: 149; left: 500px; position: absolute; top: 238px" runat="server" MaxLength="19" Width="1px" Visible="False"></asp:TextBox>
                            </div>
                        </asp:Panel>
                        <asp:Panel ID="pLCBQC" runat="server" Visible="False">
                            <div style="width: 644px; position: relative; height: 221px">
                        ...
                        <asp:Panel ID="pLCDC" runat="server" Visible="False">
                            <div style="width: 644px; position: relative; height: 60px">
                        ...
                        <asp:Panel ID="ZCDC" runat="server" Visible="False">
                            <table id="tableCompetitionNum" runat="server" align="center" visible="true" style="width: 642px">
                                <tr>
                                    <td align="left" style="width: 638px">
                                        &nbsp;&nbsp;&nbsp;本期比赛总场数：<asp:TextBox ID="CompetitionNum" runat="server" onkeypress="return CompetitionNumOnPress();"></asp:TextBox>
                                        <ShoveWebUI:ShoveConfirmButton ID="btCompetitionNum" 
                                            BackgroupImage="../Images/Admin/buttbg.gif" runat="server" Width="60px" 
                                            Height="20px" AlertText="确定后将无法增加，确认书写无误吗？" Text="手动添加" 
                                            OnClick="btCompetitionNum_Click" /><ShoveWebUI:ShoveConfirmButton ID="tb_auto" 
                                            runat="server" AlertText="确定后将无法增加，确认书写无误吗？" 
                                            BackgroupImage="../Images/Admin/buttbg.gif" Height="20px" 
                                            onclick="tb_auto_Click" Text="自动添加" Width="60px" />
                                        <font color="red">先添加总场次 时间格式: 0000-00-00 00:00:00</font>
                                    </td>
                                </tr>
                            </table><br />
                           
                            <br />
                            <asp:DataList ID="DataListZCDC" runat="server" RepeatColumns="1" ShowFooter="False" Visible="false" OnItemDataBound="DataListZCDC_ItemDataBound">
                                <HeaderTemplate>
                                ...
                                <ItemTemplate>
                                    <table id="tableZCDC" align="center" style="width: 642px">
                                        <tr>
                                            <td align="center" style="height: 21px; width: 40px;">
                                                <asp:Label ID="lbZCDC" runat="server" Text='<%# Eval("ID")%>'></asp:Label>
                                            </td>
                                            <td align="center" style="height: 21px; width: 126px;">                                              
                                                <asp:DropDownList ID="ddlLeagueType" runat="server" >
                                                </asp:DropDownList>
                                                  <asp:HiddenField ID="HidLeagueType" runat="server"  Value='<%# Eval("League") %>'/>
                                                   <asp:HiddenField ID="HidColor" runat="server"  Value='<%# Eval("Color") %>'/>
                                            </td>
                                            <td align="center" style="height: 21px; width: 180px;">
                                                <asp:TextBox ID="tb1ZCDC" runat="server" MaxLength="20" Width="110px" Text='<%# Eval("HostTeam") %>'></asp:TextBox>
                                                ...
                                                <asp:HiddenField ID="Hiddloseball" runat="server" Value='<%# Eval("loseBall") %>' />
                                            </td>
                                            <td style="height: 21px; width: 45px;" align="center">
                                                <font color="red"><b>VS</b></font>
                                            </td>
                                            ...
                                            <td align="center" style="width: 100px; height: 21px">
                                                <asp:TextBox ID="tb3ZCDC" runat="server" MaxLength="20" Width="100px" Text='<%# Eval("Time") %>'></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </ItemTemplate>
