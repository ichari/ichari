<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserDistillUnsuccess.aspx.cs"
    Inherits="Admin_UserDistillUnsuccess" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="border: 1px solid #BCD2E9; width: 99%; margin-top: 10px; margin-bottom: 8px; background-color: #F4F9FC; height: 80px; vertical-align: middle;" >
            
            <div style="border-color: #BCD2E9; width: 100%;  height: 35px; vertical-align: middle; " align="center">
                <span style="font-size: 14px; font-weight: bold; color: #226699">支付宝付款失败一览表</span>
            </div>
            <div>
                提示：批量付款到支付宝或银行卡时,返回结果为支付失败的提款.财务人员需要确认是否已经付款,如果没有付款成功,请另作付款或者拒绝提款.
            </div>
                                   ...
                                   <asp:BoundColumn  DataField="BankInCity" HeaderText="所在市"></asp:BoundColumn>
                                    ...
                                    <asp:TemplateColumn HeaderText="操作"> 
                                            ...
                                            <ItemTemplate> 
                                                ...
                                                <br />拒绝原因:<asp:TextBox ID="tbMemo" runat="server"  MaxLength="50" Height="16px" Width="80" />
                                         </ItemTemplate> 
                                    </asp:TemplateColumn> 
                                </Columns>
