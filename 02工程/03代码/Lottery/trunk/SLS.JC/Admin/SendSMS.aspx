        ...
        <div>
            <table id="Table1" cellspacing="0" cellpadding="0" width="654" align="center" border="0">
                ...
                <tr>
                    <td align="center">
                        <br />
                        <table id="Table4" cellspacing="0" cellpadding="0" width="726" border="0">
                            <tr>
                                <td class="td2" style="width: 107px" valign="top" height="25" align="right">
                                    <font color="#999999">发送给：</font></td>
                                <td class="td2" height="25" align="left">
                                    <font face="宋体">
                                        <asp:TextBox ID="tbAim" runat="server" BorderWidth="1px" BorderColor="Silver" Width="620px"></asp:TextBox><br />
                                        <font color="#999999">可以是用户名，也可以是手机号码，用,隔开。如：shove,3km,dudu,我爱500W,13537697102。<font face="宋体">最多同时只能发送 50 个用户，超过的部分系统将不发送。</font></font></font></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="td2" height="25" align="left">
                                    <font face="宋体">
                                        <asp:TextBox ID="tbContent" runat="server" BorderWidth="1px" BorderColor="Silver" Width="620px" MaxLength="140" Height="100px" TextMode="MultiLine"></asp:TextBox><br />
