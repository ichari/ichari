<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserDistillWaitPay.aspx.cs" Inherits="Admin_UserDistillWaitPay" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <table border="0" cellspacing="0" cellpadding="0" width="99%">
            ...
            <tr>
               <td height="1" colspan="8" bgcolor="#FFFFFF"></td>
            </tr>
            <tr>
                <td height="2" colspan="8" bgcolor="#6699CC"></td>
            </tr>
        </table>
            ...
            <tr>
                <td>
                    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#DDDDDD">
                        <tr>
                            <td height="20"  align="left" bgcolor="#F8F8F8"  style="padding: 5px 10px 5px 10px;"></td>
                        </tr>
                        <tr>
                            <td height="30"  align="center" bgcolor="#FFFFFF">
                                <asp:DataGrid ID="g" runat="server" Width="100%" AutoGenerateColumns="False" CellPadding="1" BackColor="White" 
                                    BorderWidth="2px" BorderStyle="None" BorderColor="#E0E0E0" Font-Names="宋体" PageSize="20" AllowPaging="True" 
                                    onitemcommand="g_ItemCommand" DataKeyField="ID" onitemdatabound="g_ItemDataBound">
                                    <FooterStyle ForeColor="#330099" BackColor="#FFFFCC"></FooterStyle>
                                    <SelectedItemStyle Font-Bold="True" ForeColor="#663399"></SelectedItemStyle>
                                    <HeaderStyle HorizontalAlign="Center" ForeColor="RoyalBlue" VerticalAlign="Middle" BackColor="#E7F1FA"></HeaderStyle>
                                    <Columns>
