<%@ Page Language="C#" AutoEventWireup="true" CodeFile="OnlinePayGateway.aspx.cs" Inherits="Admin_OnlinePayGateway" %>
            ...
            <table width="707" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#85BDE2" style="color: #000000">
                ...
                <tr>
                    ...
                    <td bgcolor="#FFFFFF" style="width: 212px">
                        <asp:TextBox ID="tbChinaUnionName" runat="server" MaxLength="100" Width="456px"></asp:TextBox></td>
                </tr>
                <tr>
                    <td height="26" bgcolor="#FFFFFF" style="width: 115px">
                        <div align="right">
                    ...
                    <td bgcolor="#FFFFFF" style="width: 212px">
                        <asp:TextBox ID="tbChinaUnionNumber" runat="server" Width="456px" MaxLength="100"></asp:TextBox></td>
                </tr>
                <tr>
                    <td height="26" bgcolor="#FFFFFF" style="width: 115px">
                        <div align="right">
                    ...
                    <td bgcolor="#FFFFFF" style="width: 212px">
                        <asp:TextBox ID="tbChinaUnionKey" runat="server" MaxLength="100" TextMode="Password" Width="456px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td height="26" bgcolor="#FFFFFF" style="width: 115px">
                    ...
                    <td bgcolor="#FFFFFF" style="width: 212px">
                        <asp:TextBox ID="tbChinaUnionPayCommisionRate" runat="server" Width="130px" MaxLength="5"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td height="26" bgcolor="#FFFFFF" style="width: 115px">
                    ...
                    <td bgcolor="#FFFFFF" style="width: 212px">
                        <asp:TextBox ID="tbChinaUnionSetKey" runat="server" MaxLength="5" Width="456px" TextMode="Password"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td height="26" bgcolor="#FFFFFF" style="width: 115px">
                    ...
                    <td bgcolor="#FFFFFF" style="width: 212px">
                        <asp:TextBox ID="tbChinaUnionSetCommisionRate" runat="server" MaxLength="5" Width="130px"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    <td height="26" bgcolor="#FFFFFF" style="width: 115px">
                    ...
                    <td bgcolor="#FFFFFF" style="width: 212px">
                        <asp:CheckBox ID="cbChinaUnionStatus" runat="server" Text="启用" />
                    </td>
                </tr>
