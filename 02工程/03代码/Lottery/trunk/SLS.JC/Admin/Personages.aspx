<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Personages.aspx.cs" Inherits="Admin_Personages" %>
                            ...
                            <asp:TemplateColumn HeaderText="编辑">
                                ...
                                <ItemTemplate>
                                    <asp:LinkButton ID="btnEdit" runat="server" CommandName="Edit">修改</asp:LinkButton>
                                     <asp:LinkButton ID="btnDelete" runat="server" CommandName="Deletes">删除</asp:LinkButton>
                                </ItemTemplate>
                            </asp:TemplateColumn>
