<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IsuseAdd2.aspx.cs" Inherits="Admin_IsuseAdd2" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table id="Table1" cellspacing="0" cellpadding="0" width="99%" align="right" border="0">
                <tr>
                    <td align="center">
                        <div style="width: 645px; position: relative; height: 121px">
                            ...
                            <ShoveWebUI:ShoveConfirmButton ID="btnAdd" Style="z-index: 106; left: 344px; position: absolute; top: 72px" BackgroupImage="../Images/Admin/buttbg.gif" runat="server" Width="60px" Height="20px" AlertText="确认书写无误并增加一期吗？" Text="增加" OnClick="btnAdd_Click" />
                            ...
                            <asp:CheckBox ID="cbAutoNext10Isuse" Style="z-index: 109; left: 85px; position: absolute; top: 95px" runat="server" Text="按开奖间隔连续增加 10 期(系统对此不设期号是否重复检查，请谨慎操作)" />
                        </div>
                            ...
                            <table id="tableCompetitionNum" runat="server" align="center" visible="true" style="width: 642px">
                                <tr>
                                    <td align="left" style="width: 638px">
                                        ...
                                        <ShoveWebUI:ShoveConfirmButton ID="btCompetitionNum" BackgroupImage="../Images/Admin/buttbg.gif" runat="server" Width="60px" Height="20px" AlertText="确定后将无法增加，确认书写无误吗？" Text="确定" OnClick="btCompetitionNum_Click" />
                                ...
                                <ItemTemplate>
                                    <table id="tableZCDC" align="center" style="width: 642px">
                                        <tr>
                                            ...
                                            <td align="center" style="height: 21px; width: 180px;">
                                                <asp:TextBox ID="tb1ZCDC" runat="server" MaxLength="20" Width="110px"></asp:TextBox>
                                            ...
                                            <td align="center" style="height: 21px; width: 110px;">
                                                <asp:TextBox ID="tb2ZCDC" runat="server" MaxLength="20" Width="110px"></asp:TextBox>
                                            </td>
                                            <td align="center" style="width: 100px; height: 21px">
                                                <asp:TextBox ID="tb3ZCDC" runat="server" MaxLength="20" Width="100px"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </ItemTemplate>
