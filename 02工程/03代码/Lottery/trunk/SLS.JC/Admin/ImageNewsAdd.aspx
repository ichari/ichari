<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImageNewsAdd.aspx.cs" Inherits="Admin_ImageNewsAdd"
            ...
            <tr>
                <td>
                    <font face="宋体">使用已存在的图片
                        <asp:DropDownList ID="ddlImage" runat="server" Width="250px" onChange='document.x1.src="/Private/1/NewsImages/" + options[selectedIndex].value'>
                        </asp:DropDownList>
                        <img src="" name="x1" id="x1">
                    </font>
                </td>
            </tr>
            <tr>
