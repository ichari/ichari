<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InputOpenAffiche.aspx.cs"
    Inherits="Admin_InputOpenAffiche" ValidateRequest="false" %>
        ...
        <table id="Table1" cellspacing="0" cellpadding="0" width="90%" align="center" border="0">
            <tr>
                <td style="height: 21px">
                    ...
                    <span style="margin-left: 30px;"><a href="InputOpenAffiche2.aspx">录入未开启彩种开奖公告</a></span>
                </td>
            </tr>
            <tr>
                <td align="center">
            ...
            <tr>
                <td align="center" style="height: 50px">
                    <ShoveWebUI:ShoveConfirmButton ID="btnOK" runat="server" BackgroupImage="../Images/Admin/buttbg.gif"
                        Width="60px" Height="20px" Text="保存" AlertText="确信输入无误，并立即保存吗？" 
