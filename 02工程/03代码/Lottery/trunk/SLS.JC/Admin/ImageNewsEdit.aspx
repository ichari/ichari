<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ImageNewsEdit.aspx.cs" Inherits="Admin_ImageNewsEdit" ValidateRequest="false" %>
                ...
                <tr>
                    <td>
                        <font face="宋体">使用已存在的图片
                            <asp:DropDownList ID="ddlImage" runat="server" Width="160px" onChange='document.x1.src="/Private/1/NewsImages/" + options[selectedIndex].value'>
                            </asp:DropDownList>&nbsp;&nbsp;<img src='<%=ImageURL%>' name="x1" id="x1">
                        </font>
                    </td>
                </tr>
                <tr>
