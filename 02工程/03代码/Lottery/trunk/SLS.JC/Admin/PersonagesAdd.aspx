<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PersonagesAdd.aspx.cs" Inherits="Admin_PersonagesAdd" %>
                ...
                <td>
                    ...
                    <asp:TextBox ID="tbOrder" runat="server" MaxLength="10" Width="100px">1</asp:TextBox>&nbsp;<asp:CheckBox
                        ID="cbisShow" runat="server" Text="是否显示" Checked="True"></asp:CheckBox>
                                         &nbsp
                    <asp:CheckBox ID="cbIsRecommend" runat="server" Text="是否本期推荐" Checked="false"></asp:CheckBox>
                </td>
