                        ...
                        <ItemTemplate>
                            <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                <tr>
                                    ...
                                    <td width="42%">
                                        <a class="li3" href='../Home/Web/DownloadSchemeFile.aspx?id=<%# DataBinder.Eval(Container.DataItem,"id")%>' target="_blank"><%# Shove._String.Cut(DataBinder.Eval(Container.DataItem,"LotteryNumber").ToString().Trim(), 10)%></a>
                                    </td>
                                    <td width="4%">
