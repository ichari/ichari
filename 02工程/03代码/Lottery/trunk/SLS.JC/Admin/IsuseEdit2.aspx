<%@ Page Language="C#" AutoEventWireup="true" CodeFile="IsuseEdit2.aspx.cs" Inherits="Admin_IsuseEdit2" %>
    ...
    <form id="form1" runat="server">
        <div>
            <table id="Table1" cellspacing="0" cellpadding="0" width="99%" align="right" border="0">
                <tr>
                    <td align="center">
                        <div style="width: 645px; position: relative; height: 104px">
                            <asp:Label ID="Label3" Style="z-index: 104; left: 24px; position: absolute; top: 72px" runat="server">截止时间</asp:Label>
                            <asp:TextBox ID="tbIsuseID" Style="z-index: 108; left: 312px; position: absolute; top: 8px" runat="server" Width="80px" Visible="False"></asp:TextBox>
                            ...
                            <ShoveWebUI:ShoveConfirmButton ID="btnEdit" Style="left: 376px; position: absolute; top: 72px;" BackgroupImage="../Images/Admin/buttbg.gif" runat="server" Width="60px" Height="20px" Text="保存" AlertText="确认书写无误吗？" OnClick="btnEdit_Click" />
