<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchemeAtTop.aspx.cs" Inherits="Admin_SchemeAtTop" %>
            ...
            <table id="Table1" cellspacing="0" cellpadding="0" width="90%" border="0" align="center">
                <tr>
                    <td style="height: 17px">
                        ...
                        <asp:CheckBox ID="cbUserApplication" runat="server" AutoPostBack="True" Text="仅显示用户申请置顶的方案" OnCheckedChanged="cbUserApplication_CheckedChanged"></asp:CheckBox></td>
                </tr>
                <tr>
                    <td align="center">
                        <asp:DataGrid ID="g" runat="server" Width="100%" AllowPaging="True" PageSize="30" BorderColor="#E0E0E0" BorderStyle="None" BorderWidth="2px" BackColor="White" CellPadding="0" AutoGenerateColumns="False" AllowSorting="True" OnItemCreated="g_ItemCreated" OnItemDataBound="g_ItemDataBound">
                            ...
                            <Columns>
                                ...
                                <asp:BoundColumn Visible="False" DataField="AtTopStatus" SortExpression="AtTopStatus"></asp:BoundColumn>
                            </Columns>
