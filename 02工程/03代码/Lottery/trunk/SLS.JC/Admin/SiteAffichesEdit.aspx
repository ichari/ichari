            ...
            <tr>
                <td>
                    <font face="宋体">时间
                            ...
                            <asp:CheckBox ID="cbisShow" runat="server" Text="是否显示"></asp:CheckBox>&nbsp;<asp:TextBox ID="tbID" runat="server" Visible="False"></asp:TextBox>&nbsp;<asp:CheckBox ID="cbisCommend" runat="server" Text="是否推荐"></asp:CheckBox>&nbsp;<asp:CheckBox ID="cbTitleRed" runat="server" Text="标题加红" Checked="False"></asp:CheckBox></font>
                </td>
            </tr>
            <tr>
                <td>
                    <font face="宋体">标题
                            <asp:TextBox ID="tbTitle" runat="server" Width="648px"></asp:TextBox></font>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                <td style="height: 49px" align="center">
                    <ShoveWebUI:ShoveConfirmButton ID="btnSave" runat="server" Width="60px" Height="20px"
                        ...
                        OnClientClick="sync_editor();" OnClick="btnSave_Click" />
                </td>
            </tr>
        </table>
        <br />
