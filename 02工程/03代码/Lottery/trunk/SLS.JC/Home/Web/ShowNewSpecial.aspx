<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ShowNewSpecial.aspx.cs" Inherits="Home_Web_ShowNewSpecial" %>
            ...
            <!--新闻右边图片-->
                        ...
                        <div class="jc_period sub">
                            <div class="r_box" style="width:275px;">
                                ...
                                <div class="r_content">
                                    <table border="0" cellpadding="0" cellspacing="0" class="zj_table" width="100%">
                                        <thead>
                                            <tr>
                                                <th class="text_l">
                                                    用户名 
                ...
                <div class="content1_740">
                    <table width="710" border="0" cellpadding="0" cellspacing="1" bgcolor="#9BBFCA">
                        <tr>
                            <td bgcolor="#FFFFFF">
