<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Receive.aspx.cs" Inherits="Home_Room_Receive" %>
        ...
        <div style="padding: 10px; border: #ccc 1px solid; font-size: 12px;" id="box1">
            <table id="tableRegister" runat="server" border="0" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    ...
                    <td height="23" style="padding-left: 12" align="left">
                        <asp:TextBox ID="tbRealityName" runat="server" MaxLength="16" CssClass="in_p2"></asp:TextBox>
                    </td>
                    <td align="left">
                       <font color="#cc0000" face="宋体"><span class="zw5">&nbsp;*</span></font> <span style="color: red;">非常重要，和您的提款相关，请务必填写</span>
                    </td>
                </tr>
