<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BindAlipay.aspx.cs" Inherits="Home_Room_BindAlipay" %>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
        <tr>
            ...
            <td width="100" align="center" background="images/admin_qh_100_1.jpg" class="blue12">
                <a href="BindAlipay.aspx"><strong>绑定支付宝</strong></a>
            </td>
            <td width="4">
                &nbsp;
            </td>
        ...
        <tr>
            <td height="30" align="left" bgcolor="#F3F3F3" class="black12" style="padding: 10px;">
                <p>
                    ...
                    <br />
                    <asp:Label ID="lbStatus" runat="server"></asp:Label>支付宝，提款时款项将汇至您以下绑定支付宝账号中，请确认。</p>
            </td>
        </tr>
    </table>
        ...
        <tr>
            <td width="100%" height="30" align="center" bgcolor="#FFFFFF" class="black12" style="padding: 10px;">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
                    ...
                    <asp:Label ID="lbQuestion" runat="server" Visible="false"></asp:Label>
                    <%--<tr bgcolor="#C0DBF9">
                        <td height="30" align="right" bgcolor="#FFFFFF" class="black12">
                            安全保护问题：
                        </td>
                        <td align="left" bgcolor="#FFFFFF" class="black12" style="padding-left: 10px;">
                            ...
                            &nbsp;&nbsp;<span class="blue12"><a href="SafeSet.aspx?FromUrl='BindAlipay.aspx'">
