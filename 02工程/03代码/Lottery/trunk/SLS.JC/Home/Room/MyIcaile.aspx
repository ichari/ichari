<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MyIcaile.aspx.cs" Inherits="Home_Room_MyIcaile" %>
...
<head id="Head1" runat="server">
    <title>中奖查询-我的账户-用户中心-<%=_Site.Name %>－买彩票，就上<%=_Site.Name %> ！</title>
        ...
        <tr>
            ...
            <td valign="top">
                <div id="divInvestHistory">
                    ...
                    <asp:DataGrid ID="gInvestHistory" runat="server" width="100%" BorderStyle="None" AllowPaging="True"
                    ...
                    <ShoveWebUI:ShoveGridPager ID="gPagerHistory" runat="server" width="100%" PageSize="10"
                    ...
                    <table id="Table1" width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#D8D8D8"
