<%@ Page Language="C#" AutoEventWireup="true" CodeFile="HongBaoRecord.aspx.cs" Inherits="Home_Room_MyPromotion_HongBaoRecord" %>
...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#9FC8EA">
        <tr>
            <td height="30" colspan="9" align="right" bgcolor="#FFFFFF" style="padding-right: 10px;background-image:url('/Home/Room/Images/bg_blue_30.jpg');">
