<%@ Page Language="C#" AutoEventWireup="true" CodeFile="MemberPromotion.aspx.cs" Inherits="Home_Room_MyPromotion_MemberPromotion" %>
...
<div class="w970">
    <div id="content">
        <div id="menu_left">
            <uc2:UserMyIcaile ID="UserMyIcaile1" runat="server" CurrentPage="pmMyPromo" />
        </div>
        <div id="menu_right" style="margin-top:0px">
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0" background="../images/admin_qh_100_2.jpg" style="margin-top: 10px;">
                <tr>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                    ...
                    <tr>
                        <td align="center" bgcolor="#f7f7f7" style="padding: 15px;">
                            <a href="javascript:;" onclick="tdMemberPromotion3.click();"><img src="../images/button_tuiguang.jpg" width="204" height="40" border="0" /></a>
                        </td>
                    </tr>
                </table>
            </div> 
            <div id="divMemberPromotion2" style="display:none">
                <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#DDDDDD" style="padding-left: 0px; 
                    padding-top: 0px; border-left: 1px solid #DDDDDD; border-right: 1px solid #DDDDDD;">
                    <tr>
                                ...
                                <tr>
                                    <td class="black12" style="padding-left:50px">
                                        ...
                                        <ShoveWebUI:ShoveConfirmButton ID="btnSearch" runat="server" BackgroupImage="../images/button_sousuo.jpg"
                                            Style="cursor: hand;" BorderStyle="None" Height="23px" Width="72px" onclick="btnSearch_Click" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <asp:DataGrid ID="g" runat="server" width="100%" BorderStyle="None" AllowPaging="True" PageSize="30" AutoGenerateColumns="False"
                    CellPadding="0" BackColor="#DDDDDD" Font-Names="Tahoma" CellSpacing="1" GridLines="None" onitemdatabound="g_ItemDataBound">
                                ...
                                <tr>
                                    <td height="30"  align="left">
                                        ...
                                        <div id="ckepop">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:copyToClipboard()">[复制链接]</a>
                                        </div>
            ...
            <div id="divMemberPromotion4" style="display:none">
                        ...
                        <td height="30" colspan="10" align="left" bgcolor="#EEEEEE" style="padding: 5px 10px 5px 10px;">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td class="black12" style="padding-left:50px">
                                        请选择查询月份：
                                        <asp:DropDownList ID="ddlYear" runat="server" Width="88px"></asp:DropDownList>
                                        <asp:DropDownList ID="ddlMonth" runat="server" Width="55px">
                                        ...
                                        <ShoveWebUI:ShoveConfirmButton ID="btnSearch1" runat="server" BackgroupImage="../images/button_sousuo.jpg"
                                            Style="cursor: hand;" BorderStyle="None" Height="23px" Width="72px" onclick="btnSearch1_Click" />
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <asp:DataGrid ID="g1" runat="server" width="100%" BorderStyle="None" AllowPaging="True"
                    PageSize="30" AutoGenerateColumns="False" CellPadding="0" BackColor="#DDDDDD" Font-Names="Tahoma" 
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#D8D8D8" style="margin-top: 10px;">
                    ...
                    <tr>
                        <td bgcolor="#F8F8F8" class="black12" style="padding: 5px 10px 5px 10px;" colspan="2">
                            累计推广佣金： <asp:Label ID="lbTotalBonus" runat="server"  Text ="0.00" ForeColor="#CC0000"/> &nbsp;(元)&nbsp; (包含推广的会员和商家) 
                        </td>
                    </tr>
                </table>
            </div>
            <div id="divHongBao" style="display:none;">
                <iframe id="contentFrame" frameborder="0" width="100%" onload="this.height = this.contentWindow.document.body.scrollHeight;" name="contentFrame" 
                    border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes">
                </iframe>
            </div>
            <div id="divUserAccountDetail" style="display:none">
                <iframe id="UserAccountDetailIframe" frameborder="0" width="100%" onload="this.height = this.contentWindow.document.body.scrollHeight;" name="UserAccountDetailIframe" 
                    border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes">
                </iframe>
            </div>
            <div id="divUserPromotionDetail" style="display:none">
                <iframe id="UserPromotionDetailIframe" frameborder="0" width="100%" onload="this.height = this.contentWindow.document.body.scrollHeight;" name="UserPromotionDetailIframe" 
                    border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes">
                </iframe>
            </div>
            <div id="divMemberPromotion5" style="display:none">
                <iframe id="DistillListIframe" frameborder="0" width="100%" onload="this.height = this.contentWindow.document.body.scrollHeight;"  
                    border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes">
                </iframe>
            </div>
            <div id="divMemberPromotion6" style="display:none">
                <iframe id="AppDistillIframe" frameborder="0" width="100%" onload="this.height = this.contentWindow.document.body.scrollHeight;"  
                    border="0" marginwidth="0" marginheight="0" scrolling="no" allowtransparency="yes">
                </iframe>
            </div>     
        </div>
...
<script type="text/javascript" language="javascript">   
    ...
    function ClickMenu(obj) {
        lastid.style.background = "url(../images/admin_qh_100_2.jpg)";
        //lastid.style.fontWeight = "normal";
        lastid.className = "";
        document.getElementById(lastid.id.replace("td","div")).style.display = "none";
        obj.style.background = "url(../images/admin_qh_100_1.jpg)";
        //obj.style.fontWeight = "bold";
        obj.className = "afff fs14";
