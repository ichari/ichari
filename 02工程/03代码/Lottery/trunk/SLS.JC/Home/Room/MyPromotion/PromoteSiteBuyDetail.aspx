<%@ Page Language="C#" AutoEventWireup="true" CodeFile="PromoteSiteBuyDetail.aspx.cs" Inherits="Home_Room_MyPromotion_PromoteSiteBuyDetail" %>
        ...
        <asp:DataGrid ID="g" runat="server" width="100%" BorderStyle="None" AllowPaging="True"
            ...
            <Columns>
                ...
                <asp:HyperLinkColumn DataNavigateUrlField="SchemeID" DataTextField="SchemeNumber" Target="_blank" 
                    HeaderText="方案号" DataNavigateUrlFormatString="../Scheme.aspx?id={0}" ItemStyle-ForeColor="Blue">
