<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AccountDrawMoney.aspx.cs" Inherits="Home_Room_AccountDrawMoney" %>
   ...
   <div id="divUserDistills">
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="#D8D8D8" style="margin-top: 10px;">
                        <tbody id="isShowDistill" runat="server">
                            <tr>
                                <td width="385" bgcolor="#F8F8F8" style="display:none" class="black12" style="padding: 5px 10px 5px 10px;">
