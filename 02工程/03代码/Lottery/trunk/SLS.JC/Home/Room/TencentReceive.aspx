<%@ Page Language="C#" AutoEventWireup="true" CodeFile="TencentReceive.aspx.cs" Inherits="Home_Room_TencentReceive" %>

<%@ Register Assembly="Shove.Web.UI.4 For.NET 3.5" Namespace="Shove.Web.UI" TagPrefix="ShoveWebUI" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title><%=_Site.Name %>-手机买彩票，就上<%=_Site.Name %> ！</title>
...
<body>
            ...
            <table id="tableRegister" runat="server" border="0" cellpadding="0" cellspacing="0"
                ...
                <tr>
                    <td height="60px" class="cheng" align="center" colspan="3">
                        尊敬的QQ用户<asp:Label ID="labAccount" runat="server" Text=""></asp:Label>，<%=_Site.Name %>欢迎您！请完善您在本站的用户资料：
                    </td>
                </tr>
                <tr>
                    <td align="right">
                    ...
                    <td align="left">
                        ...
                        <input id="btnCheckUserName" type="button" value="检查用户名是否可用" onclick="btn_CheckUserName(document.getElementById('tbName').value);" />
                    ...
                    <td height="23" style="padding-left: 12" align="left">
                        <asp:TextBox ID="tbTrueName" runat="server" MaxLength="16" CssClass="in_p2"></asp:TextBox>
                    </td>
                    <td align="left">
                        <font color="#cc0000" face="宋体"><span class="zw5">&nbsp;*</span></font>
                        <span class="style1">请正确输入您的姓名</span>
                    </td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                   ...
                   <tr>
                    ...
                    <td height="23" style="padding-left: 12" align="left">
                        <asp:TextBox ID="tbEmail" runat="server" CssClass="in_p2" MaxLength="13"></asp:TextBox>    
                    </td>
                    <td align="left">
                        <font color="#cc0000" face="宋体"><span class="zw5">&nbsp;*</span></font> <span class="style1">
                            请输入您的Email地址。</span>
                    </td>
                </tr>
                ...
                <tr>
                    <td colspan="3" valign="middle" align="center" height="30px" style="padding-bottom: 5px">
                        <ShoveWebUI:ShoveConfirmButton ID="btnOK" runat="server" Style="cursor: hand" Text=" 确定 " AlertText="确信输入无误并立即保存吗？"
                            OnClick="btnOK_Click" />
                        <asp:TextBox ID="tbQQID" runat="server" Visible="false"></asp:TextBox>
                    </td>
                </tr>
            </table>
            <table id="tableSelect" runat="server" visible="false" border="0" cellpadding="0"
                ...
                <tr>
                    <td height="60px" class="cheng" align="center" colspan="2">
                        尊敬的QQ用户<asp:Label ID="labAccount2" runat="server" Text=""></asp:Label>，<%=_Site.Name %>欢迎您！请从多个绑定用户中选择一个用户登录：
                    </td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                    <td align="left" colspan="2" style="height: 80px;">
                        <span class="style1">&nbsp;&nbsp;&nbsp;&nbsp;您用多个本站会员同时绑定了一个相同的QQ账号。本系统将在 1 周后不支持这种多会员对同一QQ账号的绑定，请您在这段时间内将您所属的所有的会员绑定上不同的QQ账号。谢谢支持。对您造成的不便，请谅解。谢谢！</span><br
                            class="style1" />
                        <br class="style1" />
                        <span class="style1">&nbsp;&nbsp;&nbsp; 否则系统升级后，您的多个会员账号，仅有最近一次注册的账号能够在QQ官网上直接登陆。</span>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <script type="text/javascript" language="javascript">
        ...
        {
            var result = Home_Room_TencentReceive.CheckUserName(userName).value;
