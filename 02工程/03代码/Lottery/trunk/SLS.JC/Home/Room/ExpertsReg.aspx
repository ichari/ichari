...
<head id="Head1" runat="server">
    <title><%=_Site.Name %>中专家申请-我的资料-用户中心-<%=_Site.Name %>－买彩票，就上<%=_Site.Name %> ！</title>
...
<body>
    ...
    <table width="100%" border="0"  cellspacing="0" cellpadding="0" style="margin-top: 10px;" id="LotteryList">
        <tr>
