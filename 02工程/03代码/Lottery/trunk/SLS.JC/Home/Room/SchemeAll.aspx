<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SchemeAll.aspx.cs" Inherits="Home_Room_SchemeAll" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        $(document).ready(function () {
            if ($("#btnType_" + $("#HidFilter").val()) != undefined)
                $("#btnType_" + $("#HidFilter").val()).css("color", "Blue").siblings().css("color", "");
        });
    </script>
</head>
<body>
<form id="form1" runat="server">
    ...
    <asp:HiddenField ID="HidFilter" runat="server" Value="4" />
    ...
    <asp:Button ID="btnSorting" runat="server" Text="Button" OnClick="btnSorting_Click" Visible="false" />
    <asp:Button ID="btnPaging" runat="server" Text="Button" OnClick="btnPaging_Click" Visible="false" />
    <div style="padding-bottom: 8px;">
        <table cellpadding="0" cellspacing="0" style="width: 100%; height: 50px; padding-top: 8px;"
            bgcolor="#F2F2F2">
            <tr>
                <td style=" padding-left:10px;">
                    <a href="javascript:newCoBuy();" style="font-weight: bold; width:20px; color: #FF0065; ">发起合买</a>
                </td>
                <td>
                    <asp:TextBox ID="TxtName" runat="server" CssClass="in_text" value="输入用户名" size="12"
                ...
                <td width="75">
                    <ShoveWebUI:ShoveConfirmButton ID="btnSearch" runat="server" BackgroupImage="images/button_sousuo.jpg"
                        Style="cursor: hand;" BorderStyle="None" Height="23px" OnClick="btnSearch_Click" Width="72" />
                </td>
                <td align="left" style="padding-left:0px; padding-bottom: 5px; padding-left:10px;">
                    <asp:LinkButton ID="btnType_4" runat="server" class="hui12_line" OnClick="btnType_1_Click">未满员</asp:LinkButton>
                    |
                    <asp:LinkButton ID="btnType_3" runat="server" CssClass="hui12_line" OnClick="btnType_1_Click">已满员</asp:LinkButton>
                    |
                    <asp:LinkButton ID="btnType_6" runat="server" class="hui12_line" OnClick="btnType_1_Click">有保底</asp:LinkButton>
                    |
                    <asp:LinkButton ID="btnType_1" runat="server" CssClass="hui12_line" OnClick="btnType_1_Click">千元以上</asp:LinkButton>
                    |
                    <asp:LinkButton ID="btnType_2" runat="server" CssClass="hui12_line" OnClick="btnType_1_Click">千元以下</asp:LinkButton>
                    |
                    <asp:LinkButton ID="btnType_7" runat="server" class="hui12_line" OnClick="btnType_1_Click">全部方案</asp:LinkButton>
                </td>
            </tr>
        </table>
    </div>
    <div>
        <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#FFFFFF" bordercolorlight="#BCD2E9" bgcolor="#E9F1F8">
            <tr align="center" valign="middle" class="blue" style="background-color: #E9F1F8; height: 25px;">
                ...
                <td align="center" width="12%" bgcolor="#E9F1F8" class="blue12_line">
                    投注内容
                </td>
                <td align="center" width=" 5%" bgcolor="#E9F1F8" class="blue12_line">
            ...
            <asp:Repeater ID="rptSchemes" runat="server" EnableViewState="false">
                <ItemTemplate>
                    <tr onmouseover="JavaScript:this.bgColor='MistyRose';" onmouseout="JavaScript:this.bgColor='<%#Eval("Color") %>';"
                        ...
                        <td align="center" class="blue12" style="text-align:right;">
                            <%#Eval("Assure")%>
                        </td>
                        <td align="center" class="blue12">
                            <%#Eval("State")%>
