<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DistillBybank.aspx.cs" Inherits="Hoom_Room_DistillBybank" %>
...
<body onload="Show();">
    <form id="form1" runat="server">
     <asp:Panel ID="pnlSafeSet" runat="server" Visible="true" Style="text-align: center;">
        <table width="90%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr bgcolor="#C0DBF9" id="trOldQue" runat="server" visible="false">
    ...
    <asp:Panel ID="pnlFirst" runat="server" Visible="true" Style="text-align: center;">
        <table width="90%" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
            ...
            <tr id="trBankName" runat="server" bgcolor="#C0DBF9">
                <td height="30" align="right" bgcolor="#FFFFFF" class="black12">
                    开户银行：
                </td>
                <td align="left" bgcolor="#FFFFFF" class="black12" style="padding-left: 10px;">
                    <asp:Label ID="lbBankInProvince" runat="server"></asp:Label>&nbsp;
                    <asp:Label ID="lbBankInCity" runat="server"></asp:Label>&nbsp;
                    <asp:Label ID="lbBankTypeName" runat="server"></asp:Label>&nbsp;
                    <asp:Label ID="lbBankName" runat="server"></asp:Label>
                </td>
            </tr>
            <tr bgcolor="#C0DBF9">
                <td height="30" align="right" bgcolor="#FFFFFF" class="black12">
                ...
                <td align="left" bgcolor="#FFFFFF" class="black12" style="padding-left: 10px;">
                    <asp:Label ID ="lbBankNo" runat="server" Text=""></asp:Label>
                     <label id="labBindState" runat="server"></label>
                </td>
            </tr>
            <tr id="trBankCardRealityName" runat="server" bgcolor="#C0DBF9">
                <td height="30" align="right" bgcolor="#FFFFFF" class="black12">
                    持卡人真实姓名：
                </td>
                <td align="left" bgcolor="#FFFFFF" class="black12" style="padding-left: 10px;">
                    <asp:Label ID="lbBankCardRealityName" runat="server"></asp:Label>
                </td>
            </tr>
            <tr>
                <td colspan="2" height="20"><div id="hr"></div></td>
            </tr>
             <tr bgcolor="#C0DBF9">
            ...
            <tr bgcolor="#C0DBF9">
                ...
                <td align="left" bgcolor="#FFFFFF" class="black12" style="padding-left: 10px;">
                    ...
                    &nbsp;&nbsp; <span class="blue12"><a href="SafeSet.aspx?FromUrl='Distill.aspx?Type=2'" target="_parent">
            ...
            <tr bgcolor="#C0DBF9">
                <td height="10" align="right" bgcolor="#FFFFFF" class="black12">&nbsp;</td>
                <td align="left" bgcolor="#FFFFFF" class="black12" style="padding-left: 10px;">&nbsp;</td>
            </tr>
            <tr bgcolor="#C0DBF9">
                <td height="30" align="right" bgcolor="#FFFFFF" class="black12">&nbsp;</td>
                <td align="left" bgcolor="#FFFFFF" class="black12" style="padding-left: 10px;">
    ...
    <asp:Panel ID="pnlNext" runat="server" Visible="false">
        <table width="768" border="0" cellspacing="0" cellpadding="0" style="margin-top: 10px;">
            <tr bgcolor="#C0DBF9">
                <td height="15" bgcolor="#FFFFFF">
                    <table width="700" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top: 10px;">
                        ...
                        <tr bgcolor="#C0DBF9">
                            <td height="30" colspan="3" align="left" bgcolor="#FFFFFF" class="black12">
                                您原有预付款<span class="red12"><%=_User.Balance%></span></span>元， 本次取款<span class="red12"><asp:Label
                                    ID="lblDistillMoney" runat="server"></asp:Label></span>元后， 您还有<span class="red12"><asp:Label
                                        ID="lblLastMoney" runat="server"></asp:Label></span>元预付款。
                            </td>
                        </tr>
                        <tr bgcolor="#C0DBF9">
                            <td height="30" colspan="3" align="left" bgcolor="#FFFFFF" class="blue14">
                                此款项将发到您绑定的<span class="red14">银行卡账户</span>
                            </td>
                        </tr>
                        <tr>
