<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Send_Alipay.aspx.cs" Inherits="Home_Room_OnlinePay_Alipay02_Send_Alipay" %>
                                                ...
                                                <td>
                                                    <table width="175" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td width="26">
                                                                <label>
                                                                    <asp:RadioButton ID="radZFB" GroupName="payWay" runat="server" Checked="true" />
                                                                </label>
                                                            </td>
