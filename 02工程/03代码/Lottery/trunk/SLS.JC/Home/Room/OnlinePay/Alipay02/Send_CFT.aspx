<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Send_CFT.aspx.cs" Inherits="Home_Room_OnlinePay_Alipay02_Send_CFT" %>
                                    ...
                                    <td>
                                        <table width="150" border="0" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td width="26">
                                                    <label>
                                                        <asp:RadioButton ID="radCFT" GroupName="payWay" runat="server" Checked="true" />
                                                    </label>
                                                </td>
