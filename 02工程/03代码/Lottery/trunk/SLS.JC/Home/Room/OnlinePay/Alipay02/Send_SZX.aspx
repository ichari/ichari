<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Send_SZX.aspx.cs" Inherits="Home_Room_OnlinePay_Alipay02_Send_007Ka" %>
                                                ...
                                                <td>
                                                    <table width="150" border="0" cellspacing="0" cellpadding="0">
                                                        <tr>
                                                            <td width="26">
                                                                <label>
                                                                    <asp:RadioButton ID="rad007Ka" GroupName="payWay" runat="server" Checked="true" />
                                                                </label>
                                                            </td>
                                                            <td width="124" height="28">
                                                                <img src="images/bank_logo/logo_007Ka.gif" width="121" height="27"  style="border:1px" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
