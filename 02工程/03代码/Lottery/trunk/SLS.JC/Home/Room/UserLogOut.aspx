<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserLogOut.aspx.cs" Inherits="Home_Room_UserLogOut" %>
...
<body>
    ...
    <div id="content">
        ...
        <div id="menu_right">
            ...
            <br />
            <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#C0DBF9" style="padding-left: 10px; padding-top :10px;"
                align="center">
                <tr>
