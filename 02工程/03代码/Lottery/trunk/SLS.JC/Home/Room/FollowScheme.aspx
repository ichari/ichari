            ...
            <table cellpadding="0" cellspacing="0" style="width:100%;" bgcolor="#F2F2F2" style=" height:50px" >
                <tr>
                    <td style="padding-left: 25px; width:100px">
                        <asp:LinkButton ID="btnList" runat="server" onclick="btnList_Click" style="color: #000000;padding-left: 4px;">我的合买跟单列表</asp:LinkButton>
                    </td>
                    ...
                    <td style="padding-left:15px;">
                        <asp:HyperLink ID="hlAdd" runat="server"  style=" color: #000000;">新增自动合买跟单</asp:HyperLink>
                    </td>
                </tr>
            </table>
        </div>
