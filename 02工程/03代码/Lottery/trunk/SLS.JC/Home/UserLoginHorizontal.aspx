<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserLoginHorizontal.aspx.cs" Inherits="Home_UserLoginHorizontal" %>
            ...
            <tr>
                <td>
                    <asp:Panel ID="Panel1" runat="server" Width="100%">
                        <table cellspacing="0" cellpadding="0" width="100%" border="0" style="background-image: url(Image/Login_bg.jpg); height: 30px;" class="black12">
                            <tr>
                                ...
                                <td>
                                    <ShoveWebUI:ShoveConfirmButton ID="btnLogin" Style="cursor: hand; color: #000000; background-image: url(Image/Login.jpg);" runat="server" Width="60px" Height="22px" CausesValidation="False" Text="登 录" BorderStyle="None" OnClick="btnLogin_Click" />
                                </td>
                                <td>
                                    <a href="../MemberSharing/Alipay/Login.aspx" target="_blank">
                                        <img style="height: 22px; width: 150px;" src="Image/Login_Alipay.jpg" alt="支付宝用户登录" border="0" /></a>
                                </td>
                                <td style=" padding-left: 5px;" align="center" class="black12" valign="middle">
                                    <a href="Web/UserReg.aspx" target="_parent">免费注册</a> | <a href="/ForgetPassword.aspx" target="_parent">忘记密码</a>
                                </td>
                    ...
                    <asp:Panel ID="Panel2" runat="server">
                        <table cellspacing="0" cellpadding="0" width="100%" border="0" style="background-image: url(Image/Login_bg.jpg); height: 30px;">
                            <tr>
                                ...
                                <td valign="middle" align="left" width="40%">
                                    <a href="../Default.aspx" target="_blank" class="black12">购彩大厅</a> | <a href="Room/MyIcaile.aspx?SubPage=UserEdit.aspx" target="_blank" class="black12">我的资料</a> | <a href="Room/MyIcaile.aspx?SubPage=AccountDetail.aspx" target="_blank" class="black12">个人帐户</a> | <a href="Room/MyIcaile.aspx?SubPage=OnlinePay/Default.aspx" target="_blank" class="red12">电话卡充值</a>
                                </td>
