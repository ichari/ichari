...
namespace SLS.AutomaticOpenLottery.Task
{
    public class OpenTask
    {
        ...
        private string HN11X5_Open_URL = ini.Read("Options", "HN11X5_Open_URL");
        ...
        private string GP_Open_RulHN11X5 = ini.Read("Options", "GP_Open_RulHN11X5");

        private System.Threading.Thread thread;

        public int State = 0;   // 0 停止 1 运行中 2 置为停止

        public OpenTask(string connectionstring)
        {
        ...
        public void Run()
        {
            ...
            lock (this) // 确保临界区被一个 Thread 所占用
            {
                ...
                new Log("System").Write("OpenTask_Task.");
            }
        }
        ...
        //河南十一选五
        private void GetLotteryOpenNumberForHN11X5(int LotteryID)
        {
            DAL.Tables.T_Isuses t_Isuses = new DAL.Tables.T_Isuses();
            ...
            try
            {
                ds.ReadXml(HN11X5_Open_URL);
            }
            catch
            {
                new Log("SystemGetLotteryOpenNumber").Write("河南11选5获取开奖号码页面异常");
            ...
            foreach (DataRow dr in ds.Tables[0].Rows)
            {
                ...
                {
                    new Log("SystemGetLotteryOpenNumber").Write("河南11选5获取开奖号码异常：" + e.Message);
                }
            }
        }
