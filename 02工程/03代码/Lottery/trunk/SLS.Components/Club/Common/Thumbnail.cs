...
namespace Discuz.Common
{
	...
	public class Thumbnail
	{
		...
		{
            srcFileName = AppDomain.CurrentDomain.BaseDirectory + FileName;
			try
			{
			...
			{
                Discuz.Forum.ScheduledEvents.EventLogs.WriteFailedLog(this.GetType().FullName + ",srcFileName:" + srcFileName + "," + e.Message);
