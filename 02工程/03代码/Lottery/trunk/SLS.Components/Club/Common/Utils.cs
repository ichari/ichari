...
namespace Discuz.Common
{
    ...
    public class Utils
	{
		...
		public static string MD5(string str)
		{
            ...
            if (IsMD5)
            {
                return FormsAuthentication.HashPasswordForStoringInConfigFile(str, "MD5"); //宁波客户彩票俱乐部 使用的是纯MD5 加密方式
            }
            else
            {
                return FormsAuthentication.HashPasswordForStoringInConfigFile(str + "7ien.shovesoft.shove 中国深圳 2007-10-25", "MD5");
            }
		}
