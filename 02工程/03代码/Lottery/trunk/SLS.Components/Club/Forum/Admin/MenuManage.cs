...
namespace Discuz.Forum
{
    ...
    {
        private static readonly string configPath = AppDomain.CurrentDomain.BaseDirectory + "/admin/xml/navmenu.config";
        ...
        {
            Utils.BackupFile(configPath,AppDomain.CurrentDomain.BaseDirectory + "/admin/xml/backup/" + DateTime.Now.ToString("yyyy-MM-dd HH_mm_ss") + ".config");
        }
        #endregion
    }
}
