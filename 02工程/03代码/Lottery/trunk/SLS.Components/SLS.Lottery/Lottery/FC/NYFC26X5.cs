...
namespace SLS
{
    public partial class Lottery
    {
        ...
        {
            #region 静态变量
            public const int PlayType_D = 1701;
            public const int PlayType_F = 1702;
            public const int PlayType_HC2_D = 1703;
            public const int PlayType_HC2_F = 1704;
            public const int PlayType_HC3_D = 1705;
            public const int PlayType_HC3_F = 1706;
            ...
            {
                return ((play_type >= 1701) && (play_type <= 1706));
            }
