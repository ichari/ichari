...
namespace SLS
{
    public partial class Lottery
    {
        ...
        /// 胜负彩
        /// </summary>
        public partial class ZCSFC : LotteryBase
        {
            #region 静态变量
            public const int PlayType_D = 7401;
            public const int PlayType_F = 7402;

            public const int ID = 74;
            public const string sID = "74";
            public const string Name = "胜负彩";
            public const string Code = "ZCSFC";
            ...
            {
                return ((play_type >= 7401) && (play_type <= 7402));
            }
