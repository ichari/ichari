...
namespace SLS
{
    public partial class Lottery
    {
        ...
        /// 十一运夺金
        /// </summary>
        public partial class SYYDJ : LotteryBase
        {
            #region 静态变量

            public const int PlayType_RX1 = 6201;
            public const int PlayType_RX2 = 6202;
            public const int PlayType_RX3 = 6203;
            public const int PlayType_RX4 = 6204;
            public const int PlayType_RX5 = 6205;
            public const int PlayType_RX6 = 6206;
            public const int PlayType_RX7 = 6207;
            public const int PlayType_RX8 = 6208;
            public const int PlayType_ZhiQ2 = 6209;
            public const int PlayType_ZhiQ3 = 6210;
            public const int PlayType_ZuQ2 = 6211;
            public const int PlayType_ZuQ3 = 6212;
            ...
            {
                return ((play_type >= 6201) && (play_type <= 6212));
            }
            ...
            public override Ticket[] ToElectronicTicket_HPSD(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                ...
                {
                    return ToElectronicTicket_HPSD_RX1(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX2)
                {
                    return ToElectronicTicket_HPSD_RX2(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX3)
                {
                    return ToElectronicTicket_HPSD_RX3(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX4)
                {
                    return ToElectronicTicket_HPSD_RX4(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX5)
                {
                    return ToElectronicTicket_HPSD_RX5(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX6)
                {
                    return ToElectronicTicket_HPSD_RX6(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX7)
                {
                    return ToElectronicTicket_HPSD_RX7(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX8)
                {
                    return ToElectronicTicket_HPSD_RX8(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_ZhiQ2)
                {
                    return ToElectronicTicket_HPSD_ZhiQ2(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_ZhiQ3)
                {
                    return ToElectronicTicket_HPSD_ZhiQ3(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_ZuQ2)
                {
                    return ToElectronicTicket_HPSD_ZuQ2(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_ZuQ3)
                {
                    return ToElectronicTicket_HPSD_ZuQ3(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                return null;
            }
            #region ToElectronicTicket_HPSD 的具体方法
            private Ticket[] ToElectronicTicket_HPSD_RX1(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                ...
                for (int n = 1; n < MultipleNum + 1; n++)
                {
                    ...
                    for (int i = 0; i < strs.Length; i += 5)
                    {
                        ...
                        al.Add(new Ticket(1, ConvertFormatToElectronTicket_HPSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                    }
                }
            ...
            private Ticket[] ToElectronicTicket_HPSD_RX2(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(2, ConvertFormatToElectronTicket_HPSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(2, ConvertFormatToElectronTicket_HPSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_HPSD_RX3(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(3, ConvertFormatToElectronTicket_HPSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(3, ConvertFormatToElectronTicket_HPSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_HPSD_RX4(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(4, ConvertFormatToElectronTicket_HPSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(4, ConvertFormatToElectronTicket_HPSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_HPSD_RX5(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(5, ConvertFormatToElectronTicket_HPSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(5, ConvertFormatToElectronTicket_HPSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_HPSD_RX6(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(6, ConvertFormatToElectronTicket_HPSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(6, ConvertFormatToElectronTicket_HPSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_HPSD_RX7(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(7, ConvertFormatToElectronTicket_HPSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(7, ConvertFormatToElectronTicket_HPSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_HPSD_RX8(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(8, ConvertFormatToElectronTicket_HPSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(8, ConvertFormatToElectronTicket_HPSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_HPSD_ZhiQ2(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[2]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(9, ConvertFormatToElectronTicket_HPSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(9, ConvertFormatToElectronTicket_HPSD(PlayTypeID, t_Numbers.Replace(" ", ",")), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_HPSD_ZhiQ3(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[3]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(10, ConvertFormatToElectronTicket_HPSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(10, ConvertFormatToElectronTicket_HPSD(PlayTypeID, t_Numbers.Replace(" ", ",")), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_HPSD_ZuQ2(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(11, ConvertFormatToElectronTicket_HPSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(11, ConvertFormatToElectronTicket_HPSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_HPSD_ZuQ3(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(12, ConvertFormatToElectronTicket_HPSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(12, ConvertFormatToElectronTicket_HPSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            public override Ticket[] ToElectronicTicket_CTTCSD(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                if (PlayTypeID == PlayType_RX1)
                {
                    return ToElectronicTicket_CTTCSD_RX1(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX2)
                {
                    return ToElectronicTicket_CTTCSD_RX2(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX3)
                {
                    return ToElectronicTicket_CTTCSD_RX3(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX4)
                {
                    return ToElectronicTicket_CTTCSD_RX4(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX5)
                {
                    return ToElectronicTicket_CTTCSD_RX5(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX6)
                {
                    return ToElectronicTicket_CTTCSD_RX6(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX7)
                {
                    return ToElectronicTicket_CTTCSD_RX7(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX8)
                {
                    return ToElectronicTicket_CTTCSD_RX8(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_ZhiQ2)
                {
                    return ToElectronicTicket_CTTCSD_ZhiQ2(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_ZhiQ3)
                {
                    return ToElectronicTicket_CTTCSD_ZhiQ3(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_ZuQ2)
                {
                    return ToElectronicTicket_CTTCSD_ZuQ2(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_ZuQ3)
                {
                    return ToElectronicTicket_CTTCSD_ZuQ3(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                return null;
            }
            #region ToElectronicTicket_CTTCSD 的具体方法
            private Ticket[] ToElectronicTicket_CTTCSD_RX1(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_RX1(Number, PlayTypeID).Split('\n');
                ...
                for (int n = 1; n < MultipleNum + 1; n++)
                {
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        al.Add(new Ticket(101, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                    }
                }
            ...
            private Ticket[] ToElectronicTicket_CTTCSD_RX2(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_RX2(Number, PlayTypeID).Split('\n');
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(111, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(102, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_CTTCSD_RX3(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_RX3(Number, PlayTypeID).Split('\n');
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(112, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(103, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_CTTCSD_RX4(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_RX4(Number, PlayTypeID).Split('\n');
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(113, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(104, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_CTTCSD_RX5(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_RX5(Number, PlayTypeID).Split('\n');
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(114, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(105, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_CTTCSD_RX6(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_RX6(Number, PlayTypeID).Split('\n');
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(115, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(106, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_CTTCSD_RX7(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_RX7(Number, PlayTypeID).Split('\n');
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(116, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(107, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_CTTCSD_RX8(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseSchemeToElectronicTicket_RX8(Number, PlayTypeID).Split('\n');
                ...
                for (int n = 1; n < MultipleNum + 1; n++)
                {
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if ((M == 5) || (i == strs.Length - 1))
                        {
                            ...
                            al.Add(new Ticket(117, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_CTTCSD_ZhiQ2(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_ZhiQ2(Number, PlayTypeID).Split('\n');
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[2]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(141, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(144, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, t_Numbers.Replace(" ", ",")), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_CTTCSD_ZhiQ3(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_ZhiQ3(Number, PlayTypeID).Split('\n');
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[3]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(161, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(164, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, t_Numbers.Replace(" ", ",")), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_CTTCSD_ZuQ2(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_ZuQ2(Number, PlayTypeID).Split('\n');
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(131, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(108, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_CTTCSD_ZuQ3(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_ZuQ3(Number, PlayTypeID).Split('\n');
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        if (double.Parse(strs[i].ToString().Split('|')[1]) == 1)
                        {
                            ...
                            if ((M == 5) || (i == strs.Length - 1))
                            {
                                ...
                                al.Add(new Ticket(151, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, Numbers), EachMultiple, EachMoney * EachMultiple));
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(109, ConvertFormatToElectronTicket_CTTCSD(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private string AnalyseSchemeToElectronicTicket_RX8(string Content, int PlayType)
            {
                string[] strs = Content.Split('\n');
                if (strs == null)
                    return "";
            ...
            public override Ticket[] ToElectronicTicket_BJCP(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                if (PlayTypeID == PlayType_RX1)
                {
                    return ToElectronicTicket_BJCP_RX1(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX2)
                {
                    return ToElectronicTicket_BJCP_RX2(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX3)
                {
                    return ToElectronicTicket_BJCP_RX3(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX4)
                {
                    return ToElectronicTicket_BJCP_RX4(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX5)
                {
                    return ToElectronicTicket_BJCP_RX5(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX6)
                {
                    return ToElectronicTicket_BJCP_RX6(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX7)
                {
                    return ToElectronicTicket_BJCP_RX7(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_RX8)
                {
                    return ToElectronicTicket_BJCP_RX8(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_ZhiQ2)
                {
                    return ToElectronicTicket_BJCP_ZhiQ2(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_ZhiQ3)
                {
                    return ToElectronicTicket_BJCP_ZhiQ3(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_ZuQ2)
                {
                    return ToElectronicTicket_BJCP_ZuQ2(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                if (PlayTypeID == PlayType_ZuQ3)
                {
                    return ToElectronicTicket_BJCP_ZuQ3(PlayTypeID, Number, Multiple, MaxMultiple, ref Money);
                }
                return null;
            }
            #region ToElectronicTicket_BJCP 的具体方法
            private Ticket[] ToElectronicTicket_BJCP_RX1(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_RX1(Number, PlayTypeID).Split('\n');
            ...
            private Ticket[] ToElectronicTicket_BJCP_RX2(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_RX2(Number, PlayTypeID).Split('\n');
                ...
                for (int n = 1; n < MultipleNum + 1; n++)
                {
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(1, ConvertFormatToElectronTicket_BJCP(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_BJCP_RX3(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_RX3(Number, PlayTypeID).Split('\n');
            ...
            private Ticket[] ToElectronicTicket_BJCP_RX4(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_RX4(Number, PlayTypeID).Split('\n');
            ...
            private Ticket[] ToElectronicTicket_BJCP_RX5(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_RX5(Number, PlayTypeID).Split('\n');
            ...
            private Ticket[] ToElectronicTicket_BJCP_RX6(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_RX6(Number, PlayTypeID).Split('\n');
            ...
            private Ticket[] ToElectronicTicket_BJCP_RX7(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_RX7(Number, PlayTypeID).Split('\n');
            ...
            private Ticket[] ToElectronicTicket_BJCP_RX8(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_RX8(Number, PlayTypeID).Split('\n');
                ...
                for (int n = 1; n < MultipleNum + 1; n++)
                {
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(0, ConvertFormatToElectronTicket_BJCP(PlayTypeID, t_Numbers), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_BJCP_ZhiQ2(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_ZhiQ2(Number, PlayTypeID).Split('\n');
                ...
                for (int n = 1; n < MultipleNum + 1; n++)
                {
                    ...
                    for (int i = 0; i < strs.Length; i++)
                    {
                        ...
                        else
                        {
                            ...
                            al.Add(new Ticket(1, ConvertFormatToElectronTicket_BJCP(PlayTypeID, t_Numbers.Replace(" ", ",")), EachMultiple, t_EachMoney * EachMultiple));
            ...
            private Ticket[] ToElectronicTicket_BJCP_ZhiQ3(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_ZhiQ3(Number, PlayTypeID).Split('\n');
            ...
            private Ticket[] ToElectronicTicket_BJCP_ZuQ2(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_ZuQ2(Number, PlayTypeID).Split('\n');
            ...
            private Ticket[] ToElectronicTicket_BJCP_ZuQ3(int PlayTypeID, string Number, int Multiple, int MaxMultiple, ref double Money)
            {
                string[] strs = AnalyseScheme_ZuQ3(Number, PlayTypeID).Split('\n');
            ...
            private string ConvertFormatToElectronTicket_BJCP(int PlayTypeID, string Number)
            {
                ...
                if (PlayTypeID == PlayType_RX2 || PlayTypeID == PlayType_RX3 || PlayTypeID == PlayType_RX4 || PlayTypeID == PlayType_RX5 || PlayTypeID == PlayType_RX6 || PlayTypeID == PlayType_RX7 || PlayTypeID == PlayType_RX8)
                {
                    Ticket = Number.Replace(" ", "");
                }
