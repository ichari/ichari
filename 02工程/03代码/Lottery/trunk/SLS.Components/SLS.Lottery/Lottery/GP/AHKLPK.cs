...
namespace SLS
{
    public partial class Lottery
    {
        ...
        /// 安徽快乐扑克
        /// </summary>
        public partial class AHKLPK : LotteryBase
        {
            #region 静态变量
            public const int PlayType_Mixed = 5100; //混合投注
            public const int PlayType_RX1_D = 5101; //任选1单式
            public const int PlayType_RX1_F = 5102; //任选1复式
            public const int PlayType_RX2_D = 5103; //任选2单式
            public const int PlayType_RX2_F = 5104; //任选2复式
            public const int PlayType_RX3_D = 5105; //任选3单式
            public const int PlayType_RX3_F = 5106; //任选3复式
            public const int PlayType_X4_Zu24 = 5107; //选4组选24
            public const int PlayType_X4_Zu12 = 5108; //选4组选12
            public const int PlayType_X4_Zu6 = 5109; //选4组选6
            public const int PlayType_X4_Zu4 = 5110; //选4组选4
            public const int PlayType_X4_ZhiD = 5111; //选4直选单式
            public const int PlayType_X4_ZhiF = 5112; //选4直选复式
            ...
            {
                return ((play_type >= 5100) && (play_type <= 5112));
            }
