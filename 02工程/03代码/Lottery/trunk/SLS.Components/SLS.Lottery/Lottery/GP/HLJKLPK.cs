...
namespace SLS
{
    public partial class Lottery
    {
        ...
        /// 黑龙江快乐扑克
        /// </summary>
        public partial class HLJKLPK : LotteryBase
        {
            #region 静态变量
            public const int PlayType_Mixed = 5200; //混合投注
            public const int PlayType_RX1_D = 5201; //任选1单式
            public const int PlayType_RX1_F = 5202; //任选1复式
            public const int PlayType_RX2_D = 5203; //任选2单式
            public const int PlayType_RX2_F = 5204; //任选2复式
            public const int PlayType_RX3_D = 5205; //任选3单式
            public const int PlayType_RX3_F = 5206; //任选3复式
            public const int PlayType_X4_Zu24 = 5207; //选4组选24
            public const int PlayType_X4_Zu12 = 5208; //选4组选12
            public const int PlayType_X4_Zu6 = 5209; //选4组选6
            public const int PlayType_X4_Zu4 = 5210; //选4组选4
            public const int PlayType_X4_ZhiD = 5211; //选4直选单式
            public const int PlayType_X4_ZhiF = 5212; //选4直选复式
            ...
            {
                return ((play_type >= 5200) && (play_type <= 5212));
            }
