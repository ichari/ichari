...
namespace SLS
{
    public partial class Lottery
    {
        ...
        /// 山西快乐扑克
        /// </summary>
        public partial class ShXKLPK : LotteryBase
        {
            #region 静态变量
            public const int PlayType_Mixed = 5700; //混合投注
            public const int PlayType_RX1_D = 5701; //任选1单式
            public const int PlayType_RX1_F = 5702; //任选1复式
            public const int PlayType_RX2_D = 5703; //任选2单式
            public const int PlayType_RX2_F = 5704; //任选2复式
            public const int PlayType_RX3_D = 5705; //任选3单式
            public const int PlayType_RX3_F = 5706; //任选3复式
            public const int PlayType_X4_Zu24 = 5707; //选4组选24
            public const int PlayType_X4_Zu12 = 5708; //选4组选12
            public const int PlayType_X4_Zu6 = 5709; //选4组选6
            public const int PlayType_X4_Zu4 = 5710; //选4组选4
            public const int PlayType_X4_ZhiD = 5711; //选4直选单式
            public const int PlayType_X4_ZhiF = 5712; //选4直选复式
            ...
            {
                return ((play_type >= 5700) && (play_type <= 5712));
            }
