...
namespace SLS
{
    public partial class Lottery
    {
        ...
        /// 辽宁快乐扑克
        /// </summary>
        public partial class LLKLPK : LotteryBase
        {
            #region 静态变量
            public const int PlayType_Mixed = 5300; //混合投注
            public const int PlayType_RX1_D = 5301; //任选1单式
            public const int PlayType_RX1_F = 5302; //任选1复式
            public const int PlayType_RX2_D = 5303; //任选2单式
            public const int PlayType_RX2_F = 5304; //任选2复式
            public const int PlayType_RX3_D = 5305; //任选3单式
            public const int PlayType_RX3_F = 5306; //任选3复式
            public const int PlayType_X4_Zu24 = 5307; //选4组选24
            public const int PlayType_X4_Zu12 = 5308; //选4组选12
            public const int PlayType_X4_Zu6 = 5309; //选4组选6
            public const int PlayType_X4_Zu4 = 5310; //选4组选4
            public const int PlayType_X4_ZhiD = 5311; //选4直选单式
            public const int PlayType_X4_ZhiF = 5312; //选4直选复式
            ...
            {
                return ((play_type >= 5300) && (play_type <= 5312));
            }
