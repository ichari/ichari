...
namespace SLS
{
    public partial class Lottery
    {
        ...
        /// 陕西快乐扑克
        /// </summary>
        public partial class SXKLPK : LotteryBase
        {
            #region 静态变量
            public const int PlayType_Mixed = 5400; //混合投注
            public const int PlayType_RX1_D = 5401; //任选1单式
            public const int PlayType_RX1_F = 5402; //任选1复式
            public const int PlayType_RX2_D = 5403; //任选2单式
            public const int PlayType_RX2_F = 5404; //任选2复式
            public const int PlayType_RX3_D = 5405; //任选3单式
            public const int PlayType_RX3_F = 5406; //任选3复式
            public const int PlayType_X4_Zu24 = 5407; //选4组选24
            public const int PlayType_X4_Zu12 = 5408; //选4组选12
            public const int PlayType_X4_Zu6 = 5409; //选4组选6
            public const int PlayType_X4_Zu4 = 5410; //选4组选4
            public const int PlayType_X4_ZhiD = 5411; //选4直选单式
            public const int PlayType_X4_ZhiF = 5412; //选4直选复式
            ...
            {
                return ((play_type >= 5400) && (play_type <= 5412));
            }
