...
namespace SLS
{
    public partial class Lottery
    {
        ...
        /// 四川快乐扑克
        /// </summary>
        public partial class SCKLPK : LotteryBase
        {
            #region 静态变量
            public const int PlayType_Mixed = 5600; //混合投注
            public const int PlayType_RX1_D = 5601; //任选1单式
            public const int PlayType_RX1_F = 5602; //任选1复式
            public const int PlayType_RX2_D = 5603; //任选2单式
            public const int PlayType_RX2_F = 5604; //任选2复式
            public const int PlayType_RX3_D = 5605; //任选3单式
            public const int PlayType_RX3_F = 5606; //任选3复式
            public const int PlayType_X4_Zu24 = 5607; //选4组选24
            public const int PlayType_X4_Zu12 = 5608; //选4组选12
            public const int PlayType_X4_Zu6 = 5609; //选4组选6
            public const int PlayType_X4_Zu4 = 5610; //选4组选4
            public const int PlayType_X4_ZhiD = 5611; //选4直选单式
            public const int PlayType_X4_ZhiF = 5612; //选4直选复式
            ...
            {
                return ((play_type >= 5600) && (play_type <= 5612));
            }
