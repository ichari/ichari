...
namespace SLS
{
    public partial class Lottery
    {
        ...
        /// 山东快乐扑克
        /// </summary>
        public partial class SDKLPK : LotteryBase
        {
            #region 静态变量
            public const int PlayType_Mixed = 4900; //混合投注
            public const int PlayType_RX1_D = 4901; //任选1单式
            public const int PlayType_RX1_F = 4902; //任选1复式
            public const int PlayType_RX2_D = 4903; //任选2单式
            public const int PlayType_RX2_F = 4904; //任选2复式
            public const int PlayType_RX3_D = 4905; //任选3单式
            public const int PlayType_RX3_F = 4906; //任选3复式
            public const int PlayType_X4_Zu24 = 4907; //选4组选24
            public const int PlayType_X4_Zu12 = 4908; //选4组选12
            public const int PlayType_X4_Zu6 = 4909; //选4组选6
            public const int PlayType_X4_Zu4 = 4910; //选4组选4
            public const int PlayType_X4_ZhiD = 4911; //选4直选单式
            public const int PlayType_X4_ZhiF = 4912; //选4直选复式
            ...
            {
                return ((play_type >= 4900) && (play_type <= 4912));
            }
