...
namespace SLS
{
    public partial class Lottery
    {
        ...
        /// 河北快乐扑克
        /// </summary>
        public partial class HeBKLPK : LotteryBase
        {
            #region 静态变量
            public const int PlayType_Mixed = 5000; //混合投注
            public const int PlayType_RX1_D = 5001; //任选1单式
            public const int PlayType_RX1_F = 5002; //任选1复式
            public const int PlayType_RX2_D = 5003; //任选2单式
            public const int PlayType_RX2_F = 5004; //任选2复式
            public const int PlayType_RX3_D = 5005; //任选3单式
            public const int PlayType_RX3_F = 5006; //任选3复式
            public const int PlayType_X4_Zu24 = 5007; //选4组选24
            public const int PlayType_X4_Zu12 = 5008; //选4组选12
            public const int PlayType_X4_Zu6 = 5009; //选4组选6
            public const int PlayType_X4_Zu4 = 5010; //选4组选4
            public const int PlayType_X4_ZhiD = 5011; //选4直选单式
            public const int PlayType_X4_ZhiF = 5012; //选4直选复式
            ...
            {
                return ((play_type >= 5000) && (play_type <= 5012));
            }
