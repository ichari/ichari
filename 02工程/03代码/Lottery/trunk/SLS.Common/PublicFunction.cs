    ...
    public class PF
{
    ...
    public const int SchemeMaxBettingMoney = 20000;
    ...
    public static string ConnectString = Shove._Web.WebConfig.GetAppSettingsString("ConnectionString");
    ...
    {
        return new Sites()[SLS.Dal.Functions.F_GetMasterSiteID(ConnectString)];
    }
    ...
    public static string GetScriptResTable(string val)
    {
        try
        {
            ...
            if (type.Substring(0, 2) == "72")
            {
                ...
                table = new SLS.Dal.Tables.T_Match().Open(ConnectString,SQL, "id in (" + Matchids + ")", "");
            }
            else
            {
                ...
                table = new SLS.Dal.Tables.T_MatchBasket().Open(ConnectString,SQL, "id in (" + Matchids + ")", "");
            }
    ...
    {
        DataTable dt = new SLS.Dal.Views.V_SchemeForZCDC().Open(ConnectString,"*", "[SchemesID] = " + SchemeID.ToString() + " and No = " + No, "");
