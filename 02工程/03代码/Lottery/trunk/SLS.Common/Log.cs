...
namespace SLS.Common
{
    ...
    public class Log
    {
        ...
        public Log(string pathname)
        {
            ...
            if (!Directory.Exists(System.AppDomain.CurrentDomain.BaseDirectory + "App_Log\\"))
            {
                try {
                    Directory.CreateDirectory(System.AppDomain.CurrentDomain.BaseDirectory + "App_Log\\");
                }
                catch {
